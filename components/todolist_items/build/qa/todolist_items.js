...
todolist_items.prototype.k_css = "/********************************* *  todolist_items *  Created by keleko34 *  an item that holds an input and controls todos ********************************/.{{loopid}} .todolist_items {  background:{{complete | statusBackground}};  position: relative;  border-top: 2px dashed #e9e9e9;  height: 30px;  margin: 0px 14px;  display:{{hide | isHidden}}}.{{loopid}} .todolist_items__title {  color:{{complete | statusColor}};  padding-left: 42px;  line-height: 30px;  font-family: sans-serif;  font-size: 16px;}.{{loopid}} .todolist_items__complete {  width: 14px;  height: 14px;  position: absolute;  left: 12px;  top: 7px;}.{{loopid}} .todolist_items__complete__checkbox {  width: 14px;  height: 14px;  margin: 0;  cursor:pointer;}.{{loopid}} .todolist_items__controls {  position: absolute;  right: 24px;  top: 6px;}.{{loopid}} .todolist_items__controls__icon {  width:18px;  height:18px;  cursor:pointer;}.{{loopid}} .todolist_items__controls .todobutton {  position: absolute;}.{{loopid}} .todolist_items__controls .todobutton[title='favorite'] {  right:8px;}";
