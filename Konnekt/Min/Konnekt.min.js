var Konnekt=function(){var S=function(){return function(D,A,Q,r){function v(b,c,e,d){b=void 0===b?{}:b;var f={};if("undefined"===typeof Proxy)return console.error("There is no support for proxies! This library can not be used here, please update Your js library or browser");var k=new Proxy(f,{set:M,deleteProperty:z}),t=Object.keys(b,"all");Object.defineProperties(f,{__kbname:h("string"===typeof c?c:"default",!0,!0),__kbref:h(e?e.__kbref||e:k,!0,!0),__kbscopeString:h(d||"",!0,!0),__kbImmediateParent:h(e||
null,!0,!0),__kbsubscribers:h({}),__kblisteners:h({}),__kbupdatelisteners:h({}),__kbparentlisteners:h({}),__kbparentupdatelisteners:h({}),__kbcreatelisteners:h([]),__kbdeletelisteners:h([]),__kbparentcreatelisteners:h([]),__kbparentdeletelisteners:h([]),__kbpointers:h({}),__kbevents:h(w),length:h(0,!0),__kbnonproxy:h(f,!1,!0),_stopChange:h(!1,!0)});c=0;for(e=t.length;c<e;c++)k[t[c]]=b[t[c]];f.__proto__=v.prototype;f.__kbevents.addlistener=[];f.__kbevents.removelistener=[];f.addActionListener("addlistener",
...
1);break}g=0;for(l=t.length;g<l;g++)e.call(this[t[g]],c,b,k)}return function(d,f){arguments=Array.prototype.slice.call(arguments);arguments.push(b);var k=new u(this,c,"removechildlistener",void 0,void 0,arguments,"");!0!==g(k)&&(e.call(this,d,f,c),k.type="postremovechildlistener",g(k));return this}}var w={set:[],postset:[],create:[],postcreate:[],"delete":[],postdelete:[],splice:[],postsplice:[],push:[],postpush:[],pop:[],postpop:[],shift:[],postshift:[],unshift:[],postunshift:[],fill:[],postfill:[],
...
-1!==b.indexOf(".")?this.getLayer(b):this;-1!==b.indexOf(".")&&(b=b.split(".").pop());return c?void 0!==c[b]:!!c}),addPrototype:h(function(b,c){var e=-1!==b.indexOf(".")?this.setLayer(b):this;-1!==b.indexOf(".")&&(b=b.split(".").pop());void 0===e[b]?Object.defineProperty(e.__proto__,b,h(c,!0,!0)):console.error("Your attempting to add your prototype with the prop %O that already exists on %O",prop,e);return this}),addPointer:h(function(b,c){b instanceof v||(b=new v(b,b.__kbname));var e=Object.getOwnPropertyDescriptor(b,
c);Object.defineProperty(this,c,P(b,c,e));this.__kbpointers[c]=b}),move:h(function(b,c){this[c]=b[c];b instanceof v||(b[c]=null);delete b[c];return this}),copy:h(function(b,c){this[c]=b[c];return this}),merge:h(function(b){function c(b,f){for(var k=b instanceof v?b.keys("o"):Object.keys(b),t,g=0,q=k.length;g<q;g++)t=b[k[g]],"object"===typeof t&&-1===e.indexOf(t)&&"undefined"!==f[k[g]]?c(t,f):f[k[g]]=t}var e=[];c(b,this);return this}),copyWithin:h(function(b,c,e){c=c||0;e=e||0;var d=new u(this,b,"copyWithin",
this[b],void 0,arguments,"");if(!0!==g(d)&&b<this.length){b=0>b?this.length-1:b;c=c<this.length?c:this.length-1;e=e<this.length?e:this.length-1;c=0>c?this.length-1:c;e=0>c?this.length-1:e;for(var f=c;f<=e;f++)this[b+(f-c)]=this[f];d.type="postcopyWithin";g(d)}return this}),fill:h(function(b,c,e){c=void 0!==c?Math.max(0,c):0;e=void 0!==e&&e<=this.length?Math.min(this.length,Math.max(0,e)):this.length;var d=new u(this,_start,"fill",this[_start],void 0,arguments,"");if(!0!==g(d)){for(var f=a.key;f<e;f++)this[f]=
b;d.type="postfill";g(d)}return this}),pop:h(function(){var b=new u(this,this.length-1,"pop",this[this.length-1],void 0,arguments,"");if(!0!==g(b)){var c=this[this.length-1];--this.length;b.type="postpop";g(b);return c}return null}),push:h(function(b){var c=new u(this,this.length,"push",b,void 0,arguments,"");!0!==g(c)&&(this[this.length]=b,c.type="postpush",g(c));return this.length}),reverse:h(function(){var b=new u(this,void 0,"reverse",void 0,void 0,arguments,"");if(!0!==g(b)){for(var c=this.slice().reverse(),
e=0,d=this.length;e<d;e++)this[e]=c[e];b.type="postreverse";g(b)}return this}),shift:h(function(){var b=new u(this,0,"shift",this[0],void 0,arguments,"");if(!0!==g(b)){for(var c=a.key,e=this.length-1;c<e;c++)this[c]=this[c+1];--this.length;b.type="postshift";g(b)}return null}),sort:h(function(){var b=new u(this,void 0,"sort",void 0,void 0,arguments,"");if(!0!==g(b)){for(var c=this.slice(),c=c.sort.apply(c,arguments),e=0,d=this.length;e<d;e++)this[e]=c[e];b.type="postsort";g(b)}return this}),splice:h(function(b,
c,e){var d=new u(this,b,"splice",void 0,void 0,arguments,"");if(!0!==g(d)){var f=[],k=Array.prototype.slice.call(arguments,2),t=k.length-2,m=0;if(0!==c&&void 0!==this[b-1+c])for(var q=0,l=c;q<l;q++){f.push(this[b+q]);for(var h=b+q,p=this.length-1;h<p;h++)this[h]=this[h+1];delete this[this.length-1]}if(0!==t)for(q=0,l=t;q<l;q++){m=b+Math.min(1,q);h=this.length;for(p=m;h>p;h--)this[h]=this[h-1];this[m]=k[q]}d.type="postsplice";d.listener="";g(d);return f}return[]}),unshift:h(function(){var b=new u(this,
...
"__kbparentupdatelisteners")),addChildDataCreateListener:h(x("addChildDataCreateListener","__kbparentcreatelisteners")),removeChildDataCreateListener:h(B("removeChildDataCreateListener","__kbparentcreatelisteners")),addChildDataDeleteListener:h(x("addChildDataDeleteListener","__kbparentdeletelisteners")),removeChildDataDeleteListener:h(B("removeChildDataDeleteListener","__kbparentdeletelisteners"))});return v}}(),T=function(){return function(){function D(r){if("object"===typeof r)for(var v=0,u=r.length;v<
u;v++)K_Components[r[v]]?A(r[v],K_Components[r[v]],document.getElementById("script_"+r[v])):D.load(r[v],"component/"+r[v]+"/"+location.search,A);else"string"===typeof r&&(K_Components[r[v]]?A(r,K_Components[r],document.getElementById("script_"+r)):D.load(r,"component/"+r+"/"+location.search,A))}var A=function(){},Q=/(<\/.*?>)/g;window.K_Components||(window.K_Components={});D.getUnknowns=function(r){var v=r.match(Q);return v.map(function(r){return r.replace(/[<\/>]/g,"")}).filter(function(r,h){return document.createElement(r)instanceof
HTMLUnknownElement&&-1===v.indexOf(r,h+1)&&!K_Components[r]})};D.load=function(r,v,u){document.head.appendChild(function(h,r,u){var v=document.createElement("script");v.type="text/javascript";v.charset="utf-8";v.async=!0;v.src=r;v.id="script_"+h;v.onload=function(){u(h,K_Components[h],this)};return v}(r,v,u));return D};D.onLoad=function(r){if(void 0===r)return A;A="function"===typeof r?r:A;return D};return D}}(),U=function(D){return function(){function A(l,g){this.name=l.tagName.toLowerCase();this.template=
...
if("object"!==typeof c||void 0===c.value)c={value:c};e.value=c.value}};this.__proto__.updateLoop=function(){e.kb_loop&&e.loop(e.kb_loop)}}var m="attribute"===g&&-1!==F.indexOf(f.name)||"component"===g&&f.name&&-1!==F.indexOf(f.name);m&&k.stopChange().removeAttribute(f.name);Object.defineProperties(t.prototype,{valget:n(r),valset:n(v),refresh:n(O),connect:n(K),deleteMap:n(L),loop:n(P),unsync:n(G),isSynced:n(u),type:n(g),text:n(b,!0),bindText:n(c,!0),bindNames:n("for"===g?[y(c[0])[0]]:H(c),!0),bindListener:n(m?
e.toLowerCase():e),bindProperty:n(m?f.name.toLowerCase():d),bindTarget:n(f,!0),element:n(k,!0),_data:n({},!0),filters:n({},!0),maps:n(l,!0),loop:n(P)});return t}function r(){return this._value}function v(l){this._value=this.isSynced()?l:this._value;this.refresh()}function u(){return this.element.parentElement?!!this.element.parentElement:this.unsync()}function h(l,g){function b(c,b){return b.reduce(function(b,e){return b+("string"===typeof e?e:0===e.filterNames.length?e._value:e.filterNames.reduce(function(b,
...
configurable:!0}}function L(c,b,d,f){if("function"!==typeof b)return p;var k=-1!==["value","checked"].indexOf(c),g=-1!==w.indexOf(c),m;if(this.toString()!==p.toString())if(d){var q=this.querySelectorAll("*");d=q.length;for(var l,h=0;h<d;h++){l=q[h].attrListeners();if(k||"*"===c)void 0!==q[h].addInputBinding&&q[h].addInputBinding(),void 0!==q[h].addInputBoxBinding&&q[h].addInputBoxBinding();if(g)p.injectStyleProperty(q[h],c),m=f?"_parentStyleUpdateListeners":"_parentStyleListeners";else{if("*"===c){m=
f?"_parentStyleUpdateListeners":"_parentStyleListeners";d=w.length;for(var n=0;n<d;n++)p.injectStyleProperty(q[h],w[n]);void 0===l[m]["*"]&&(l[m]["*"]=[]);l[m]["*"].push({parent:this,func:b})}m=f?"_parentAttrUpdateListeners":"_parentAttrListeners"}void 0===l[m][c]&&(l[m][c]=[]);l[m][c].push({parent:this,func:b})}}else{l=this.attrListeners();if(g)m=f?"_styleUpdateListeners":"_styleListeners",p.injectStyleProperty(this,c);else{if(k||"*"===c)void 0!==this.addInputBinding&&this.addInputBinding(),void 0!==
this.addInputBoxBinding&&this.addInputBoxBinding();if("*"===c){m=f?"_styleUpdateListeners":"_styleListeners";d=w.length;for(h=0;h<d;h++)p.injectStyleProperty(this,w[h]);void 0===l[m][c]&&(l[m][c]=[]);l[m][c].push(b)}m=f?"_attrUpdateListeners":"_attrListeners"}void 0===l[m][c]&&(l[m][c]=[]);l[m][c].push(b)}else{if(k||"*"===c)for(n=document.querySelectorAll("input, textarea"),d=n.length,h=0;h<d;h++)void 0!==n[h].addInputBinding&&n[h].addInputBinding(),void 0!==n[h].addInputBoxBinding&&n[h].addInputBoxBinding();
if(g){g=Array.prototype.slice.call(document.body.querySelectorAll("*"));d=g.length+1;g.unshift(document.body);for(h=0;h<d;h++)p.injectStyleProperty(g[h],c);m=f?F:J}else{if("*"===c){g=Array.prototype.slice.call(document.body.querySelectorAll("*"));d=g.length+1;k=w.length;g.unshift(document.body);for(h=0;h<d;h++)for(n=0;n<k;n++)p.injectStyleProperty(g[h],w[n]);m=f?F:J;void 0===m[c]&&(m[c]=[]);m[c].push(b)}m=f?C:I}void 0===m[c]&&(m[c]=[]);m[c].push(b)}}function G(c,b,d,f){function k(c,d){var f=d[c],
g=f.length;for(l=0;l<g;l++)f[l].toString()===b.toString()&&f.splice(l,1)}if("function"!==typeof b)return p;["value","checked"].indexOf(c);var g=-1!==w.indexOf(c),l;if(this.toString()!==p.toString())if(d){d=this.querySelectorAll("*");var q=d.length;g?(g=f?"_childStyleUpdateListeners":"_childStyleListeners",k(c,this.attrListeners()[g]),g=f?"_parentStyleUpdateListeners":"_parentStyleListeners"):("*"===c&&(g=f?"_childStyleUpdateListeners":"_childStyleListeners",k(c,this.attrListeners()[g])),g=f?"_childAttrUpdateListeners":
...
k=Object.keys(F);Object.keys(d._styleListeners);Object.keys(d._styleUpdateListeners);l=Object.keys(d._parentStyleListeners);d=Object.keys(d._parentStyleUpdateListeners);h=[];if(0!==g.length||0!==k.length)h=c(h,g),h=c(h,k);if(0!==h.length&&0!==l.length||0!==d.length)h=c(h,l),h=c(h,d);-1!==h.indexOf("*")&&(h=w);var d=h,g=d.length,n,z,k=[],r,l="outerHTML"===b.attr||"outerText"===b.attr?b.attr:void 0,h=b.target;void 0!==l&&(b.attr="appendChild",b.arguments=[b.target],b.target=b.target.parentElement);
...
k[f],u(c[k[f]],"filters"!==k[f])):d.set(k[f],c[k[f]]);if(c.pointers)for(f=0,k=Object.keys(c.pointers),h=k.length;f<h;f++)d.addPointer(c.pointers[k[f]],k[f]);g.apply(d,b);f=0;k=Object.keys(e);for(h=k.length;f<h;f++)-1!==N.indexOf(k[f])?Object.defineProperty(d,k[f],u(e[k[f]],"filters"!==k[f])):d.set(k[f],e[k[f]]);if(e.pointers)for(f=0,k=Object.keys(e.pointers),h=k.length;f<h;f++)d.addPointer(e.pointers[k[f]],k[f]);f=0;k=Object.keys(d.filters);for(h=k.length;f<h;f++)d.filters[k[f]]=d.filters[k[f]].bind(d);
...
(r.loadWaitList(c.component).loading=!0,h(c.component)));break;case "component":c.connect(b).deleteMap();break;default:c.connect(b)}})})}function D(l,g){x=new K(g,!0);Object.defineProperty(x.wrapper,"__kbcomponenttree",u(g.kb_mapper?g.kb_mapper.__kbcomponenttree:[]));g.parentElement.replaceChild(x.fragment,g);y.unshift(x.wrapper);C(x.wrapper,x,A(l,L[l],y,w,E));if(-1===x.wrapper.__kbcomponenttree.indexOf(l)||x.wrapper.kb_viewmodel.multiple){x.wrapper.__kbcomponenttree.push(l);x.wrapper.classList.add(x.wrapper.kb_viewmodel.local);
for(var b=x.wrapper.querySelectorAll("*"),c=0,e=b.length;c<e;c++)b[c]instanceof HTMLUnknownElement&&r(b[c])}else console.error("Warning!! You are attempting to make a recursive component %o, recursive components can lead to memory stack overflows unless properly handled, Please check your components html for use of this component, if You want this to be a recursive component please set `this.multiple = true;`",l),console.error("Recursive Component %o on %o",x.wrapper,x.wrapper.parentElement),x.wrapper.parentElement.removeChild(x.wrapper)}
var F=z.tagName.toLowerCase(),x,B=Object.keys(HTMLElement.prototype).filter(function(l){return 0===l.indexOf("on")}),w={},E={};void 0===y&&(y=[]);n&&v(n,w);Object.defineProperty(w,"local",u(w.local||F+"-"+Date.now(),!0,!1,!0));Object.defineProperty(w,"filters",u(w.filters||{},!1,!1,!0));"string"===typeof w.sessionStorage&&(w.sessionStorage="true"===w.sessionStorage);Object.defineProperty(w,"sessionStorage",u(void 0!==w.sessionStorage?w.sessionStorage:!1,!0,!1,!0));"string"===typeof w.localStorage&&
(w.localStorage="true"===w.localStorage);Object.defineProperty(w,"localStorage",u(void 0!==w.localStorage?w.localStorage:!1,!0,!1,!0));"string"===typeof w.store&&(w.store="true"===w.store);Object.defineProperty(w,"store",u(void 0!==w.store?w.store:!1,!0,!1,!0));"string"===typeof w.multiple&&(w.multiple="true"===w.multiple);Object.defineProperty(w,"multiple",u(void 0!==w.multiple?w.multiple:!1,!0,!1,!0));p&&v(p,E);E.innerHTML=z.innerHTML.toString();n=0;for(p=z.attributes.length;n<p;n++)E[z.attributes[n].name]=
z.attributes[n].value;n=0;for(p=B.length;n<p;n++)z[B[n]]&&(E[B[n]]=z[B[n]]);z.k_post&&v(z.k_post,E);K.isRegistered(F)?D(F,z):(r.loadWaitList(F,function(l,g){D(F,z)}),r.loadWaitList(F).loading||(r.loadWaitList(F).loading=!0,h(F)))}function v(h,r){var n=Object.keys(h);r.pointers||(r.pointers={});for(var p=0,v=n.length;p<v;p++)if(h.isObservable(n[p]))r.pointers[n[p]]=h;else if(h[n[p]].isMixed())r.pointers[n[p]]=h[n[p]].__kbImmediateParent;else if(Object.prototype.isObject(h[n[p]]))for(var u=0,A=Object.keys(h[n[p]]);u<
v;u++)r[n[p]][A[u]]=h[n[p]][A[u]];else if(Object.prototype.isArray(h[n[p]]))for(u=0;u<v;u++)r[n[p]][u]=h[n[p]][u];else r[n[p]]=h[n[p]]}function u(h,r,n,p){return{value:h,writable:!!r,enumerable:!!p,configurable:!!n}}window.K_Components||(window.K_Components={});var h=A().onLoad(function(h,y){var n="<style>"+unescape(y.prototype.k_css)+"</style>"+unescape(y.prototype.k_html);r.register(h,y,n,y.prototype.cms);r.loadWaitList(h).forEach(function(n){n(h,y)});r.loadWaitList(h,"clear")}),O=D(),K=Q(),P=O({},
"Model"),L={},G=function(){return window.location.search.replace("?","").split("&").filter(function(h){return 0!==h.length}).reduce(function(h,r){h[r.split("=")[0]]=r.split("=")[1];return h},{})}(),N="id filters class sessionStorage localStorage store component multiple".split(" "),H={},M;r.register=function(h,y,n,p){K.register(h,n);L[h]=y;return r};r.loadWaitList=function(h,y){if("undefined"===typeof y&&h)return H[h];if(h){if(void 0===H[h]||"clear"===y){var n=void 0===H[h]?!1:!!H[h].loading;H[h]=
[];H[h].loading=n}"function"===typeof y&&H[h].push(y)}return r};r.localRouting=function(h){h?(M=Node.prototype.appendChild,Node.prototype.appendChild=function(h){if("script"===h.tagName.toLowerCase()){h.src=h.src.substring(0,-1!==h.src.indexOf("?")?h.src.indexOf("?"):h.src.length);var n=h.src.match(/(.*?component\/)/);n&&(G.env||(G.env="prod"),"dev"===G.env&&(G.env="qa"),n=h.src.replace(n[0],"").replace(/[\/\s]/g,""),h.src="/components/"+n+"/build/"+G.env+"/"+n+(G.debug&&"prod"!==G.env?"":".min")+
".js",arguments[0]=h)}return M.apply(this,arguments)}):M&&(Node.prototype.appendChild=M,M=null);return r};return r}}(S,T,U);"undefined"!==typeof window&&"undefined"!==typeof window.define&&"undefined"!==typeof window.require?define([],function(){return R}):"undefined"!==typeof module&&(module.exports=R);return R}();
