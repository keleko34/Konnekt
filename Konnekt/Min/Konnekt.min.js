...
Object.keys(h),g=0,k=y.length;g<k;g++)for(var d=0,n=h[y[g]].length;d<n;d++)c[f[l].method](y[g],h[y[g]][d]);else for(g=0,k=h.length;g<k;g++)c[f[l].method](h[g])}function H(b,c,f){if(v(b,c)||"length"===c){if("length"===c)if(f>b.length&&void 0!==b[f-1])b.length=f;else{if(f<b.length){c=f;for(var y=b.length;c<y;c++)b[c]&&delete b[c];b.length=f}}else b[c]=f;return!0}b.set(c,f)}function O(b,c){b.del(c);return!0}function N(b,c,f){var y=g(f),h=p(f),l=J(f);if(y&&f.__kbname!==b.__kbname)"default"===f.__kbname?
...
"__kbupdatelisteners";y.type="postcreate";k(y)}}}function K(b,c,f,y){var h=g(f),l=p(f),e=J(f);if(h&&f.__kbname!==b.__kbname)"default"===f.__kbname?b.merge(f,c):b.__kbpointers[c]||b.addPointer(f,c);else if(void 0===b[c])-1===m.indexOf(c)?N.call(this,b,c,f):(y?b.stopChange():b)[c]=f;else if(l||e)for(h=0,l=Object.keys(f,"all"),e=l.length;h<e;h++)K.call(this[c],b[c],l[h],f[l[h]],y);else(y?b.stopChange():b)[c]=f}function I(b){return{}.toString.call(b).match(/\s([a-zA-Z]+)/)[1].toLowerCase()}function p(b){return"object"===
I(void 0!==b?b:this)}function J(b){return"array"===I(void 0!==b?b:this)}function g(b){return"mixed"===I(void 0!==b?b:this)}function v(b,c){c="string"===typeof b?b:c;var f=Object.getOwnPropertyDescriptor("string"===typeof b?this:b,c);return f?void 0===f.value:!1}function x(b,c){"number"===typeof b&&(b=b.toString());var f=-1!==b.indexOf(".")?this.__kbnonproxy.setLayer(b):this.__kbnonproxy;-1!==b.indexOf(".")&&(b=b.split(".").pop());var y=new q(this,b,"set",c,this[b],arguments,"__kbmethodlisteners");
!0!==k(y)&&(K.call(this,f,b,c,this._stopChange),this.stopChange=void 0,y.type="postset",y.listener="__kbmethodupdatelisteners",k(y));return this}function G(b){return b.split(".")}function L(b,c){return function(f,y){arguments=Array.prototype.slice.call(arguments);arguments.push(b);var h=this[c],l=new q(this,c,"addlistener",h,void 0,arguments,"");"string"===typeof f&&1!==G(f).length&&(h=G(f),f=h.pop(),h=h.join("."),l.local=this.getLayer(h),h=l.local[c],l.value=h);!0!==k(l)&&(p.call(h)?(void 0===h[f]&&
(h[f]=[]),h[f].push(y),l.type="postaddlistener",k(l)):J.call(h)&&"function"===typeof f&&(h.push(f),l.type="postaddlistener",k(l)));return this}}function C(b,c){return function(f,y){arguments=Array.prototype.slice.call(arguments);arguments.push(b);var h=this[c],l=new q(this,c,"removelistener",h,void 0,arguments,"");"string"===typeof f&&1!==G(f).length&&(h=G(f),h.pop(),h.join("."),l.local=this.getLayer(h),h=l.local[c],l.value=h,f=G(f).pop());if(!0!==k(l))if(p.call(h)){if(void 0!==h[f])for(var e=0,g=
h[f].length;e<g;e++)if(h[f][e].toString()===y.toString()){h[f].splice(e,1);l.type="postremovelistener";k(l);break}}else if(J.call(h)&&"function"===typeof f)for(e=0,g=h.length;e<g;e++)if(h[e].toString()===f.toString()){h.splice(e,1);l.type="postremovelistener";k(l);break}return this}}function A(b,c){function f(b,c,l){var e=Object.keys(this,"all").filter(function(b){return g.call(this[b])}.bind(this)),D=this,k=b;"string"===typeof b&&1!==G(b).length&&(D=G(b),k=D.pop(),D=D.join("."),D=this.getLayer(D),
...
k(l));return this}}function z(b,c){function f(b,c,l){var e=Object.keys(this,"all").filter(function(b){return g.call(this[b])}.bind(this)),k=this,d=b;if("string"===typeof b&&1!==G(b).length){var n=G(b),d=n.pop();n.join(".");k=this.getLayer(n);if(void 0!==k[l][b])for(var n=0,m=k[l][b].length;n<m;n++)if(k[l][b][n].toString()===c.toString()){k[l][b].splice(n,1);break}}if(p.call(k[l])){if(void 0!==k[l][d]){n=0;for(m=k[l][d].length;n<m;n++)if(k[l][d][n].toString()===c.toString()){k[l][d].splice(n,1);break}if(-1!==
...
k(l)&&(f.call(this.__kbnonproxy,e,h,c),l.type="postremovechildlistener",k(l));return this}}var u={set:[],postset:[],create:[],postcreate:[],"delete":[],postdelete:[],splice:[],postsplice:[],push:[],postpush:[],pop:[],postpop:[],shift:[],postshift:[],unshift:[],postunshift:[],fill:[],postfill:[],reverse:[],postreverse:[],sort:[],postsort:[],addlistener:[],postaddlistener:[],removelistener:[],postremovelistener:[],addchildlistener:[],postaddchildlistener:[],removechildlistener:[],postremovechildlistener:[]},
...
prop,f);return this}),addPointer:d(function(){var b=Array.prototype.slice.call(arguments),c=b.shift(),f=b[b.length-1];c instanceof M||(c=new M(c,c.__kbname));var e=new q(this,f,"create",c[f],void 0,[],"__kbcreatelisteners",this._stopChange),h=this.__kbnonproxy;e.root=c.__kbref.__kbproxy;if(!0!==k(e)){Object.defineProperty(h,f,F.apply(h,arguments));h.__kbpointers[f]={keys:b.join("."),point:c};var b=h,c=[{listener:"__kblisteners",method:"addDataListener"},{listener:"__kbupdatelisteners",method:"addDataUpdateListener"}],
h=[],l;if(b[f].__kbImmediateParent)for(var g=0,n=c.length;g<n;g++){l=b[c[g].listener];for(var h=Object.keys(l),d=0,m=h.length;d<m;d++)if(f===h[g])for(var v=0,p=l[h[g]].length;v<p;v++)void 0===b[f].__kbImmediateParent[c[g].listener][f]&&(b[f].__kbImmediateParent[c[g].listener][f]=[]),b[f].__kbImmediateParent[c[g].listener][f].push(l[h[g]][v])}E(b,b[f]);e.listener="__kbupdatelisteners";e.type="postcreate";k(e)}return this}),move:d(function(b,c){this.__kbnonproxy.set(c,b[c]);g(b)?b.del(c):(b[c]=null,
...
splice:d(function(b,c,f){b="string"===typeof b?parseInt(b,10):b;var e=new q(this,b,"splice",void 0,void 0,arguments,"__kbmethodlisteners"),h=this.__kbnonproxy;if(!0!==k(e)){var l=[],g=Array.prototype.slice.call(arguments,2),n=g.length-2,d=0;if(0!==c&&void 0!==h[b-1+c])for(var m=0,v=c;m<v;m++){l.push(h[b+m]);for(var p=b+m,x=this.length-1;p<x;p++)h[p]=h[p+1];h.del(h.length-1,!0)}if(0!==n)for(m=0,v=n;m<v;m++){d=b+Math.min(1,m);p=h.length;for(x=d;p>x;p--)h.set(p,h[p-1]);h.set(d,g[m])}e.type="postsplice";
...
1?null:g(this[e])?0!==b.length-1?(b.shift(),c.call(this[e],b)):this[e]:this}b=G(b);return c.call(this,b)}),setLayer:d(function(b){function c(b){var e=b[0];void 0===this[e]&&0!==b.length-1&&(this[e]=M({},this.__kbname,this,this.__kbscopeString+"."+e));return g(this[e])?0!==b.length-1?(b.shift(),c.call(this[e],b)):this[e]:this}b=G(b);return c.call(this,b)}),ignoreCreate:d(function(b){-1===m.indexOf(b)&&m.push(b);return this}),addActionListener:d(function(b,c){var e=this.__kbnonproxy;void 0!==e.__kbref.__kbevents[b]&&
...
e)for(listenersStyle=f?"_parentStyleUpdateListeners":"_parentStyleListeners",m=c[l].attrListeners()[h][e],d=m.length,p=0;p<d;p++)m[p].isEqualNode(this)&&m.slice(p,1)}}else h?h=f?"_styleUpdateListeners":"_styleListeners":("*"===e&&(h=f?"_styleUpdateListeners":"_styleListeners",k(e,this.attrListeners()[h])),h=f?"_attrUpdateListeners":"_attrListeners"),k(e,this.attrListeners()[h]);else h?h=f?L:G:("*"===e&&(h=f?L:G,k(e,h)),h=f?x:v),k(e,h)}function O(e,b){g.addAttrListener.call(this,e,b,!0);return this}
function N(e,b){g.addAttrUpdateListener.call(this,e,b,!0);return this}function K(e,b){g.removeAttrListener.call(this,e,b,!0);return this}function I(e,b){g.removeAttrUpdateListener.call(this,e,b,!0);return this}function p(e,b,c){var f=this.attrListeners();"html"===b&&(b="innerHTML");"events"===b&&(b="onclick");switch(e){case "attr":if(w(f._attrListeners[b],c))return!0;break;case "attrupdate":if(w(f._attrUpdateListeners[b],c))return!0}return!1}function J(){this._stopChange=!0;return this}function g(){function e(b,
c){var e,f=c.length;for(e=0;e<f;e++)-1===b.indexOf(c[e])&&b.push(c[e]);return b}function b(b,c){for(var e=Object.keys(b),f,h,g=0,l=e.length;g<l;g++)if(f=e[g],void 0===c[f])c[f]=b[f].slice();else for(var k=0,n=b[f].length;k<n;k++)h=b[f][k],c[f].push(h)}function c(c){if(3!==c.target.nodeType&&8!==c.target.nodeType){var f=c.target.attrListeners(),h,l=["value","checked"],k=f._attrListeners,n=f._attrUpdateListeners,m=f._parentAttrListeners;h=f._parentAttrUpdateListeners;var d=!1;if(void 0!==v["*"]||void 0!==
x["*"])d=!0;if(!0!==d&&void 0!==k["*"]||void 0!==n["*"]||void 0!==m["*"]||void 0!==h["*"])d=!0;if(!0!==d)for(var p=0;p<l.length;p++)if(void 0!==v[l[p]]||void 0!==x[l[p]]||void 0!==k[l[p]]||void 0!==n[l[p]]||void 0!==m[l[p]]||void 0!==h[l[p]]){d=!0;break}h=d;l=Object.keys(G);k=Object.keys(L);Object.keys(f._styleListeners);Object.keys(f._styleUpdateListeners);n=Object.keys(f._parentStyleListeners);f=Object.keys(f._parentStyleUpdateListeners);m=[];if(0!==l.length||0!==k.length)m=e(m,l),m=e(m,k);if(0!==
...
k.unshift(c.arguments[0])):k=Array.prototype.slice.call(c.target.querySelectorAll("input,textarea"));t=k.length;for(var u=0;u<t;u++)void 0!==k[u].addInputBinding&&k[u].addInputBinding(),void 0!==k[u].addInputBoxBinding&&k[u].addInputBoxBinding()}"appendChild"===c.attr&&"#text"!==c.arguments[0].nodeName&&"#comment"!==c.arguments[0].nodeName?(k=Array.prototype.slice.call(c.arguments[0].querySelectorAll("*")),k.unshift(c.arguments[0])):k=Array.prototype.slice.call(c.target.querySelectorAll("*"));h=c.target.__kb._parentAttrListeners;
d=c.target.__kb._parentAttrUpdateListeners;p=c.target.__kb._parentStyleListeners;y=c.target.__kb._parentStyleUpdateListeners;t=k.length;for(u=0;u<t;u++){if(0!==l)for(q=0;q<l;q++)g.injectStyleProperty(k[u],f[q]);q=k[u].attrListeners();b(h,q._parentAttrListeners);b(d,q._parentAttrUpdateListeners);b(p,q._parentStyleListeners);b(y,q._parentStyleUpdateListeners)}void 0!==n&&(c.attr=n,c.target=m,c.arguments=[])}}function f(b){var c=b.target.attributes[b.arguments[0]],e="setAttribute"===b.attr?b.arguments[1]:
...
var h=n,l=k;g.addAttrUpdateListener("appendChild",c);g.addAttrUpdateListener("removeChild",c);g.addAttrUpdateListener("innerHTML",c);g.addAttrUpdateListener("outerHTML",c);g.addAttrUpdateListener("innerText",c);g.addAttrUpdateListener("outerText",c);g.addAttrUpdateListener("textContent",c);g.addAttrListener("setAttribute",f);g.addAttrListener("removeAttribute",f);g.addAttrUpdateListener("setAttribute",m);g.addAttrUpdateListener("removeAttribute",m);return g}var v={},x={},G={},L={},C={},A="textContent innerHTML innerText outerHTML outerText appendChild removeChild replaceChild insertAdjacentHTML insertBefore".split(" "),
z=Object.getOwnPropertyNames(document.documentElement.style),u=Object.keys(HTMLElement.prototype).filter(function(e){return 0===e.indexOf("on")}).concat(["addEventListener","removeEventListener"]),m,n=function(e,b,c,f,g,h){c=new B(e,b,c,f,g,void 0,"set",h);void 0!==e.__kb&&(f=e.__kb._attrListeners,g=e.__kb._styleListeners,h=e.__kb._parentAttrListeners,e=e.__kb._parentStyleListeners,void 0!==f[b]&&t(f[b],c),void 0===c._stopPropogation&&void 0!==g[b]&&t(g[b],c),void 0===c._stopPropogation&&void 0!==
f["*"]&&(t(f["*"],c),void 0===c._stopPropogation&&t(g["*"],c)),void 0===c._stopPropogation&&void 0!==h[b]&&r(h[b],c),void 0===c._stopPropogation&&void 0!==e[b]&&r(e[b],c),void 0===c._stopPropogation&&void 0!==h["*"]&&(r(h["*"],c),void 0===c._stopPropogation&&r(e["*"],c)));void 0===c._stopPropogation&&void 0!==v[b]&&t(v[b],c);void 0===c._stopPropogation&&void 0!==G[b]&&t(G[b],c);void 0===c._stopPropogation&&void 0!==v["*"]&&(t(v["*"],c),void 0===c._stopPropogation&&t(G["*"],c));return void 0!==c._preventDefault?
...
"");var v=C[c];f=f||n;m=m||k;void 0===h.attrListeners&&(h={},h.attrListeners=function(){void 0===this.__kb&&(this.__kb=new q);return this.__kb}.bind(h),h.addAttrListener=g.addAttrListener,h.addAttrUpdateListener=g.addAttrUpdateListener,h.addChildAttrListener=O,h.addChildAttrUpdateListener=N,h.hasListener=p,h.removeAttrListener=g.removeAttrListener,h.removeAttrUpdateListener=g.removeAttrUpdateListener,h.removeChildAttrListener=K,h.removeChildAttrUpdateListener=I,h.stopChange=J);void 0===v&&(C[c]={obj:e,
proto:h,descriptors:{},set:void 0,update:void 0},v=C[c],v.set=f,v.update=m);void 0===v.descriptors[b]&&(v.descriptors[b]=l);l.configurable&&(void 0!==l.set?Object.defineProperty(h,b,{get:l.get,set:d(l,b,f,m),enumerable:!0,configurable:!0}):"function"===typeof l.value?Object.defineProperty(h,b,{value:P(l,b,f,m),writable:!0,enumerable:!0,configurable:!0}):void 0!==l.value&&Object.defineProperty(h,b,{get:function(){return l.value},set:Q(l,b,f,m),enumerable:!0,configurable:!0}));return g};g.injectStyleProperty=
function(e,b,c,f){var m=e.style,h=Object.getOwnPropertyDescriptor(m,b),l=e.attrListeners().injectedStyle;c=c||n;f=f||k;void 0===l&&(e.attrListeners().injectedStyle={obj:e,proto:m,descriptors:{},set:void 0,update:void 0},e.attrListeners().injectedStyle.set=c,e.attrListeners().injectedStyle.update=f,l=e.attrListeners().injectedStyle);void 0===l.descriptors[b]&&(l.descriptors[b]=h);h.configurable&&Object.defineProperty(m,b,F(h,b,c,f,e));return g};g.injectPrototypes=function(e,b,c,f){var m=e.prototype;
...
m.removeChildAttrUpdateListener=I,m.hasListener=p,m.stopChange=J);void 0===h&&(C[b]={obj:e,proto:m,descriptors:{},set:void 0,update:void 0},h=C[b],h.set=c,h.update=f);d=C[b].descriptors;for(f=0;f<l.length;f+=1)void 0===d[l[f]]&&g.injectPrototypeProperty(e,l[f],b,c,k);if(-1!==l.indexOf("value")){var v=function(b){var c,e,f;if("checkbox"===this.type||"radio"===this.type)c=!0;e=c?"string"===typeof this.checked?this.checked:this.checked?"true":"false":this.value;setTimeout(function(){f=c?"string"===typeof this.checked?
this.checked:this.checked?"true":"false":this.value;c&&(h.set(this,"checked",this.checked,e)?h.update(this,"checked",this.checked,e):d.checked.set.call(this,e));this.value!==f&&(this.value=f);h.set(this,"value",this.value,e)?h.update(this,"value",this.value,e):d.value.set.call(this,e)}.bind(this),0)};m.removeInputBinding=function(){this.attrListeners()._onkeydown=void 0;this.removeEventListener("keydown",v)};m.addInputBinding=function(){this.attrListeners()._onkeydown=!0;this.addEventListener("keydown",
v)};m.removeInputBoxBinding=function(){this.attrListeners()._onmousedown=void 0;this.removeEventListener("mouseup",v)};m.addInputBoxBinding=function(){this.attrListeners()._onmousedown=!0;this.addEventListener("mouseup",v)}}return g};g.addAttrListener=function(e,b,c){if("html"===e){e=0;for(var f=A.length;e<f;e++)E.call(this,A[e],b,c,!1)}else if("events"===e)for(e=0,f=u.length;e<f;e++)E.call(this,u[e],b,c,!1);else E.call(this,e,b,c,!1);return this};g.addAttrUpdateListener=function(e,b,c){if("html"===
e){e=0;for(var f=A.length;e<f;e++)E.call(this,A[e],b,c,!0)}else if("events"===e)for(e=0,f=u.length;e<f;e++)E.call(this,u[e],b,c,!0);else E.call(this,e,b,c,!0);return this};g.removeAttrListener=function(e,b,c){if("html"===e){e=0;for(var f=A.length;e<f;e++)H.call(this,A[e],b,c,!1)}else if("events"===e)for(e=0,f=u.length;e<f;e++)H.call(this,u[e],b,c,!1);else H.call(this,e,b,c,!1);return this};g.removeAttrUpdateListener=function(e,b,c){if("html"===e){e=0;for(var f=A.length;e<f;e++)H.call(this,A[e],b,
c,!0)}else if("events"===e)for(e=0,f=u.length;e<f;e++)H.call(this,u[e],b,c,!0);else H.call(this,e,b,c,!0);return this};g.hasListener=function(e,b,c){"html"===b&&(b="innerHTML");"events"===b&&(b="onclick");switch(e){case "attr":if(w(v[b],c))return!0;break;case "attrupdate":if(w(x[b],c))return!0}return!1};g.injectedPrototypes=function(){return C};return g}"function"===typeof define&&define.amd&&define("KB",B);return B}(),V=function(B){return function(){function t(d){document.createDocumentFragment();
this.name=d.tagName.toLowerCase();this.template=O[this.name]||'<div class="missing_component">Unknown Component</div>';this.node=d;this.fragment=document.createDocumentFragment();this.wrapper=this.fragment.appendChild(document.createElement("div"));this.wrapper.className="Wrapper Wrapper__"+this.name}function r(d,q,g,v){return{value:d,writable:!!q,enumerable:!!v,configurable:!!g}}function w(){return new RegExp("(\\"+F.split("").join("\\")+")(.*?)(\\"+E.split("").join("\\")+")","g")}function M(d){return d.split(new RegExp("("+
F.split("").join("\\")+")(.*?)("+E.split("").join("\\")+")","g")).map(function(d,g,p){return p[g-1]===F?F+d+E:d}).filter(function(d,g,p){return 0!==d.length&&d!==F&&d!==E&&0!==d.length})}function q(d){return d.replace(new RegExp("["+F+E+"]","g"),"").replace(new RegExp("\\"+H.split("").join("\\")+"(.*)"),"").replace(/\s/g,"")}function d(d){return d.reduce(function(d,g){g.match(/(\()(.*?)(\))/)?d.vmFilters[d.vmFilters.length]=g.replace(/[\(\)]/g,""):g.match(/(\[)(.*?)(\])/)?-1!==g.indexOf("~")?d.model[d.model.length]=
g.replace(/[\[\]\~]/g,""):-1!==g.indexOf("+")?d.local[d.local.length]=g.replace(/[\[\]\+]/g,""):d.session[d.session.length]=g.replace(/[\[\]\-]/g,""):d.filters[d.filters.length]=g;return d},{filters:[],vmFilters:[],model:[],local:[],session:[]})}function Q(d){return-1!==d.indexOf("for")?d.replace(new RegExp("["+F+E+"]","g"),"").replace(/\|(.*)/,"").replace(/\s/g,"").split(/for(.*?)loop/).filter(function(d){return 0!==d.length}):[]}function P(){function p(g,n){this.text=g;this.key=n;this.keyLength=
this.key.split(".").length;this.localKey=this.key.split(".").pop();var k;k=-1!==g.indexOf(H)?g.replace(new RegExp("["+E+"]","g"),"").replace(new RegExp("(.*?)(\\"+H.split("").join("\\")+")"),"").replace(/\s/g,"").split(","):[];this.filters=d(k);this.component="for"===this.type?Q(g)[1]:void 0;this.id=0}function q(m){if(0!==m.length){for(var d="",k=0,e=m.length;k<e;k++)d="string"===typeof m[k]?d+m[k]:void 0===m[k]._data?d+m[k].text:d+g(m[k]._data.get(m[k].key),m[k].filters.filters,m[k]._data.filters);
return d}return g(m[0]._data.get(m[0].key),m[0].filters.filters,m[0]._data.filters)}function g(g,d,k){return d.reduce(function(e,b){return k[b]?k[b](e):e},g)}function v(g,d,k,e){return d.reduce(function(b,c){return k[c]?k[c](b,e):b},g)}function x(g,d){for(var k=0,e=d.length;k<e;k++)g.stopChange().appendChild(d[k])}function t(g){if(g&&window.model)return window.model.get(g[0])}function w(g,d){if(d&&0!==d.length&&window.model)for(var k=0,e=d.length;k<e;k++)window.model.set(d[k],g)}function C(g){if(g&&
window.localStorage)return localStorage.getItem(g[0])}function A(g,d){if(g&&0!==g.length&&window.localStorage)for(var k=0,e=g.length;k<e;k++)localStorage.setItem(g[k],d)}function z(g){if(g&&window.sessionStorage)return sessionStorage.getItem(g[0])}function u(g,d){if(g&&0!==g.length&&window.sessionStorage)for(var k=0,e=g.length;k<e;k++)sessionStorage.setItem(g[k],d)}Object.defineProperties(p.prototype,{addPointer:r(function(g){for(var d=document.createElement(this.component),k=v(this._data.getLayer(this.key),
this.filters.filters,this._data.filters,g)[g],e=0,b=Object.keys(k,"all"),c=b.length;e<c;e++)d.k_post||(d.k_post={}),d.k_post[b[e]]=k;g>=this.node.children.length?this.node.stopChange().appendChild(d):this.node.stopChange().insertBefore(d,this.node.children[g]);g={event:"loopitem",node:d,parent:this.node};d=I[g.event];k=0;for(e=d.length;k<e;k++)d[k](g);return this}),removePointer:r(function(g){for(var d=this.node.children[g].kb_maps,k=0,e=Object.keys(this.node.children[g].kb_viewmodel.pointers),b=
...
"";for(var g=0,d=v(this._data.get(this.key),this.filters.filters,this._data.filters).length;g<d;g++)this.setLoop(g,"create");return this}),setData:r(function(d){d=g(d,this.filters.vmFilters,this._data.filters);this._data.stopChange().set(this.key,d);w(this.filters.model,d);u(this.filters.session,d);A(this.filters.local,d);return this}),setDom:r(function(g){w(this.filters.model,g);u(this.filters.session,g);A(this.filters.local,g);this.isEvent?this.node.stopChange()[this.attr]=this._data.get(this.key):
...
e;k++)this.reapplyPointer(k)}return this}),bindMaps:r([]),unsync:r(function(){this._data=this.__proto__.bindText=null;delete this._data;this.bindMaps=null;delete this.bindMaps;this.binds=null;delete this.binds;return this})});return p}var F="{{",E="}}",H="|",O={},N=/(<\/.*?>)/g;B().call();var K=Object.keys(HTMLElement.prototype).filter(function(d){return 0===d.indexOf("on")}),I={loopitem:[]};t.start=function(d){if(void 0===d)return F;F="string"===typeof d?d:F;return t};t.end=function(d){if(void 0===
d)return E;E="string"===typeof d?d:E;return t};t.pipe=function(d){if(void 0===d)return H;H="string"===typeof d?d:H;return t};t.getUnknown=function(d){var q=d.match(N).map(function(g){return g.replace(/[<\/>]/g,"")});q.filter(function(g,d){return document.createElement(g)instanceof HTMLUnknownElement&&-1===q.indexOf(g,d+1)&&void 0===O[g]});return q};t.isRegistered=function(d){return void 0!==O[d]};t.register=function(d,q){void 0===O[d]?(O[d]=q,t.getUnknown(q)):console.error("Class: KonnektMP Method: 'register', A template by the name %o already exists",
d);return this};t.addEventListener=function(d,q){void 0!==I[d]?I[d].push(q):console.error("Class: KonnektMP Method: 'addEventListener', No event exists with the name %o",d);return t};t.removeEventListener=function(d,q){if(void 0!==I[d])for(var g=0,v=I[d].length;g<v;g++)I[d][g].toString()===q.toString()&&I[d].splice(g,1);else console.error("Class: KonnektMP Method: 'removeEventListener', No event exists with the name %o",d);return t};Object.defineProperties(t.prototype,{register:r(t.register),isRegistered:r(t.isRegistered),
getUnknown:r(t.getUnknown),map:r(function(d){function t(g,v){for(var x=0,G=g.length;x<G;x++)if(void 0===g[x].kb_maps&&8!==g[x].nodeType){g[x].kb_mapper=d;g[x].kb_maps=v;if(3===g[x].nodeType){var r=g[x],C=v,A=r.textContent;if(A.match(w())){var z=M(A),u=P();u.prototype.type=A.match(new RegExp("(\\"+F.split("").join("\\")+")(.*?)(for)(.*?)(loop)(.*?)(\\"+E.split("").join("\\")+")","g"))?"for":"text";u.prototype.text=A;u.prototype.bindText=z;u.prototype.listener="textContent";u.prototype.attr="textContent";
u.prototype.localAttr="textContent";u.prototype.local=r;u.prototype.node=r.parentElement;u.prototype.binds=C;r=0;for(A=z.length;r<A;r++)if(0===z[r].indexOf(F)){var m="for"===u.prototype.type?Q(z[r])[0]:q(z[r]),n=new u(z[r],m);void 0===C[m]&&(C[m]=[]);n.bindText[r]=n;n.bindMaps.push(n);n.id=C[m].length;C[m].push(n)}}}else for(C=g[x],z=v,u=Array.prototype.slice.call(C.attributes),r=C instanceof HTMLUnknownElement,A=0,m=u.length;A<m;A++)if(u[A].value.match(w())){var n=M(u[A].value),k=P();k.prototype.type=
r?"component":"attribute";k.prototype.text=u[A].value;k.prototype.bindText=n;k.prototype.isEvent=-1!==K.indexOf(u[A].name);k.prototype.isInput="input"===C.tagName.toLowerCase();k.prototype.isRadio=k.prototype.isInput?-1!==["radio","checkbox"].indexOf(C.type):!1;k.prototype.listener=u[A].name;k.prototype.attr=u[A].name;k.prototype.localAttr="value";k.prototype.local=u[A];k.prototype.node=C;k.prototype.binds=z;k.prototype.isEvent&&C.removeAttribute(u[A].name);for(var e=0,b=n.length;e<b;e++)if(0===n[e].indexOf(F)){var c=
q(n[e]),f=new k(n[e],c);void 0===z[c]&&(z[c]=[]);f.bindText[e]=f;f.bindMaps.push(f);f.id=z[c].length;z[c].push(f)}}g[x].childNodes&&0!==g[x].childNodes.length&&(v=t(g[x].childNodes,v))}return v}return t(d.childNodes,{})})});return t}}(S),W=function(){return function(){function B(w){0===w.length&&(w=t);document.body.innerHTML="<"+w+"></"+w+">";r(w);return B}var t="",r=function(){};B.base=function(r){if(void 0===r)return t;t="string"===typeof r?r:t;return B};B.onChange=function(t){if(void 0===t)return r;
r="function"===typeof t?t:r;return B};B.watch=function(t){window.onhashchange=t?function(){B(window.location.hash.replace("#",""))}:null;return B};return B}}(),R=function(B,t,r,w,M){return function(){function q(g,v,x,p){function t(e,b,c,f,g){for(var h=F({},e),d=0,k=Object.keys(b.prototype),m=k.length;d<m;d++)h.__proto__[k[d]]=b.prototype[k[d]];d=0;k=Object.keys(f);for(m=k.length;d<m;d++)-1!==I.indexOf(k[d])?Object.defineProperty(h,k[d],r(f[k[d]],"filters"!==k[d])):f.pointers?void 0===f.pointers[k[d]]&&
h.set(k[d],f[k[d]]):h.set(k[d],f[k[d]]);if(f.pointers)for(h.pointers||Object.defineProperty(h,"pointers",r({},!1,!0)),d=0,k=Object.keys(f.pointers),m=k.length;d<m;d++)h.pointers[k[d]]=f.pointers[k[d]],h.addPointer(h.pointers[k[d]].point,h.pointers[k[d]].key,k[d]);b.apply(h,c);d=0;k=Object.keys(g);for(m=k.length;d<m;d++)-1!==I.indexOf(k[d])?Object.defineProperty(h,k[d],r(g[k[d]],"filters"!==k[d])):g.pointers?void 0===g.pointers[k[d]]&&h.set(k[d],g[k[d]]):h.set(k[d],g[k[d]]);if(g.pointers)for(h.pointers||
...
function(){sessionStorage.setItem(h.id||e,h.stringify())})}if(h.localStorage){if(b=localStorage.getItem(h.id||e))for(b=JSON.parse(b),d=0,k=Object.keys(b),m=k.length;d<m;d++)h.set(k[d],b[k[d]]);else localStorage.setItem(h.id||e,h.stringify());h.addChildDataUpdateListener("*",function(){localStorage.setItem(h.id||e,h.stringify())})}h.store&&O.set(h.id||e,h);return h}function w(e,b,c){e.kb_viewmodel=c;b.wrapper.innerHTML=E.insert(b.template,c);var d=b.maps=b.map(b.wrapper);b.wrapper.kb_maps=d;Object.keys(d).forEach(function(b){d[b].forEach(function(b){switch(b.type){case "for":b.connect(c).createloop();
break;case "component":b.connect(c).unsync();break;default:b.connect(c)}})});b.wrapper.kb_viewmodel.onFinish.call(b.wrapper.kb_viewmodel,b.wrapper)}function A(e,b){u=new E(b,!0);Object.defineProperty(u.wrapper,"__kbcomponenttree",r(b.kb_mapper?b.kb_mapper.__kbcomponenttree.slice():[]));b.parentElement.replaceChild(u.fragment,b);v.unshift(u.wrapper);w(u.wrapper,u,t(e,N[e],v,n,k));if(-1===u.wrapper.__kbcomponenttree.indexOf(e)||u.wrapper.kb_viewmodel.multiple){u.wrapper.__kbcomponenttree.push(e);u.wrapper.className+=
" "+u.wrapper.kb_viewmodel.local;u.wrapper.className+=u.wrapper.kb_viewmodel.loopid?" "+u.wrapper.kb_viewmodel.loopid:"";for(var c=u.wrapper.querySelectorAll("*"),d=0,g=c.length;d<g;d++)c[d]instanceof HTMLUnknownElement&&q(c[d])}else console.error("Warning!! You are attempting to make a recursive component %o, recursive components can lead to memory stack overflows unless properly handled, Please check your components html for use of this component, if You want this to be a recursive component please set `this.multiple = true;`",
e),console.error("Recursive Component %o on %o",u.wrapper,u.wrapper.parentElement),u.wrapper.parentElement.removeChild(u.wrapper)}var z=g.tagName.toLowerCase(),u,m=Object.keys(HTMLElement.prototype).filter(function(e){return 0===e.indexOf("on")}),n={},k={};void 0===v&&(v=[]);x&&d(x,n);Object.defineProperty(n,"local",r(n.local||z+"-"+Date.now(),!0,!1,!0));Object.defineProperty(n,"filters",r(n.filters||{},!1,!1,!0));"function"!==typeof n.onFinish&&(n.onFinish=function(){});Object.defineProperty(n,"onFinish",
...
!0,P(z)))}function d(d,v){var q=Object.keys(d);v.pointers||Object.defineProperty(v,"pointers",{value:{},writable:!0,enumerable:!1,configurable:!0});for(var p=0,t=q.length;p<t;p++)if(F.prototype.isObservable(d,q[p]))v.pointers[q[p]]={key:d.__kbscopeString.split(".").pop(),point:d.__kbImmediateParent};else if(F.prototype.isMixed(d[q[p]]))v.pointers[q[p]]={key:d[q[p]].__kbscopeString.split(".").pop(),point:d[q[p]].__kbImmediateParent};else if(F.prototype.isObject(d[q[p]]))for(var r=0,w=Object.keys(d[q[p]]);r<
t;r++)v[q[p]][w[r]]=d[q[p]][w[r]];else if(F.prototype.isArray(d[q[p]]))for(r=0;r<t;r++)v[q[p]][r]=d[q[p]][r];else v[q[p]]=d[q[p]]}function r(d,q,p,t){return{value:d,writable:!!q,enumerable:!!t,configurable:!!p}}window.K_Components||(window.K_Components={});var P=t().onLoad(function(d,p){var r="<style>"+unescape(p.prototype.k_css)+"</style>"+unescape(p.prototype.k_html);q.register(d,p,r,p.prototype.cms);q.loadWaitList(d).forEach(function(q){q(d,p)});q.loadWaitList(d,"clear")}),F=B(),E=w().addEventListener("loopitem",
function(d){var p=d.node.tagName.toLowerCase();q.isRegistered(p)||d.node.kb_isLoading?q.isRegistered(p)&&q(d.node):(d.node.kb_isLoading=!0,q.loadWaitList(p,function(p,r){q(d.node)}),q.loadWaitList(p).loading||(q.loadWaitList(p).loading=!0,P(p)))}),H=M().base(void 0!==config&&void 0!==config.base?config.base:"default").watch(!0).onChange(function(d){q(document.querySelector(d))}),O=F({},"Model"),N={},K=function(){return window.location.search.replace("?","").split("&").filter(function(d){return 0!==
d.length}).reduce(function(d,p){d[p.split("=")[0]]=p.split("=")[1];return d},{})}(),I="id filters class sessionStorage localStorage store component multiple".split(" "),p={},J;q.register=function(d,p,r,t){E.register(d,r);N[d]=p;return q};q.isRegistered=function(d){return void 0!==N[d]&&E.isRegistered(d)};q.registered=function(){return Object.keys(N)};q.loadWaitList=function(d,r){if("undefined"===typeof r&&d)return p[d];if(d){if(void 0===p[d]||"clear"===r){var t=void 0===p[d]?!1:!!p[d].loading;p[d]=
[];p[d].loading=t}"function"===typeof r&&p[d].push(r)}return q};q.localRouting=function(d){d?(J=Node.prototype.appendChild,Node.prototype.appendChild=function(d){if("script"===d.nodeName.toLowerCase()){d.src=d.src.substring(0,-1!==d.src.indexOf("?")?d.src.indexOf("?"):d.src.length);var g=d.src.match(/(.*?component\/)/);g&&(K.env||(K.env="prod"),"dev"===K.env&&(K.env="qa"),g=d.src.replace(g[0],"").replace(/[\/\s]/g,""),d.src="/components/"+g+"/build/"+K.env+"/"+g+(K.debug&&"prod"!==K.env?"":".min")+
".js",arguments[0]=d)}return J.apply(this,arguments)}):J&&(Node.prototype.appendChild=J,J=null);return q};q.hashRouting=function(d){d&&(document.body?H(window.location.hash.replace("#","")):document.addEventListener("DOMContentLoaded",function(){H(window.location.hash.replace("#",""))}))};return q}}(T,U,S,V,W);"undefined"!==typeof window&&"undefined"!==typeof window.define&&"undefined"!==typeof window.require?define([],function(){return R}):"undefined"!==typeof module&&(module.exports=R);return R}();
