...
void 0,arguments,"");"string"===typeof d&&1!==C(d).length&&(h=C(d),h.pop(),h.join("."),k.local=this.getLayer(h),h=k.local[c],k.value=h,d=C(d).pop());!0!==l(k)&&(w.call(h)?(void 0===h[d]&&(h[d]=[]),h[d].push(e),k.type="postaddlistener",l(k)):r.call(h)&&"function"===typeof d&&(h.push(d),k.type="postaddlistener",l(k)));return this}}function D(b,c){return function(d,e){arguments=Array.prototype.slice.call(arguments);arguments.push(b);var h=this[c],k=new v(this,c,"removelistener",h,void 0,arguments,"");
"string"===typeof d&&1!==C(d).length&&(h=C(d),h.pop(),h.join("."),k.local=this.getLayer(h),h=k.local[c],k.value=h,d=C(d).pop());if(!0!==l(k))if(w.call(h)){if(void 0!==h[d])for(var n=0,m=h[d].length;n<m;n++)if(h[d][n].toString()===e.toString()){h[d].splice(n,1);k.type="postremovelistener";l(k);break}}else if(r.call(h)&&"function"===typeof d)for(n=0,m=h.length;n<m;n++)if(h[n].toString()===e.toString()){h.splice(n,1);k.type="postremovelistener";l(k);break}return this}}function A(b,c){function d(c,b,
k){var n=Object.keys(this,"all").filter(function(c){return t.call(this[c])}.bind(this)),m=this,p=c;"string"===typeof c&&1!==C(c).length&&(m=C(c),p=m.pop(),m.join("."),m=this.getLayer(m),void 0===m[k][c]&&(m[k][c]=[]),m[k][c].push(b));w.call(m[k])?(void 0===m[k][p]&&(m[k][p]=[]),m[k][p].push(b),void 0!==m.__kbpointers[p]&&(void 0===m.__kbpointers[p][p]&&(m.__kbpointers[p][p]=[]),m.__kbpointers[p][p].push(_func))):m[k].push(b);p=0;for(m=n.length;p<m;p++)d.call(this[n[p]],c,b,k)}return function(e,h){arguments=
Array.prototype.slice.call(arguments);arguments.push(b);var k=new v(this,c,"addchildlistener",void 0,void 0,arguments,"");!0!==l(k)&&(d.call(this,e,h,c),k.type="postaddchildlistener",l(k));return this}}function u(b,c){function d(c,b,k){var n=Object.keys(this,"all").filter(function(c){return t.call(this[c])}.bind(this)),m=this,p=c;if("string"===typeof c&&1!==C(c).length&&(m=C(c),p=m.pop(),m.join("."),m=this.getLayer(m),void 0!==m[k][c]))for(var f=0,l=m[k][c].length;f<l;f++)if(m[k][c][f].toString()===
b.toString()){m[k][c].splice(f,1);break}if(w.call(m[k])){if(void 0!==m[k][p]){f=0;for(l=m[k][p].length;f<l;f++)if(m[k][p][f].toString()===b.toString()){m[k][p].splice(f,1);break}if(-1!==m.__kbpointers.indexOf(p)&&void 0!==m[p].__kbImmediateParent[k][p])for(f=0,l=m[p].__kbImmediateParent[k][p].length;f<l;f++)if(m[p].__kbImmediateParent[k][p][f].toString()===b.toString()){m[p].__kbImmediateParent[k][p].splice(f,1);break}}}else for(f=0,l=m[k].length;f<l;f++)if(m[k][f].toString()===b.toString()){m[k].splice(f,
...
10))})};Object.defineProperties(Object.prototype,{"typeof":g(function(b){return{}.toString.call(b).match(/\s([a-zA-Z]+)/)[1].toLowerCase()},!1,!0),sizeof:g(function(b){function c(b){for(var h=Object.keys(b,"all"),k=0,n=void 0,f=0,p=h.length;f<p;f++)n=b[h[f]],"object"===typeof n&&void 0!==n&&null!==n?-1===d.indexOf(n)&&(d.push(n),k+=c(n)):"string"===typeof n?k+=2*n.length:"number"===typeof n?k+=8:"boolean"===typeof n?k+=4:"function"===typeof n&&(k+=2*n.toString().length),k+=2*h[f].length;return k}
if(this==Object.prototype&&void 0===b)return console.error("No object specified in Object.prototype.sizeof");var d=[];return c(b||this)+" Bytes (Rough estimate)"},!1,!0),isObject:g(w,!1,!0),isArray:g(r,!1,!0),isMixed:g(t,!1,!0),isObservable:g(J,!1,!0),stringify:g(function(b){if(this==Object.prototype&&void 0===b)return console.error("No object was specified in Object.prototype.stringify to stringify");var c=[];return JSON.stringify(this,function(d,b){if(r(b)||w(b)){if(-1!==c.indexOf(b))return;c.push(b)}return b})},
...
c);Object.defineProperty(this,c,Q(b,c,d));this.__kbpointers[c]=b}),move:g(function(b,c){this[c]=b[c];b instanceof x||(b[c]=null);delete b[c];return this}),copy:g(function(b,c){this[c]=b[c];return this}),merge:g(function(b){function c(b,h){for(var k=b instanceof x?b.keys("o"):Object.keys(b),n,f=0,p=k.length;f<p;f++)n=b[k[f]],"object"===typeof n&&-1===d.indexOf(n)&&"undefined"!==h[k[f]]?c(n,h):h[k[f]]=n}var d=[];c(b,this);return this}),copyWithin:g(function(b,c,d){c=c||0;d=d||0;var e=new v(this,b,"copyWithin",
...
c,d){var e=new v(this,b,"splice",void 0,void 0,arguments,"");if(!0!==l(e)){var h=[],k=Array.prototype.slice.call(arguments,2),n=k.length-2,f=0;if(0!==c&&void 0!==this[b-1+c])for(var p=0,g=c;p<g;p++){h.push(this[b+p]);for(var I=b+p,S=this.length-1;I<S;I++)this[I]=this[I+1];delete this[this.length-1]}if(0!==n)for(p=0,g=n;p<g;p++){f=b+Math.min(1,p);I=this.length;for(S=f;I>S;I--)this[I]=this[I-1];this[f]=k[p]}e.type="postsplice";e.listener="";l(e);return h}return[]}),unshift:g(function(){var b=new v(this,
0,"unshift",this[0],void 0,arguments,"");if(!0!==l(b)){for(var c=Array.prototype.slice.call(arguments),d=this.length-1+c.length,e=c.length;-1!==d;d--)this[d]=d<e?c[d]:this[d-c.length];b.type="postunshift";l(b)}return this.length}),getLayer:g(function(b){function c(b){var e=b[0];return void 0===this[e]&&0!==b.length-1?null:t(this[e])?0!==b.length-1?(b.shift(),c.call(this[e],b)):this[e]:this}b=C(b);return c.call(this,b)}),setLayer:g(function(b){function c(b){var e=b[0];void 0===this[e]&&0!==b.length-
...
"__kbparentupdatelisteners")),addChildDataCreateListener:g(A("addChildDataCreateListener","__kbparentcreatelisteners")),removeChildDataCreateListener:g(u("removeChildDataCreateListener","__kbparentcreatelisteners")),addChildDataDeleteListener:g(A("addChildDataDeleteListener","__kbparentdeletelisteners")),removeChildDataDeleteListener:g(u("removeChildDataDeleteListener","__kbparentdeletelisteners"))});return x}}(),V=function(){return function(){function z(q){if("object"===typeof q)for(var x=0,v=q.length;x<
v;x++)K_Components[q[x]]?y(q[x],K_Components[q[x]],document.getElementById("script_"+q[x])):z.load(q[x],"component/"+q[x]+"/"+location.search,y);else"string"===typeof q&&(K_Components[q[x]]?y(q,K_Components[q],document.getElementById("script_"+q)):z.load(q,"component/"+q+"/"+location.search,y))}var y=function(){},R=/(<\/.*?>)/g;window.K_Components||(window.K_Components={});z.getUnknowns=function(q){var x=q.match(R);return x.map(function(q){return q.replace(/[<\/>]/g,"")}).filter(function(q,g){return document.createElement(q)instanceof
HTMLUnknownElement&&-1===x.indexOf(q,g+1)&&!K_Components[q]})};z.load=function(q,x,v){document.head.appendChild(function(g,q,x){var v=document.createElement("script");v.type="text/javascript";v.charset="utf-8";v.async=!0;v.src=q;v.id="script_"+g;v.onload=function(){x(g,K_Components[g],this)};return v}(q,x,v));return z};z.onLoad=function(q){if(void 0===q)return y;y="function"===typeof q?q:y;return z};return z}}(),W=function(z){return function(){function y(f){this.name=f.tagName.toLowerCase();this.template=
...
"for"===l?b[1]:void 0;this.id=0;this.isEvent=m;this.__proto__.bindText=this.__proto__.bindText.map(function(b){return b===c?this:b});Object.defineProperties(this,{value:{get:this.valget,set:this.valset,enumerable:!0,configurable:!1},_value:r("",!0)});this.__proto__.updateData=function(c){if(d.isConnected&&d._data){if("object"!==typeof c||void 0===c.value)c={value:c};"function"===typeof d._data.stopChange&&d._data.stopChange().set(d.key,c.value)}};this.__proto__.updateDom=function(c){if(d.isSynced()){d.element.stopChange();
if("object"!==typeof c||void 0===c.value)c={value:c};d.value=c.value}};this.__proto__.updateLoop=function(){d.kb_loop&&d.loop(d.kb_loop)}}var m="attribute"===l&&-1!==D.indexOf(h.name)||"component"===l&&h.name&&-1!==D.indexOf(h.name);m&&k.stopChange().removeAttribute(h.name);Object.defineProperties(n.prototype,{valget:r(q),valset:r(x),refresh:r(P),connect:r(N),deleteMap:r(L),loop:r(Q),unsync:r(G),isSynced:r(v),type:r(l),text:r(b,!0),bindText:r(c,!0),bindNames:r("for"===l?[w(c[0])[0]]:M(c),!0),bindListener:r(m?
d.toLowerCase():d),bindProperty:r(m?h.name.toLowerCase():e),bindTarget:r(h,!0),element:r(k,!0),_data:r({},!0),filters:r({},!0),maps:r(f,!0),loop:r(Q)});return n}function q(){return this._value}function x(f){this._value=this.isSynced()?f:this._value;this.refresh()}function v(){return this.element.parentElement?!!this.element.parentElement:this.unsync()}function g(f,l){function b(c,b){return b.reduce(function(b,d){return b+("string"===typeof d?d:0===d.filterNames.length?d._value:d.filterNames.reduce(function(b,
...
"g"),"").replace(/\|(.*)/,"").replace(/\s/g,"").split(/for(.*?)loop/).filter(function(f){return 0!==f.length}):[]}function r(f,l,b){return{value:f,writable:!!l,enumerable:!1,configurable:!!b}}function t(f,l){for(var b=F[f],c=0,d=b.length;c<d&&(b[c](l),l._stopPropogation);c++);return l._preventDefault}function J(f){var l=f.match(K).map(function(b){return b.replace(/[<\/>]/g,"")});l.filter(function(b,c){return document.createElement(b)instanceof HTMLUnknownElement&&-1===l.indexOf(b,c+1)&&void 0===C[b]});
0!==l.length&&t("unknown",new Event("unknown",l));return l}var C={},K=/(<\/.*?>)/g;z().call();var D=Object.keys(HTMLElement.prototype).filter(function(f){return 0===f.indexOf("on")}),A="{{",u="}}",E="|",F={unknown:[]};y.prototype.map=function(f){function l(c){for(var d=0,e=c.length;d<e;d++)if(void 0===c[d].kb_maps&&8!==c[d].nodeType){c[d].kb_mapper=f;if(3===c[d].nodeType){var h=c[d],k=b,n=h.textContent,m=h.parentElement instanceof HTMLUnknownElement;if(n.match(new RegExp("(\\"+A.split("").join("\\")+
")(.*?)(\\"+u.split("").join("\\")+")","g")))for(var p=m?"component":-1!==n.indexOf("for")&&void 0!==n.indexOf("loop")?"for":"text",h=R(k,p,n,H(n),m?"":"textContent","textContent",h,h.parentElement),n=0,m=h.prototype.bindText.length;n<m;n++)0===h.prototype.bindText[n].indexOf(A)&&(p=new h(h.prototype.bindText[n]),h.prototype.bindText[n]=p,void 0===k[p.key]&&(k[p.key]=[]),p.id=k[p.key].length,k[p.key].push(p))}else for(var k=c[d],h=b,n=k.attributes,m=k instanceof HTMLUnknownElement,p=0,g=n.length;p<
g;p++)if(n[p].value.match(new RegExp("(\\"+A.split("").join("\\")+")(.*?)(\\"+u.split("").join("\\")+")","g")))for(var I=R(h,m?"component":"attribute",n[p].value,H(n[p].value),m?"":n[p].name,"value",n[p],k),t=0,q=I.prototype.bindText.length;t<q;t++)if(0===I.prototype.bindText[t].indexOf(A)){var r=new I(I.prototype.bindText[t]);I.prototype.bindText[t]=r;void 0===h[r.key]&&(h[r.key]=[]);h[r.key].push(r)}c[d].childNodes&&0!==c[d].childNodes.length&&l(c[d].childNodes)}}var b={};l(f.childNodes);return b};
y.prototype.addFilter=function(f,l){void 0!==this.maps[f]&&this.maps[f].forEach(function(b){b.filters.push(l);b.refresh()});return this};y.prototype.removeFilter=function(f,l){void 0!==this.maps[f]&&this.maps[f].forEach(function(b){b.filters.splice(this.maps[f].filters.indexOf(l),1);b.refresh()});return this};y.prototype.swapFilter=function(f,l,b){void 0!==this.maps[f]&&this.maps[f].forEach(function(c){c.filters.splice(this.maps[f].filters.indexOf(l),1,b);c.refresh()});return this};Object.defineProperties(y,
{startChars:r(function(f){if(void 0===f)return A;A="string"===typeof f?f:A;return this}),endChars:r(function(f){if(void 0===f)return u;u="string"===typeof f?f:u;return this}),pipeChars:r(function(f){if(void 0===f)return E;E="string"===typeof f?f:E;return this}),getUnknown:r(J),isRegistered:r(function(f){return void 0!==C[f]}),register:r(function(f,l){void 0===C[f]?(C[f]=l,J(l)):console.error("Class: KonnektMP Method: 'register', A template by the name %o already exists",f);return this}),addEventListener:r(function(f,
l){void 0!==F[f]?F[f].push(l):console.error("Class: KonnektMP Method: 'addEventListener', No event exists with the name %o",f);return this}),removeEventListener:r(function(f,l){if(void 0!==F[f])for(var b=0,c=F[f].length;b<c;b++)F[f][b].toString()===l.toString()&&F[f].splice(b,1);else console.error("Class: KonnektMP Method: 'removeEventListener', No event exists with the name %o",f);return this})});return y}}(function(){function z(){function y(c,b){var e=c.length,h;for(h=0;h<e&&(c[h](b),void 0===b._stopPropogation);h++);
}function z(c,b){var e=c.length,h;for(h=0;h<e&&(b.child=b.target,b.target=c[h].parent,c[h].func(b),void 0===b._stopPropogation);h++);}function q(c,b){for(var e=c.length;0<e;f++)if(c[f].toString()===b.toString())return!0;return!1}function x(c,b,e,h,k,f,m,p){this.stopPropagation=function(){this._stopPropogation=!0};this.preventDefault=function(){this._preventDefault=!0};this.value=e;this.oldValue=h;this.target=c;this.attr=b;this.arguments=k;this.action=f;this.child=void 0;this.type=m;this.stopChange=
p}function v(){this._attrListeners={};this._attrUpdateListeners={};this._styleListeners={};this._styleUpdateListeners={};this._parentStyleListeners={};this._parentStyleUpdateListeners={};this._parentAttrListeners={};this._parentAttrUpdateListeners={};this._injectedStyle={}}function g(c,b,e,h){var k=c.get,f=c.set,m;return function(c){m=k.call(this);e(this,b,c,m,void 0,this._stopChange)&&f.call(this,c);this._stopChange||h(this,b,c,m);this._stopChange=void 0}}function P(c,b,e,h){var k;return function(f){k=
c.value;e(this,b,f,k,arguments,this._stopChange)&&(c.value=f);this._stopChange||h(this,b,f,k,arguments);this._stopChange=void 0}}function N(c,b,e,h){var k=c.value,f;return function(){e(this,b,null,null,arguments,this._stopChange)&&(f=k.apply(this,arguments));this._stopChange||h(this,b,null,null,arguments,f);this._stopChange=void 0;return f}}function Q(c,b,e,h,k){var f=k.style,m=b.replace(/([A-Z])/g,"-$1").replace("webkit","-webkit"),p,l;return{get:function(){return l},set:function(c){p=l;e(k,b,c,
p,void 0,this._stopChange)&&(l=c,f.setProperty(m,c));this._stopChange||h(k,b,c,p);this._stopChange=void 0},enumerable:!0,configurable:!0}}function L(c,b,e,h){if("function"!==typeof b)return t;var k=-1!==["value","checked"].indexOf(c),f=-1!==E.indexOf(c),m;if(this.toString()!==t.toString())if(e){var p=this.querySelectorAll("*");e=p.length;for(var l,g=0;g<e;g++){l=p[g].attrListeners();if(k||"*"===c)void 0!==p[g].addInputBinding&&p[g].addInputBinding(),void 0!==p[g].addInputBoxBinding&&p[g].addInputBoxBinding();
if(f)t.injectStyleProperty(p[g],c),m=h?"_parentStyleUpdateListeners":"_parentStyleListeners";else{if("*"===c){m=h?"_parentStyleUpdateListeners":"_parentStyleListeners";e=E.length;for(var r=0;r<e;r++)t.injectStyleProperty(p[g],E[r]);void 0===l[m]["*"]&&(l[m]["*"]=[]);l[m]["*"].push({parent:this,func:b})}m=h?"_parentAttrUpdateListeners":"_parentAttrListeners"}void 0===l[m][c]&&(l[m][c]=[]);l[m][c].push({parent:this,func:b})}}else{l=this.attrListeners();if(f)m=h?"_styleUpdateListeners":"_styleListeners",
t.injectStyleProperty(this,c);else{if(k||"*"===c)void 0!==this.addInputBinding&&this.addInputBinding(),void 0!==this.addInputBoxBinding&&this.addInputBoxBinding();if("*"===c){m=h?"_styleUpdateListeners":"_styleListeners";e=E.length;for(g=0;g<e;g++)t.injectStyleProperty(this,E[g]);void 0===l[m][c]&&(l[m][c]=[]);l[m][c].push(b)}m=h?"_attrUpdateListeners":"_attrListeners"}void 0===l[m][c]&&(l[m][c]=[]);l[m][c].push(b)}else{if(k||"*"===c)for(r=document.querySelectorAll("input, textarea"),e=r.length,g=
0;g<e;g++)void 0!==r[g].addInputBinding&&r[g].addInputBinding(),void 0!==r[g].addInputBoxBinding&&r[g].addInputBoxBinding();if(f){f=Array.prototype.slice.call(document.body.querySelectorAll("*"));e=f.length+1;f.unshift(document.body);for(g=0;g<e;g++)t.injectStyleProperty(f[g],c);m=h?D:K}else{if("*"===c){f=Array.prototype.slice.call(document.body.querySelectorAll("*"));e=f.length+1;k=E.length;f.unshift(document.body);for(g=0;g<e;g++)for(r=0;r<k;r++)t.injectStyleProperty(f[g],E[r]);m=h?D:K;void 0===
m[c]&&(m[c]=[]);m[c].push(b)}m=h?C:J}void 0===m[c]&&(m[c]=[]);m[c].push(b)}}function G(c,b,e,h){function f(c,e){var h=e[c],k=h.length;for(m=0;m<k;m++)h[m].toString()===b.toString()&&h.splice(m,1)}if("function"!==typeof b)return t;["value","checked"].indexOf(c);var n=-1!==E.indexOf(c),m;if(this.toString()!==t.toString())if(e){e=this.querySelectorAll("*");var p=e.length;n?(n=h?"_childStyleUpdateListeners":"_childStyleListeners",f(c,this.attrListeners()[n]),n=h?"_parentStyleUpdateListeners":"_parentStyleListeners"):
("*"===c&&(n=h?"_childStyleUpdateListeners":"_childStyleListeners",f(c,this.attrListeners()[n])),n=h?"_childAttrUpdateListeners":"_childAttrListeners",f(c,this.attrListeners()[n]),n=h?"_parentAttrUpdateListeners":"_parentAttrListeners");for(m=0;m<p;m++){for(var l=e[m].attrListeners()[n][c],g=l.length,r=0;r<g;r++)l[r].isEqualNode(this)&&l.slice(r,1);if("*"===c)for(listenersStyle=h?"_parentStyleUpdateListeners":"_parentStyleListeners",l=e[m].attrListeners()[n][c],g=l.length,r=0;r<g;r++)l[r].isEqualNode(this)&&
l.slice(r,1)}}else n?n=h?"_styleUpdateListeners":"_styleListeners":("*"===c&&(n=h?"_styleUpdateListeners":"_styleListeners",f(c,this.attrListeners()[n])),n=h?"_attrUpdateListeners":"_attrListeners"),f(c,this.attrListeners()[n]);else n?n=h?D:K:("*"===c&&(n=h?D:K,f(c,n)),n=h?C:J),f(c,n)}function H(c,b){t.addAttrListener.call(this,c,b,!0);return this}function M(c,b){t.addAttrUpdateListener.call(this,c,b,!0);return this}function B(c,b){t.removeAttrListener.call(this,c,b,!0);return this}function O(c,b){t.removeAttrUpdateListener.call(this,
c,b,!0);return this}function w(c,b,e){var h=this.attrListeners();"html"===b&&(b="innerHTML");"events"===b&&(b="onclick");switch(c){case "attr":if(q(h._attrListeners[b],e))return!0;break;case "attrupdate":if(q(h._attrUpdateListeners[b],e))return!0}return!1}function r(){this._stopChange=!0;return this}function t(){function c(c,b){var d,e=b.length;for(d=0;d<e;d++)-1===c.indexOf(b[d])&&c.push(b[d]);return c}function d(c,b){for(var d=Object.keys(c),e,h,f=0,k=d.length;f<k;f++)if(e=d[f],void 0===b[e])b[e]=
...
e),void 0===e._stopPropogation&&z(c["*"],e)));void 0===e._stopPropogation&&void 0!==C[b]&&y(C[b],e);void 0===e._stopPropogation&&void 0!==D[b]&&y(D[b],e);void 0===e._stopPropogation&&void 0!==C["*"]&&(y(C["*"],e),void 0===e._stopPropogation&&y(D["*"],e));return void 0!==e._preventDefault?!1:!0};t.injectPrototypeProperty=function(c,d,e,h,f){var n=c.prototype,m=Object.getOwnPropertyDescriptor(n,d);e=e||c.toString().split(/\s+/)[1].split("{")[0].replace("()","");var p=A[e];h=h||l;f=f||b;void 0===n.attrListeners&&
(n={},n.attrListeners=function(){void 0===this.__kb&&(this.__kb=new v);return this.__kb}.bind(n),n.addAttrListener=t.addAttrListener,n.addAttrUpdateListener=t.addAttrUpdateListener,n.addChildAttrListener=H,n.addChildAttrUpdateListener=M,n.hasListener=w,n.removeAttrListener=t.removeAttrListener,n.removeAttrUpdateListener=t.removeAttrUpdateListener,n.removeChildAttrListener=B,n.removeChildAttrUpdateListener=O,n.stopChange=r);void 0===p&&(A[e]={obj:c,proto:n,descriptors:{},set:void 0,update:void 0},
p=A[e],p.set=h,p.update=f);void 0===p.descriptors[d]&&(p.descriptors[d]=m);m.configurable&&(void 0!==m.set?Object.defineProperty(n,d,{get:m.get,set:g(m,d,h,f),enumerable:!0,configurable:!0}):"function"===typeof m.value?Object.defineProperty(n,d,{value:N(m,d,h,f),writable:!0,enumerable:!0,configurable:!0}):void 0!==m.value&&Object.defineProperty(n,d,{get:function(){return m.value},set:P(m,d,h,f),enumerable:!0,configurable:!0}));return t};t.injectStyleProperty=function(c,d,e,f){var k=c.style,g=Object.getOwnPropertyDescriptor(k,
...
A[d],m=Object.getOwnPropertyNames(k);e=e||l;f=f||b;var p;void 0===k.attrListeners&&(k.attrListeners=function(){void 0===this.__kb&&(this.__kb=new v);return this.__kb},k.addAttrListener=t.addAttrListener,k.addAttrUpdateListener=t.addAttrUpdateListener,k.addChildAttrListener=H,k.addChildAttrUpdateListener=M,k.removeAttrListener=t.removeAttrListener,k.removeAttrUpdateListener=t.removeAttrUpdateListener,k.removeChildAttrListener=B,k.removeChildAttrUpdateListener=O,k.hasListener=w,k.stopChange=r);void 0===
g&&(A[d]={obj:c,proto:k,descriptors:{},set:void 0,update:void 0},g=A[d],g.set=e,g.update=f);p=A[d].descriptors;for(f=0;f<m.length;f+=1)void 0===p[m[f]]&&t.injectPrototypeProperty(c,m[f],d,e,b);if(-1!==m.indexOf("value")){var q=function(c){var b,d,e;if("checkbox"===this.type||"radio"===this.type)b=!0;d=b?"string"===typeof this.checked?this.checked:this.checked?"true":"false":this.value;setTimeout(function(){e=b?"string"===typeof this.checked?this.checked:this.checked?"true":"false":this.value;b&&(g.set(this,
"checked",this.checked,d)?g.update(this,"checked",this.checked,d):p.checked.set.call(this,d));this.value=e;g.set(this,"value",this.value,d)?g.update(this,"value",this.value,d):p.value.set.call(this,d)}.bind(this),0)};k.removeInputBinding=function(){this.attrListeners()._onkeydown=void 0;this.removeEventListener("keydown",q)};k.addInputBinding=function(){this.attrListeners()._onkeydown=!0;this.addEventListener("keydown",q)};k.removeInputBoxBinding=function(){this.attrListeners()._onmousedown=void 0;
this.removeEventListener("mouseup",q)};k.addInputBoxBinding=function(){this.attrListeners()._onmousedown=!0;this.addEventListener("mouseup",q)}}return t};t.addAttrListener=function(b,d,e){if("html"===b){b=0;for(var f=u.length;b<f;b++)L.call(this,u[b],d,e,!1)}else if("events"===b)for(b=0,f=F.length;b<f;b++)L.call(this,F[b],d,e,!1);else L.call(this,b,d,e,!1);return this};t.addAttrUpdateListener=function(b,d,e){if("html"===b){b=0;for(var f=u.length;b<f;b++)L.call(this,u[b],d,e,!0)}else if("events"===
b)for(b=0,f=F.length;b<f;b++)L.call(this,F[b],d,e,!0);else L.call(this,b,d,e,!0);return this};t.removeAttrListener=function(b,d,e){if("html"===b){b=0;for(var f=u.length;b<f;b++)G.call(this,u[b],d,e,!1)}else if("events"===b)for(b=0,f=F.length;b<f;b++)G.call(this,F[b],d,e,!1);else G.call(this,b,d,e,!1);return this};t.removeAttrUpdateListener=function(b,d,e){if("html"===b){b=0;for(var f=u.length;b<f;b++)G.call(this,u[b],d,e,!0)}else if("events"===b)for(b=0,f=F.length;b<f;b++)G.call(this,F[b],d,e,!0);
else G.call(this,b,d,e,!0);return this};t.hasListener=function(b,d,e){"html"===d&&(d="innerHTML");"events"===d&&(d="onclick");switch(b){case "attr":if(q(J[d],e))return!0;break;case "attrupdate":if(q(C[d],e))return!0}return!1};t.injectedPrototypes=function(){return A};return t}"function"===typeof define&&define.amd&&define("KB",z);return z}()),T=function(z,y,R){return function(){function q(B,O,w,r){function t(g,f,l,b,c){for(var d=P({},g),e=0,h=Object.keys(f.prototype),k=h.length;e<k;e++)d.__proto__[h[e]]=
...
N.isRegistered(b.component)?b.loop(function(b){q(b)}):(q.loadWaitList(b.component,function(d,e){b.loop(function(b){q(b)})}),q.loadWaitList(b.component).loading||(q.loadWaitList(b.component).loading=!0,g(b.component)));break;case "component":b.connect(l).deleteMap();break;default:b.connect(l)}})})}function C(g,f){D=new N(f);Object.defineProperty(D.wrapper,"__kbcomponenttree",v(f.kb_mapper?f.kb_mapper.__kbcomponenttree:[]));f.parentElement.replaceChild(D.fragment,f);O.unshift(D.wrapper);y(D.wrapper,
D.maps,t(g,L[g],O,u,E));if(-1===D.wrapper.__kbcomponenttree.indexOf(g)||D.wrapper.kb_viewmodel.multiple){D.wrapper.__kbcomponenttree.push(g);for(var l=D.wrapper.querySelectorAll("*"),b=0,c=l.length;b<c;b++)l[b]instanceof HTMLUnknownElement&&q(l[b])}else console.error("Warning!! You are attempting to make a recursive component %o, recursive components can lead to memory stack overflows unless properly handled, Please check your components html for use of this component, if You want this to be a recursive component please set `this.multiple = true;`",
...
"sessionStorage",v(void 0!==u.sessionStorage?u.sessionStorage:!1,!0));"string"===typeof u.localStorage&&(u.localStorage="true"===u.localStorage);Object.defineProperty(u,"localStorage",v(void 0!==u.localStorage?u.localStorage:!1,!0));"string"===typeof u.store&&(u.store="true"===u.store);Object.defineProperty(u,"store",v(void 0!==u.store?u.store:!1,!0));"string"===typeof u.multiple&&(u.multiple="true"===u.multiple);Object.defineProperty(u,"multiple",v(void 0!==u.multiple?u.multiple:!1,!0));r&&x(r,E);
E.innerHTML=B.innerHTML.toString();w=0;for(r=B.attributes.length;w<r;w++)E[B.attributes[w].name]=B.attributes[w].value;w=0;for(r=A.length;w<r;w++)B[A[w]]&&(E[A[w]]=B[A[w]]);B.k_post&&x(B.k_post,E);N.isRegistered(z)?C(z,B):(q.loadWaitList(z,function(g,f){C(z,B)}),q.loadWaitList(z).loading||(q.loadWaitList(z).loading=!0,g(z)))}function x(g,q){var w=Object.keys(g);q.pointers||(q.pointers={});for(var r=0,t=w.length;r<t;r++)g.isObservable(w[r])?q.pointers[w[r]]=g:g[w[r]].isMixed()?q.pointers[w[r]]=g[w[r]].__kbImmediateParent:
q[w[r]]=g[w[r]]}function v(g,q,w){return{value:g,writable:!!q,enumerable:!1,configurable:!!w}}window.K_Components||(window.K_Components={});var g=y().onLoad(function(g,v){var w="<style>"+unescape(v.prototype.k_css)+"</style>"+unescape(v.prototype.k_html);q.register(g,v,w,v.prototype.cms);q.loadWaitList(g).forEach(function(r){r(g,v)});q.loadWaitList(g,"clear")}),P=z(),N=R(),Q=P({},"Model"),L={},G=function(){return window.location.search.replace("?","").split("&").filter(function(g){return 0!==g.length}).reduce(function(g,
q){g[q.split("=")[0]]=q.split("=")[1];return g},{})}(),H={},M;q.register=function(g,v,w,r){N.register(g,w);L[g]=v;return q};q.loadWaitList=function(g,v){if("undefined"===typeof v&&g)return H[g];if(g){if(void 0===H[g]||"clear"===v){var w=void 0===H[g]?!1:!!H[g].loading;H[g]=[];H[g].loading=w}"function"===typeof v&&H[g].push(v)}return q};q.localRouting=function(g){g?(M=Node.prototype.appendChild,Node.prototype.appendChild=function(g){if("script"===g.tagName.toLowerCase()){g.src=g.src.substring(0,-1!==
g.src.indexOf("?")?g.src.indexOf("?"):g.src.length);var q=g.src.match(/(.*?component\/)/);q&&(G.env||(G.env="prod"),"dev"===G.env&&(G.env="qa"),q=g.src.replace(q[0],"").replace(/[\/\s]/g,""),g.src="/components/"+q+"/build/"+G.env+"/"+q+(G.debug&&"prod"!==G.env?"":".min")+".js",arguments[0]=g)}return M.apply(this,arguments)}):M&&(Node.prototype.appendChild=M,M=null);return q};return q}}(U,V,W);"undefined"!==typeof window&&"undefined"!==typeof window.define&&"undefined"!==typeof window.require?define([],
function(){return T}):"undefined"!==typeof module&&(module.exports=T);return T}();
