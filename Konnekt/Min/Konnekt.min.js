...
f);n.addAttrUpdateListener("textContent",f);n.addAttrListener("setAttribute",g);n.addAttrListener("removeAttribute",g);n.addAttrUpdateListener("setAttribute",h);n.addAttrUpdateListener("removeAttribute",h);return n}var I={},y={},z={},J={},B={},C="textContent innerHTML innerText outerHTML outerText appendChild removeChild replaceChild insertAdjacentHTML insertBefore".split(" "),E=Object.getOwnPropertyNames(document.body.style),D=Object.keys(HTMLElement.prototype).filter(function(b){return 0===b.indexOf("on")}).concat(["addEventListener",
"removeEventListener"]),u,k=function(b,d,f,g,h,k){f=new v(b,d,f,g,h,void 0,"set",k);void 0!==b.__kb&&(g=b.__kb._attrListeners,h=b.__kb._styleListeners,k=b.__kb._parentAttrListeners,b=b.__kb._parentStyleListeners,void 0!==g[d]&&t(g[d],f),void 0===f._stopPropogation&&void 0!==h[d]&&t(h[d],f),void 0===f._stopPropogation&&void 0!==g["*"]&&(t(g["*"],f),void 0===f._stopPropogation&&t(h["*"],f)),void 0===f._stopPropogation&&void 0!==k[d]&&x(k[d],f),void 0===f._stopPropogation&&void 0!==b[d]&&x(b[d],f),void 0===
f._stopPropogation&&void 0!==k["*"]&&(x(k["*"],f),void 0===f._stopPropogation&&x(b["*"],f)));void 0===f._stopPropogation&&void 0!==I[d]&&t(I[d],f);void 0===f._stopPropogation&&void 0!==z[d]&&t(z[d],f);void 0===f._stopPropogation&&void 0!==I["*"]&&(t(I["*"],f),void 0===f._stopPropogation&&t(z["*"],f));return void 0!==f._preventDefault?!1:!0},b=function(b,d,f,g,h,k){f=new v(b,d,f,g,h,k,"update");void 0!==b.__kb&&(g=b.__kb._attrUpdateListeners,h=b.__kb._styleUpdateListeners,k=b.__kb._parentAttrUpdateListeners,
b=b.__kb._parentStyleUpdateListeners,void 0!==g[d]&&t(g[d],f),void 0===f._stopPropogation&&void 0!==h[d]&&t(h[d],f),void 0===f._stopPropogation&&void 0!==g["*"]&&(t(g["*"],f),void 0===f._stopPropogation&&t(h["*"],f)),void 0===f._stopPropogation&&void 0!==k[d]&&x(k[d],f),void 0===f._stopPropogation&&void 0!==b[d]&&x(b[d],f),void 0===f._stopPropogation&&void 0!==k["*"]&&(x(k["*"],f),void 0===f._stopPropogation&&x(b["*"],f)));void 0===f._stopPropogation&&void 0!==y[d]&&t(y[d],f);void 0===f._stopPropogation&&
void 0!==J[d]&&t(J[d],f);void 0===f._stopPropogation&&void 0!==y["*"]&&(t(y["*"],f),void 0===f._stopPropogation&&t(J["*"],f));return void 0!==f._preventDefault?!1:!0};n.injectPrototypeProperty=function(c,d,f,g,h){var m=c.prototype,l=Object.getOwnPropertyDescriptor(m,d);f=f||c.toString().split(/\s+/)[1].split("{")[0].replace("()","");var u=B[f];g=g||k;h=h||b;void 0===m.attrListeners&&(m={},m.attrListeners=function(){void 0===this.__kb&&(this.__kb=new A);return this.__kb}.bind(m),m.addAttrListener=
n.addAttrListener,m.addAttrUpdateListener=n.addAttrUpdateListener,m.addChildAttrListener=Q,m.addChildAttrUpdateListener=R,m.hasListener=G,m.removeAttrListener=n.removeAttrListener,m.removeAttrUpdateListener=n.removeAttrUpdateListener,m.removeChildAttrListener=P,m.removeChildAttrUpdateListener=K,m.stopChange=w);void 0===u&&(B[f]={obj:c,proto:m,descriptors:{},set:void 0,update:void 0},u=B[f],u.set=g,u.update=h);void 0===u.descriptors[d]&&(u.descriptors[d]=l);l.configurable&&(void 0!==l.set?Object.defineProperty(m,
d,{get:l.get,set:e(l,d,g,h),enumerable:!0,configurable:!0}):"function"===typeof l.value?Object.defineProperty(m,d,{value:F(l,d,g,h),writable:!0,enumerable:!0,configurable:!0}):void 0!==l.value&&Object.defineProperty(m,d,{get:function(){return l.value},set:N(l,d,g,h),enumerable:!0,configurable:!0}));return n};n.injectStyleProperty=function(c,d,f,g){var h=c.style,m=Object.getOwnPropertyDescriptor(h,d),l=c.attrListeners().injectedStyle;f=f||k;g=g||b;void 0===l&&(c.attrListeners().injectedStyle={obj:c,
proto:h,descriptors:{},set:void 0,update:void 0},c.attrListeners().injectedStyle.set=f,c.attrListeners().injectedStyle.update=g,l=c.attrListeners().injectedStyle);void 0===l.descriptors[d]&&(l.descriptors[d]=m);m.configurable&&Object.defineProperty(h,d,O(m,d,f,g,c));return n};n.injectPrototypes=function(c,d,f,g){var h=c.prototype;d=d||c.toString().split(/\s+/)[1].split("{")[0].replace("()","");var m=B[d],l=Object.getOwnPropertyNames(h);f=f||k;g=g||b;var e;void 0===h.attrListeners&&(h.attrListeners=
function(){void 0===this.__kb&&(this.__kb=new A);return this.__kb},h.addAttrListener=n.addAttrListener,h.addAttrUpdateListener=n.addAttrUpdateListener,h.addChildAttrListener=Q,h.addChildAttrUpdateListener=R,h.removeAttrListener=n.removeAttrListener,h.removeAttrUpdateListener=n.removeAttrUpdateListener,h.removeChildAttrListener=P,h.removeChildAttrUpdateListener=K,h.hasListener=G,h.stopChange=w);void 0===m&&(B[d]={obj:c,proto:h,descriptors:{},set:void 0,update:void 0},m=B[d],m.set=f,m.update=g);e=B[d].descriptors;
for(g=0;g<l.length;g+=1)void 0===e[l[g]]&&n.injectPrototypeProperty(c,l[g],d,f,b);if(-1!==l.indexOf("value")){var u=function(b){var c,d,f;if("checkbox"===this.type||"radio"===this.type)c=!0;d=c?"string"===typeof this.checked?this.checked:this.checked?"true":"false":this.value;setTimeout(function(){f=c?"string"===typeof this.checked?this.checked:this.checked?"true":"false":this.value;c&&(m.set(this,"checked",this.checked,d)?m.update(this,"checked",this.checked,d):e.checked.set.call(this,d));this.value=
f;m.set(this,"value",this.value,d)?m.update(this,"value",this.value,d):e.value.set.call(this,d)}.bind(this),0)};h.removeInputBinding=function(){this.attrListeners()._onkeydown=void 0;this.removeEventListener("keydown",u)};h.addInputBinding=function(){this.attrListeners()._onkeydown=!0;this.addEventListener("keydown",u)};h.removeInputBoxBinding=function(){this.attrListeners()._onmousedown=void 0;this.removeEventListener("mouseup",u)};h.addInputBoxBinding=function(){this.attrListeners()._onmousedown=
!0;this.addEventListener("mouseup",u)}}return n};n.addAttrListener=function(b,d,f){if("html"===b){b=0;for(var g=C.length;b<g;b++)L.call(this,C[b],d,f,!1)}else if("events"===b)for(b=0,g=D.length;b<g;b++)L.call(this,D[b],d,f,!1);else L.call(this,b,d,f,!1);return this};n.addAttrUpdateListener=function(b,d,f){if("html"===b){b=0;for(var g=C.length;b<g;b++)L.call(this,C[b],d,f,!0)}else if("events"===b)for(b=0,g=D.length;b<g;b++)L.call(this,D[b],d,f,!0);else L.call(this,b,d,f,!0);return this};n.removeAttrListener=
function(b,d,f){if("html"===b){b=0;for(var g=C.length;b<g;b++)H.call(this,C[b],d,f,!1)}else if("events"===b)for(b=0,g=D.length;b<g;b++)H.call(this,D[b],d,f,!1);else H.call(this,b,d,f,!1);return this};n.removeAttrUpdateListener=function(b,d,f){if("html"===b){b=0;for(var g=C.length;b<g;b++)H.call(this,C[b],d,f,!0)}else if("events"===b)for(b=0,g=D.length;b<g;b++)H.call(this,D[b],d,f,!0);else H.call(this,b,d,f,!0);return this};n.hasListener=function(b,d,f){"html"===d&&(d="innerHTML");"events"===d&&(d=
"onclick");switch(b){case "attr":if(r(I[d],f))return!0;break;case "attrupdate":if(r(y[d],f))return!0}return!1};n.injectedPrototypes=function(){return B};return n}"function"===typeof define&&define.amd&&define("KB",x);return x}(),W=function(){return function(){function x(r){0===r.length&&(r=t);document.body.innerHTML="<"+r+"></"+r+">";M(r);return x}var t="",M=function(){};x.base=function(r){if(void 0===r)return t;t="string"===typeof r?r:t;return x};x.onChange=function(r){if(void 0===r)return M;M="function"===
typeof r?r:M;return x};x.watch=function(r){window.onhashchange=r?function(){x(window.location.hash.replace("#",""))}:null;return x};return x}}(),S=function(x){return function(){function t(e,k){this.name=e.tagName.toLowerCase();this.template=y[this.name]||'<div class="missing_component">Unknown Component</div>';this.node=e;this.fragment=document.createDocumentFragment();this.wrapper=document.createElement("div");this.wrapper.className="Wrapper Wrapper__"+this.name;k||(this.wrapper.innerHTML=this.template);
this.fragment.appendChild(this.wrapper);k||(this.maps=this.map(this.wrapper));k||(this.wrapper.kb_maps=this.maps)}function M(e,k,b,c,d,f,g,h){function m(b){var c="for"===k?G(b):[],d=this;this.key="for"!==k?P(b):c[0];this.filterNames=K(b);this.component="for"===k?c[1]:void 0;this.id=0;this.isEvent=l;this.isInput=p;this.__proto__.bindText=this.__proto__.bindText.map(function(c){return c===b?this:c});this.__proto__.bindMaps.push(this);Object.defineProperties(this,{value:{get:this.valget,set:this.valset,
enumerable:!0,configurable:!1},_value:w("",!0)});this.updateData=function(b){if(d.isConnected&&d._data){if("object"!==typeof b||void 0===b.value)b={value:b};"function"===typeof d._data.stopChange&&d._data.stopChange().set(d.key,b.value)}};this.updateDom=function(b){if(d.isSynced()){d.element.stopChange();if("object"!==typeof b||void 0===b.value)b={value:b};d.value=b.value}};this.updateLoop=function(){d.kb_loop&&d.loop(d.kb_loop)}}var l="attribute"===k&&-1!==J.indexOf(g.name)||"component"===k&&g.name&&
-1!==J.indexOf(g.name),p="input"===h.tagName.toLowerCase();l&&h.stopChange().removeAttribute(g.name);Object.defineProperties(m.prototype,{valget:w(r),valset:w(v),refresh:w(N),connect:w(F),deleteMap:w(L),loop:w(O),unsync:w(H),isSynced:w(A),type:w(k),text:w(b,!0),bindText:w(c,!0),bindNames:w("for"===k?[G(c[0])[0]]:R(c),!0),bindMaps:w([],!0),bindListener:w(l?d.toLowerCase():d),bindProperty:w(l?g.name.toLowerCase():f),bindTarget:w(g,!0),element:w(h,!0),_data:w({},!0),filters:w({},!0),maps:w(e,!0),loop:w(O)});
return m}function r(){return this._value}function v(e){this._value=this.isSynced()?e:this._value;this.refresh()}function A(){return this.element.parentElement?!!this.element.parentElement:this.unsync()}function e(e,k){function b(b,d){return d.reduce(function(d,g){return d+("string"===typeof g?g:0===g.filterNames.length?g._value:g.filterNames.reduce(function(d,f){if(void 0!==b.filters){if(void 0!==b.filters[f])return b.filters[f](d);console.warn("there is no filter by the name %o in the data model filters %o",
f,Object.keys(b.filters));return d}console.error("Somehow filters object was not added to the mapping via .connect() method, please see dev");return d},g._value))},"")}return 1===k.length?"string"===typeof k[0]._value?b(e,k):k[0]._value:b(e,k)}function N(){if("for"!==this.type)if(this.isEvent)this.element.stopChange()[this.bindProperty]=this.bindText[0]._value;else if("component"===this.type)this.element.k_post||(this.element.k_post={}),this.element.k_post["textContent"===this.bindProperty?"innerHTML":
this.bindTarget.name]=e(this,this.bindText);else if("innerHTML"===this.key){this.bindTarget[this.bindProperty]="";for(var u=0,k=this._value.length;u<k;u++)this.element.stopChange().appendChild(this._value[u])}else this.bindTarget[this.bindProperty]=e(this,this.bindText),this.isInput&&(this.element.stopChange()[this.bindTarget.name]=e(this,this.bindText));return this}function F(e){this._data=e;this.filters=void 0!==e.filters?e.filters:this.filters;e=0;for(var k=this.bindNames.length;e<k;e++){var b=
this.bindNames[e],c=this.bindMaps[e];c._data.addDataUpdateListener&&(c._data.exists(b)||(console.warn("No property by the name %o exists on this data set %o",b,c._data),c._data.add(b,c._value)),c.value=c._data.get(b),"component"!==c.type&&"for"!==c.type?(c.isConnected=!0,c._data.addDataUpdateListener(b,c.updateDom)):"for"===c.type&&c._value.addDataUpdateListener&&c._value.addDataUpdateListener("*",c.updateLoop))}1!==this.bindText.length||"text"!==this.type&&"attribute"!==this.type&&!this.isEvent||
this.element.addAttrUpdateListener("text"===this.type?"html":this.bindListener,this.updateData);return this}function O(e){this.kb_loop=e;this.element.stopChange().innerHTML="";for(var k=this._value,b=0,c=this.filterNames.length;b<c;b++)k=this.filters[this.filterNames[b]](k);k=0;for(b=this._value.length;k<b;k++){var c=this._value[k],d=document.createElement(this.component);d.k_post=c;d.kb_wrapper=this.element.kb_wrapper;this.element.stopChange().appendChild(d);"function"===typeof e&&e(d)}}function L(){this.maps[this.key].splice(this.id,
...
null;this.__proto__.element=null;this.__proto__.filters=null;this.__proto__.bindTarget=null;this.__proto__.bindText=null;this.__proto__.bindNames=null;this.__proto__.element=null;this.__proto__.maps=null;this.__proto__.bindMaps=null;return!1}function Q(e){return e.split(new RegExp("("+B.split("").join("\\")+")(.*?)("+C.split("").join("\\")+")","g")).map(function(k,b,c){return c[b-1]===B?B+k+C:k}).filter(function(k,b,c){return 0!==k.length&&k!==B&&k!==C&&0!==k.length})}function R(e){return e.filter(function(k){return-1!==
k.indexOf(B)&&-1!==k.indexOf(C)}).map(function(k){return P(k)})}function P(e){return e.replace(new RegExp("["+B+C+"]","g"),"").replace(new RegExp("\\"+E.split("").join("\\")+"(.*)"),"").replace(/\s/g,"")}function K(e){return-1!==e.indexOf(E)?e.replace(new RegExp("["+C+"]","g"),"").replace(new RegExp("(.*?)(\\"+E.split("").join("\\")+")"),"").replace(/\s/g,"").split(","):[]}function G(e){return-1!==e.indexOf("for")?e.replace(new RegExp("["+B+C+"]","g"),"").replace(/\|(.*)/,"").replace(/\s/g,"").split(/for(.*?)loop/).filter(function(k){return 0!==
k.length}):[]}function w(e,k,b){return{value:e,writable:!!k,enumerable:!1,configurable:!!b}}function n(e,k){for(var b=D[e],c=0,d=b.length;c<d&&(b[c](k),k._stopPropogation);c++);return k._preventDefault}function I(e){var k=e.match(z).map(function(b){return b.replace(/[<\/>]/g,"")});k.filter(function(b,c){return document.createElement(b)instanceof HTMLUnknownElement&&-1===k.indexOf(b,c+1)&&void 0===y[b]});0!==k.length&&n("unknown",new Event("unknown",k));return k}var y={},z=/(<\/.*?>)/g;x().call();
var J=Object.keys(HTMLElement.prototype).filter(function(e){return 0===e.indexOf("on")}),B="{{",C="}}",E="|",D={unknown:[]};t.prototype.map=function(e){function k(c){for(var d=0,f=c.length;d<f;d++)if(void 0===c[d].kb_maps&&8!==c[d].nodeType){c[d].kb_mapper=e;if(3===c[d].nodeType){var g=c[d],h=b,m=g.textContent,l=g.parentElement instanceof HTMLUnknownElement;if(m.match(new RegExp("(\\"+B.split("").join("\\")+")(.*?)(\\"+C.split("").join("\\")+")","g")))for(var p=l?"component":m.match(new RegExp("(\\"+
B.split("").join("\\")+")(.*?)(for)(.*?)(loop)(.*?)(\\"+C.split("").join("\\")+")","g"))?"for":"text",g=M(h,p,m,Q(m),l?"":"textContent","textContent",g,g.parentElement),m=0,l=g.prototype.bindText.length;m<l;m++){var p=m,q=g.prototype.bindText[m];0===q.indexOf(B)&&(q=new g(q),g.prototype.bindText[p]=q,void 0===h[q.key]&&(h[q.key]=[]),q.id=h[q.key].length,h[q.key].push(q))}}else for(h=c[d],g=b,m=h.attributes,l=h instanceof HTMLUnknownElement,p=0,q=m.length;p<q;p++){q>m.length&&(p-=q-m.length,q=m.length);
var y=m[p];if(y.value.match(new RegExp("(\\"+B.split("").join("\\")+")(.*?)(\\"+C.split("").join("\\")+")","g")))for(var y=M(g,l?"component":"attribute",y.value,Q(y.value),l?"":y.name,"value",y,h),n=0,I=y.prototype.bindText.length;n<I;n++){var r=n,z=y.prototype.bindText[n];0===z.indexOf(B)&&(z=new y(z),y.prototype.bindText[r]=z,void 0===g[z.key]&&(g[z.key]=[]),g[z.key].push(z))}}c[d].childNodes&&0!==c[d].childNodes.length&&k(c[d].childNodes)}}var b={};k(e.childNodes);return b};t.prototype.addFilter=
function(e,k){void 0!==this.maps[e]&&this.maps[e].forEach(function(b){b.filters.push(k);b.refresh()});return this};t.prototype.removeFilter=function(e,k){void 0!==this.maps[e]&&this.maps[e].forEach(function(b){b.filters.splice(this.maps[e].filters.indexOf(k),1);b.refresh()});return this};t.prototype.swapFilter=function(e,k,b){void 0!==this.maps[e]&&this.maps[e].forEach(function(c){c.filters.splice(this.maps[e].filters.indexOf(k),1,b);c.refresh()});return this};Object.defineProperties(t,{startChars:w(function(e){if(void 0===
e)return B;B="string"===typeof e?e:B;return this}),endChars:w(function(e){if(void 0===e)return C;C="string"===typeof e?e:C;return this}),pipeChars:w(function(e){if(void 0===e)return E;E="string"===typeof e?e:E;return this}),getUnknown:w(I),isRegistered:w(function(e){return void 0!==y[e]}),register:w(function(e,k){void 0===y[e]?(y[e]=k,I(k)):console.error("Class: KonnektMP Method: 'register', A template by the name %o already exists",e);return this}),addEventListener:w(function(e,k){void 0!==D[e]?
D[e].push(k):console.error("Class: KonnektMP Method: 'addEventListener', No event exists with the name %o",e);return this}),removeEventListener:w(function(e,k){if(void 0!==D[e])for(var b=0,c=D[e].length;b<c;b++)D[e][b].toString()===k.toString()&&D[e].splice(b,1);else console.error("Class: KonnektMP Method: 'removeEventListener', No event exists with the name %o",e);return this})});return t}}(S),T=function(x,t,M,r){return function(v,A){function e(n,y,z,r){function t(b,c,e,h,k){for(var l=L({},b),p=
0,q=Object.keys(c.prototype),n=q.length;p<n;p++)l.__proto__[q[p]]=c.prototype[q[p]];p=0;q=Object.keys(h);for(n=q.length;p<n;p++)-1!==G.indexOf(q[p])?Object.defineProperty(l,q[p],F(h[q[p]],"filters"!==q[p])):l.set(q[p],h[q[p]]);if(h.pointers)for(p=0,q=Object.keys(h.pointers),n=q.length;p<n;p++)l.addPointer(h.pointers[q[p]],q[p]);c.apply(l,e);p=0;q=Object.keys(k);for(n=q.length;p<n;p++)-1!==G.indexOf(q[p])?Object.defineProperty(l,q[p],F(k[q[p]],"filters"!==q[p])):l.set(q[p],k[q[p]]);if(k.pointers)for(p=
0,q=Object.keys(k.pointers),n=q.length;p<n;p++)l.addPointer(k.pointers[q[p]],q[p]);p=0;q=Object.keys(l.filters);for(n=q.length;p<n;p++)l.filters[q[p]]=l.filters[q[p]].bind(l);if(l.sessionStorage){if(c=sessionStorage.getItem(l.id||b))for(c=JSON.parse(c),p=0,q=Object.keys(c),n=q.length;p<n;p++)l.set(q[p],c[q[p]]);else sessionStorage.setItem(l.id||b,l.stringify());l.addChildDataUpdateListener("*",function(){sessionStorage.setItem(l.id||b,l.stringify())})}if(l.localStorage){if(c=localStorage.getItem(l.id||
b))for(c=JSON.parse(c),p=0,q=Object.keys(c),n=q.length;p<n;p++)l.set(q[p],c[q[p]]);else localStorage.setItem(l.id||b,l.stringify());l.addChildDataUpdateListener("*",function(){localStorage.setItem(l.id||b,l.stringify())})}l.store&&R.set(l.id||b,l);return l}function v(b,c,g){b.kb_viewmodel=g;c.wrapper.innerHTML=u.template.replace(new RegExp("("+H.startChars()+"local"+H.endChars()+")","g"),g.local);var h=c.maps=c.map(c.wrapper);c.wrapper.kb_maps=h;Object.keys(h).forEach(function(b){h[b].forEach(function(b){switch(b.type){case "for":b.connect(g);
