...
b.substring(1,b.length-1):b.substring(1,b.length)}else return g;return b}var l=this.__kbnonproxy;split=c.split(/({"|,"(?=(?:[^"]|"[^"]*")*$)|\[(?=(?:[^"]|"[^"]*")*$)|\](?=(?:[^"]|"[^"]*")*$)|":|"}|{(?=(?:[^"]|"[^"]*")*$)|,(?=(?:[^"]|"[^"]*")*$)|}(?=(?:[^"]|"[^"]*")*$))/).filter(Boolean);UKeys=[];isValue=isKey=!1;t="";for(var m=1,B=split.length,f,e,h,k;m<B;m++)f=split[m],e=split[m-1],h=split[m+1],k=UKeys[UKeys.length-1],'":'===e&&'{"'===f||'":'===e&&"["===f?(t+=(0!==t.length?".":"")+k,l[k]||l.set(k,
b?b(k,{},t,l):{}),l=l[k],UKeys.pop()):"["===e||","===e&&0!==l.length?"{"===f||'{"'===f?(t+=(0!==t.length?".":"")+l.__kbsetindex,"object"!==typeof l[l.__kbsetindex]&&l.set(l.__kbsetindex,b?b(l.length,{},t,l):{}),l.__kbsetindex+=1,l=l[l.__kbsetindex-1]):(l.set(l.__kbsetindex,b?b(l.length,g(f),t,l):g(f)),l.__kbsetindex+=1):'":'===e?(l.set(k,b?b(k,g(f),t,l):g(f)),UKeys.pop()):'{"'===e||","===e&&'":'===h?UKeys[UKeys.length]=f.replace(/\"/g,""):"}"!==e&&"]"!==e||void 0===f||(t=-1!==t.indexOf(".")?t.substring(0,
t.lastIndexOf(".")-1):"",l=l.__kbImmediateParent);return this}function F(c,b){"number"===typeof c&&(c=c.toString());var g=-1!==c.indexOf(".")?this.__kbnonproxy.setLayer(c):this.__kbnonproxy;-1!==c.indexOf(".")&&(c=c.split(".").pop());var l=new q(this,c,"set",b,this[c],arguments,"__kbmethodlisteners");!0!==f(l)&&(M.call(this,g,c,b,this._stopChange),this.stopChange=void 0,l.type="postset",l.listener="__kbmethodupdatelisteners",f(l));return this}function y(c){return c.split(".")}function p(c,b){return function(g,
l){arguments=Array.prototype.slice.call(arguments);arguments.push(c);var m=this[b],e=new q(this,b,"addlistener",m,void 0,arguments,"");"string"===typeof g&&1!==y(g).length&&(m=y(g),g=m.pop(),m=m.join("."),e.local=this.getLayer(m),m=e.local[b],e.value=m);!0!==f(e)&&(E.call(m)?(void 0===m[g]&&(m[g]=[]),m[g].push(l),e.type="postaddlistener",f(e)):I.call(m)&&"function"===typeof g&&(m.push(g),e.type="postaddlistener",f(e)));return this}}function r(c,b){return function(g,l){arguments=Array.prototype.slice.call(arguments);
arguments.push(c);var m=this[b],e=new q(this,b,"removelistener",m,void 0,arguments,"");"string"===typeof g&&1!==y(g).length&&(m=y(g),m.pop(),m.join("."),e.local=this.getLayer(m),m=e.local[b],e.value=m,g=y(g).pop());if(!0!==f(e))if(E.call(m)){if(void 0!==m[g])for(var h=0,k=m[g].length;h<k;h++)if(m[g][h].toString()===l.toString()){m[g].splice(h,1);e.type="postremovelistener";f(e);break}}else if(I.call(m)&&"function"===typeof g)for(h=0,k=m.length;h<k;h++)if(m[h].toString()===g.toString()){m.splice(h,
1);e.type="postremovelistener";f(e);break}return this}}function z(c,b){function g(b,c,e){var f=Object.keys(this,"all").filter(function(b){return n.call(this[b])}.bind(this)),h=this,k=b;"string"===typeof b&&1!==y(b).length&&(h=y(b),k=h.pop(),h=h.join("."),h=this.getLayer(h),void 0===h[e][k]&&(h[e][k]=[]),h[e][k].push(c));E.call(h[e])?(void 0===h[e][k]&&(h[e][k]=[]),h[e][k].push(c),h=h.__kbpointers[k],h=h.point.getLayer(h.keys),void 0!==h[k]&&(void 0===h[e][k]&&(h[e][k]=[]),h[e][k].push(_func))):h[e].push(c);
k=0;for(h=f.length;k<h;k++)g.call(this[f[k]],b,c,e)}return function(l,m){arguments=Array.prototype.slice.call(arguments);arguments.push(c);var e=new q(this,b,"addchildlistener",void 0,void 0,arguments,"");!0!==f(e)&&(g.call(this.__kbnonproxy,l,m,b),e.type="postaddchildlistener",f(e));return this}}function v(c,b){function g(b,c,e){var f=Object.keys(this,"all").filter(function(b){return n.call(this[b])}.bind(this)),h=this,k=b;if("string"===typeof b&&1!==y(b).length){var d=y(b),k=d.pop();d.join(".");
...
shift:[],postshift:[],unshift:[],postunshift:[],fill:[],postfill:[],reverse:[],postreverse:[],sort:[],postsort:[],addlistener:[],postaddlistener:[],removelistener:[],postremovelistener:[],addchildlistener:[],postaddchildlistener:[],removechildlistener:[],postremovechildlistener:[]},N=["__proto__","_stopChange"],w=function(c,b){if(!b._stopPropogration&&c)for(var g=0,l=c.length;g!==l&&(c[g](b),!b._stopPropogration);g++);},f=function(c){if(c.listener){var b=c.local[c.listener],g=c.local[c.listener.replace("__kb",
"__kbparent")];E.call(b)?(w(b[c.key],c),w(b["*"],c)):w(b,c);E.call(g)?(w(g[c.key],c),w(g["*"],c)):w(g,c)}w(c.local.__kbref.__kbevents[c.type],c);return c._preventDefault},e=Array.prototype.sort,h=Array.prototype.slice,k;Object.prototype._toString||(Object.prototype._toString=Object.prototype.toString);Object._keys||(Object._keys=Object.keys);Object.prototype.toString=function(){return this instanceof C?"[object Mixed]":Object.prototype._toString.apply(this,arguments)};Object.keys=function(c,b){return Object._keys(c).filter(function(g){return b&&
...
"__kbmethodlisteners"),b=this.__kbnonproxy;if(!0!==f(c)){var g=h.call(b);e.apply(g,arguments);for(var l=0,m=g.length;l<m;l++)b[l]=g[l];c.type="postsort";c.listener="__kbmethodupdatelisteners";f(c)}return this}),splice:d(function(c,b,g){c="string"===typeof c?parseInt(c,10):c;var e=new q(this,c,"splice",void 0,void 0,arguments,"__kbmethodlisteners"),m=this.__kbnonproxy;if(!0!==f(e)){var h=[],k=Array.prototype.slice.call(arguments,2),d=k.length-2,p=0;if(0!==b&&void 0!==m[c-1+b])for(var r=0,z=b;r<z;r++){h.push(m[c+
r]);for(var n=c+r,v=this.length-1;n<v;n++)m[n]=m[n+1];m.del(m.length-1,!0)}if(0!==d)for(r=0,z=d;r<z;r++){p=c+Math.min(1,r);n=m.length;for(v=p;n>v;n--)m.set(n,m[n-1]);m.set(p,k[r])}e.type="postsplice";e.listener="__kbmethodupdatelisteners";f(e);return h}return[]}),unshift:d(function(){var c=new q(this,0,"unshift",this[0],void 0,arguments,"__kbmethodlisteners"),b=this.__kbnonproxy;if(!0!==f(c)){for(var g=Array.prototype.slice.call(arguments),e=b.length-1+g.length,m=g.length;-1!==e;e--)e<m?b.set(e,g[e]):
b.set(e,b[e-g.length]);c.type="postunshift";c.listener="__kbmethodupdatelisteners";f(c)}return this.length}),getLayer:d(function(c){function b(g){var c=g[0];return void 0===this[c]&&0!==g.length-1?null:n(this[c])?0!==g.length-1?(g.shift(),b.call(this[c],g)):this[c]:this}c=y(c);return b.call(this,c)}),setLayer:d(function(c){function b(g){var c=g[0];void 0===this[c]&&0!==g.length-1&&(this[c]=C({},this.__kbname,this,this.__kbscopeString+"."+c));return n(this[c])?0!==g.length-1?(g.shift(),b.call(this[c],
...
b.__kbsubscribers[g[f]],g[f]);f=0;for(h=e.length;f<h;f++)if(0!==b.__kbparentsubscribers[e[f]].length)if("*"===e[f])for(k=0,d=Object.keys(b),p=d.length;k<p;k++)c(b,b.__kbparentsubscribers[e[f]],d[k]);else c(b,b.__kbparentsubscribers[e[f]],e[f])})(this.__kbnonproxy);return this}),stopChange:d(function(){this.__kbnonproxy._stopChange=!0;return this})});Object.defineProperties(C.prototype,{addDataListener:d(p("addDataListener","__kblisteners")),removeDataListener:d(r("removeDataListener","__kblisteners")),
addDataUpdateListener:d(p("addDataUpdateListener","__kbupdatelisteners")),removeDataUpdateListener:d(r("removeDataUpdateListener","__kbupdatelisteners")),addDataCreateListener:d(p("addDataCreateListener","__kbcreatelisteners")),removeDataCreateListener:d(r("removeDataCreateListener","__kbcreatelisteners")),addDataDeleteListener:d(p("addDataDeleteListener","__kbdeletelisteners")),removeDataDeleteListener:d(r("removeDataDeleteListener","__kbdeletelisteners")),addDataMethodListener:d(p("addDataMethodListener",
"__kbmethodlisteners")),removeDataMethodListener:d(r("removeDataMethodListener","__kbmethodlisteners")),addDataMethodUpdateListener:d(p("addDataMethodUpdateListener","__kbmethodupdatelisteners")),removeDataMethodUpdateListener:d(r("removeDataMethodUpdateListener","__kbmethodupdatelisteners")),addChildDataListener:d(z("addChildDataListener","__kbparentlisteners")),removeChildDataListener:d(v("removeChildDataListener","__kbparentlisteners")),addChildDataUpdateListener:d(z("addChildDataUpdateListener",
"__kbparentupdatelisteners")),removeChildDataUpdateListener:d(v("removeChildDataUpdateListener","__kbparentupdatelisteners")),addChildDataCreateListener:d(z("addChildDataCreateListener","__kbparentcreatelisteners")),removeChildDataCreateListener:d(v("removeChildDataCreateListener","__kbparentcreatelisteners")),addChildDataDeleteListener:d(z("addChildDataDeleteListener","__kbparentdeletelisteners")),removeChildDataDeleteListener:d(v("removeChildDataDeleteListener","__kbparentdeletelisteners"))});return C}}(),
Y=function(){return function(){function D(t){if("object"===typeof t)for(var C=0,q=t.length;C<q;C++)K_Components[t[C]]?u(t[C],K_Components[t[C]],document.getElementById("script_"+t[C])):D.load(t[C],"component/"+t[C]+"/"+location.search,u);else"string"===typeof t&&(K_Components[t[C]]?u(t,K_Components[t],document.getElementById("script_"+t)):D.load(t,"component/"+t+"/"+location.search,u))}var u=function(){},A=/(<\/.*?>)/g;window.K_Components||(window.K_Components={});D.getUnknowns=function(t){var u=
t.match(A);return u.map(function(q){return q.replace(/[<\/>]/g,"")}).filter(function(q,d){return document.createElement(q)instanceof HTMLUnknownElement&&-1===u.indexOf(q,d+1)&&!K_Components[q]})};D.load=function(t,u,q){document.head.appendChild(function(d,q,u){var t=document.createElement("script");t.type="text/javascript";t.charset="utf-8";t.async=!0;t.src=q;t.id="script_"+d;t.onload=function(){u(d,K_Components[d],this)};return t}(t,u,q));return D};D.onLoad=function(t){if(void 0===t)return u;u="function"===
typeof t?t:u;return D};return D}}(),W=function(){function D(){function u(f,e){var h=f.length,k;for(k=0;k<h&&(f[k](e),void 0===e._stopPropogation);k++);}function A(f,e){var h=f.length,k;for(k=0;k<h&&(e.child=e.target,e.target=f[k].parent,f[k].func(e),void 0===e._stopPropogation);k++);}function t(f,e){for(var h=f.length;0<h;U++)if(f[U].toString()===e.toString())return!0;return!1}function C(f,e,h,k,c,b,g,l){this.stopPropagation=function(){this._stopPropogation=!0};this.preventDefault=function(){this._preventDefault=
...
c.style,g=e.replace(/([A-Z])/g,"-$1").replace("webkit","-webkit"),l,m;return{get:function(){return m},set:function(f){l=m;h(c,e,f,l,void 0,this._stopChange)&&(m=f,b.setProperty(g,f));this._stopChange||k(c,e,f,l);this._stopChange=void 0},enumerable:!0,configurable:!0}}function G(f,e,h,k){if("function"!==typeof e)return n;var c=-1!==["value","checked"].indexOf(f),b=-1!==z.indexOf(f),g;if(this.toString()!==n.toString())if(h){var l=this.querySelectorAll("*");h=l.length;for(var m,d=0;d<h;d++){m=l[d].attrListeners();
if(c||"*"===f)void 0!==l[d].addInputBinding&&l[d].addInputBinding(),void 0!==l[d].addInputBoxBinding&&l[d].addInputBoxBinding();if(b)n.injectStyleProperty(l[d],f),g=k?"_parentStyleUpdateListeners":"_parentStyleListeners";else{if("*"===f){g=k?"_parentStyleUpdateListeners":"_parentStyleListeners";h=z.length;for(var p=0;p<h;p++)n.injectStyleProperty(l[d],z[p]);void 0===m[g]["*"]&&(m[g]["*"]=[]);m[g]["*"].push({parent:this,func:e})}g=k?"_parentAttrUpdateListeners":"_parentAttrListeners"}void 0===m[g][f]&&
(m[g][f]=[]);m[g][f].push({parent:this,func:e})}}else{m=this.attrListeners();if(b)g=k?"_styleUpdateListeners":"_styleListeners",n.injectStyleProperty(this,f);else{if(c||"*"===f)void 0!==this.addInputBinding&&this.addInputBinding(),void 0!==this.addInputBoxBinding&&this.addInputBoxBinding();if("*"===f){g=k?"_styleUpdateListeners":"_styleListeners";h=z.length;for(d=0;d<h;d++)n.injectStyleProperty(this,z[d]);void 0===m[g][f]&&(m[g][f]=[]);m[g][f].push(e)}g=k?"_attrUpdateListeners":"_attrListeners"}void 0===
m[g][f]&&(m[g][f]=[]);m[g][f].push(e)}else{if(c||"*"===f)for(p=document.querySelectorAll("input, textarea"),h=p.length,d=0;d<h;d++)void 0!==p[d].addInputBinding&&p[d].addInputBinding(),void 0!==p[d].addInputBoxBinding&&p[d].addInputBoxBinding();if(b){b=Array.prototype.slice.call(document.body.querySelectorAll("*"));h=b.length+1;b.unshift(document.body);for(d=0;d<h;d++)n.injectStyleProperty(b[d],f);g=k?y:F}else{if("*"===f){b=Array.prototype.slice.call(document.body.querySelectorAll("*"));h=b.length+
1;c=z.length;b.unshift(document.body);for(d=0;d<h;d++)for(p=0;p<c;p++)n.injectStyleProperty(b[d],z[p]);g=k?y:F;void 0===g[f]&&(g[f]=[]);g[f].push(e)}g=k?K:J}void 0===g[f]&&(g[f]=[]);g[f].push(e)}}function L(f,e,h,k){function c(b,c){var f=c[b],h=f.length;for(g=0;g<h;g++)f[g].toString()===e.toString()&&f.splice(g,1)}if("function"!==typeof e)return n;["value","checked"].indexOf(f);var b=-1!==z.indexOf(f),g;if(this.toString()!==n.toString())if(h){h=this.querySelectorAll("*");var l=h.length;b?(b=k?"_childStyleUpdateListeners":
"_childStyleListeners",c(f,this.attrListeners()[b]),b=k?"_parentStyleUpdateListeners":"_parentStyleListeners"):("*"===f&&(b=k?"_childStyleUpdateListeners":"_childStyleListeners",c(f,this.attrListeners()[b])),b=k?"_childAttrUpdateListeners":"_childAttrListeners",c(f,this.attrListeners()[b]),b=k?"_parentAttrUpdateListeners":"_parentAttrListeners");for(g=0;g<l;g++){for(var d=h[g].attrListeners()[b][f],p=d.length,r=0;r<p;r++)d[r].isEqualNode(this)&&d.slice(r,1);if("*"===f)for(listenersStyle=k?"_parentStyleUpdateListeners":
"_parentStyleListeners",d=h[g].attrListeners()[b][f],p=d.length,r=0;r<p;r++)d[r].isEqualNode(this)&&d.slice(r,1)}}else b?b=k?"_styleUpdateListeners":"_styleListeners":("*"===f&&(b=k?"_styleUpdateListeners":"_styleListeners",c(f,this.attrListeners()[b])),b=k?"_attrUpdateListeners":"_attrListeners"),c(f,this.attrListeners()[b]);else b?b=k?y:F:("*"===f&&(b=k?y:F,c(f,b)),b=k?K:J),c(f,b)}function O(f,e){n.addAttrListener.call(this,f,e,!0);return this}function P(f,e){n.addAttrUpdateListener.call(this,f,
e,!0);return this}function M(f,e){n.removeAttrListener.call(this,f,e,!0);return this}function H(f,e){n.removeAttrUpdateListener.call(this,f,e,!0);return this}function E(f,e,h){var d=this.attrListeners();"html"===e&&(e="innerHTML");"events"===e&&(e="onclick");switch(f){case "attr":if(t(d._attrListeners[e],h))return!0;break;case "attrupdate":if(t(d._attrUpdateListeners[e],h))return!0}return!1}function I(){this._stopChange=!0;return this}function n(){function f(b,g){var c,e=g.length;for(c=0;c<e;c++)-1===
b.indexOf(g[c])&&b.push(g[c]);return b}function e(b,g){for(var c=Object.keys(b),e,f,h=0,d=c.length;h<d;h++)if(e=c[h],void 0===g[e])g[e]=b[e].slice();else for(var k=0,p=b[e].length;k<p;k++)f=b[e][k],g[e].push(f)}function h(b){if(3!==b.target.nodeType&&8!==b.target.nodeType){var g=b.target.attrListeners(),c,h=["value","checked"],d=g._attrListeners,k=g._attrUpdateListeners,p=g._parentAttrListeners;c=g._parentAttrUpdateListeners;var r=!1;if(void 0!==J["*"]||void 0!==K["*"])r=!0;if(!0!==r&&void 0!==d["*"]||
void 0!==k["*"]||void 0!==p["*"]||void 0!==c["*"])r=!0;if(!0!==r)for(var v=0;v<h.length;v++)if(void 0!==J[h[v]]||void 0!==K[h[v]]||void 0!==d[h[v]]||void 0!==k[h[v]]||void 0!==p[h[v]]||void 0!==c[h[v]]){r=!0;break}c=r;h=Object.keys(F);d=Object.keys(y);Object.keys(g._styleListeners);Object.keys(g._styleUpdateListeners);k=Object.keys(g._parentStyleListeners);g=Object.keys(g._parentStyleUpdateListeners);p=[];if(0!==h.length||0!==d.length)p=f(p,h),p=f(p,d);if(0!==p.length&&0!==k.length||0!==g.length)p=
f(p,k),p=f(p,g);-1!==p.indexOf("*")&&(p=z);var g=p,h=g.length,q,t,d=[],w,k="outerHTML"===b.attr||"outerText"===b.attr?b.attr:void 0,p=b.target;void 0!==k&&(b.attr="appendChild",b.arguments=[b.target],b.target=b.target.parentElement);if(c){"appendChild"===b.attr&&3!==b.arguments[0].nodeType&&8!==b.arguments[0].nodeType?(d=Array.prototype.slice.call(b.arguments[0].querySelectorAll("input,textarea")),"INPUT"!==b.arguments[0].tagName&&"TEXTAREA"!==b.arguments[0].tagName||d.unshift(b.arguments[0])):d=
Array.prototype.slice.call(b.target.querySelectorAll("input,textarea"));w=d.length;for(var u=0;u<w;u++)void 0!==d[u].addInputBinding&&d[u].addInputBinding(),void 0!==d[u].addInputBoxBinding&&d[u].addInputBoxBinding()}"appendChild"===b.attr&&"#text"!==b.arguments[0].nodeName&&"#comment"!==b.arguments[0].nodeName?(d=Array.prototype.slice.call(b.arguments[0].querySelectorAll("*")),d.unshift(b.arguments[0])):d=Array.prototype.slice.call(b.target.querySelectorAll("*"));c=b.target.__kb._parentAttrListeners;
r=b.target.__kb._parentAttrUpdateListeners;v=b.target.__kb._parentStyleListeners;q=b.target.__kb._parentStyleUpdateListeners;w=d.length;for(u=0;u<w;u++){if(0!==h)for(t=0;t<h;t++)n.injectStyleProperty(d[u],g[t]);t=d[u].attrListeners();e(c,t._parentAttrListeners);e(r,t._parentAttrUpdateListeners);e(v,t._parentStyleListeners);e(q,t._parentStyleUpdateListeners)}void 0!==k&&(b.attr=k,b.target=p,b.arguments=[])}}function d(g){var c=g.target.attributes[g.arguments[0]],e="setAttribute"===g.attr?g.arguments[1]:
...
var b=N,g=w;n.addAttrUpdateListener("appendChild",h);n.addAttrUpdateListener("removeChild",h);n.addAttrUpdateListener("innerHTML",h);n.addAttrUpdateListener("outerHTML",h);n.addAttrUpdateListener("innerText",h);n.addAttrUpdateListener("outerText",h);n.addAttrUpdateListener("textContent",h);n.addAttrListener("setAttribute",d);n.addAttrListener("removeAttribute",d);n.addAttrUpdateListener("setAttribute",c);n.addAttrUpdateListener("removeAttribute",c);return n}var J={},K={},F={},y={},p={},r="textContent innerHTML innerText outerHTML outerText appendChild removeChild replaceChild insertAdjacentHTML insertBefore".split(" "),
z=Object.getOwnPropertyNames(document.documentElement.style),v=Object.keys(HTMLElement.prototype).filter(function(f){return 0===f.indexOf("on")}).concat(["addEventListener","removeEventListener"]),U,N=function(f,e,h,d,c,b){h=new C(f,e,h,d,c,void 0,"set",b);void 0!==f.__kb&&(d=f.__kb._attrListeners,c=f.__kb._styleListeners,b=f.__kb._parentAttrListeners,f=f.__kb._parentStyleListeners,void 0!==d[e]&&u(d[e],h),void 0===h._stopPropogation&&void 0!==c[e]&&u(c[e],h),void 0===h._stopPropogation&&void 0!==
...
m)};c.removeInputBoxBinding=function(){this.attrListeners()._onmousedown=void 0;this.removeEventListener("mouseup",m)};c.addInputBoxBinding=function(){this.attrListeners()._onmousedown=!0;this.addEventListener("mouseup",m)}}return n};n.addAttrListener=function(f,e,d){if("html"===f){f=0;for(var k=r.length;f<k;f++)G.call(this,r[f],e,d,!1)}else if("events"===f)for(f=0,k=v.length;f<k;f++)G.call(this,v[f],e,d,!1);else G.call(this,f,e,d,!1);return this};n.addAttrUpdateListener=function(f,e,d){if("html"===
f){f=0;for(var k=r.length;f<k;f++)G.call(this,r[f],e,d,!0)}else if("events"===f)for(f=0,k=v.length;f<k;f++)G.call(this,v[f],e,d,!0);else G.call(this,f,e,d,!0);return this};n.removeAttrListener=function(f,e,d){if("html"===f){f=0;for(var k=r.length;f<k;f++)L.call(this,r[f],e,d,!1)}else if("events"===f)for(f=0,k=v.length;f<k;f++)L.call(this,v[f],e,d,!1);else L.call(this,f,e,d,!1);return this};n.removeAttrUpdateListener=function(f,e,d){if("html"===f){f=0;for(var k=r.length;f<k;f++)L.call(this,r[f],e,
d,!0)}else if("events"===f)for(f=0,k=v.length;f<k;f++)L.call(this,v[f],e,d,!0);else L.call(this,f,e,d,!0);return this};n.hasListener=function(f,e,d){"html"===e&&(e="innerHTML");"events"===e&&(e="onclick");switch(f){case "attr":if(t(J[e],d))return!0;break;case "attrupdate":if(t(K[e],d))return!0}return!1};n.injectedPrototypes=function(){return p};return n}"function"===typeof define&&define.amd&&define("KB",D);return D}(),Z=function(D){return function(){function u(p){document.createDocumentFragment();
this.name=p.tagName.toLowerCase();this.template=n[this.name]||'<div class="missing_component">Unknown Component</div>';this.node=p;this.fragment=document.createDocumentFragment();this.wrapper=this.fragment.appendChild(document.createElement("div"));this.wrapper.className="Wrapper Wrapper__"+this.name;if(this.template.match(C())){var r=this.template;p=C();for(var r=r.split(p).filter(Boolean),z={},v=0,t,q,u=r.length;v<u;v++)r[v].match(p)&&(t=d(r[v].substring(r[v].indexOf("<"),r[v].indexOf("}}"))+"}").replace(/[<>]/g,
""),0===t.indexOf("/")&&z[t.replace("/","")]?(t=t.replace("/",""),q=Object.keys(z[t],"array"),0!==q.length&&(q=q[q.length-1],r[q]="\x3c!--"+r[q],z[t].splice(parseInt(q,10),1),r[v]+="--\x3e",q=Object.keys(z[t],"array"),0===q.length&&(z[t]=null,delete z[t]))):(z[t]||(z[t]=[]),z[t][v]=r[v]));v=0;q=Object.keys(z);for(u=q.length;v<u;v++)for(p=Object.keys(z[q[v]],"array");v<u;v++)r[p[0]]="\x3c!--"+r[p[0]]+"--\x3e";this.template=r.join("")}}function A(d,r,z,n){return{value:d,writable:!!r,enumerable:!!n,
configurable:!!z}}function t(){return new RegExp("(\\"+H.split("").join("\\")+")(.*?)(\\"+E.split("").join("\\")+")","g")}function C(){return new RegExp("(<\\"+H.split("").join("\\")+".*?\\"+E.split("").join("\\")+".*?>|<\\/\\"+H.split("").join("\\")+".*?\\"+E.split("").join("\\")+">)")}function q(d){return d.split(new RegExp("("+H.split("").join("\\")+")(.*?)("+E.split("").join("\\")+")","g")).map(function(d,p,n){return n[p-1]===H?H+d+E:d}).filter(function(d,p,n){return 0!==d.length&&d!==H&&d!==
E&&0!==d.length})}function d(d){return d.replace(new RegExp("["+H+E+"]","g"),"").replace(new RegExp("(\\"+I.split("").join("\\")+"(.*?)+)","g"),"").replace(/\s/g,"")}function S(d){return d.reduce(function(d,p){p.match(/(\()(.*?)(\))/)?d.vmFilters[d.vmFilters.length]=p.replace(/[\(\)]/g,""):p.match(/(\[)(.*?)(\])/)?-1!==p.indexOf("~")?d.model[d.model.length]=p.replace(/[\[\]\~]/g,""):-1!==p.indexOf("+")?d.local[d.local.length]=p.replace(/[\[\]\+]/g,""):d.session[d.session.length]=p.replace(/[\[\]\-]/g,
""):d.filters[d.filters.length]=p;return d},{filters:[],vmFilters:[],model:[],local:[],session:[]})}function R(d){return-1!==d.indexOf("for")?d.replace(new RegExp("["+H+E+"]","g"),"").replace(/\|(.*)/,"").replace(/\s/g,"").split(/for(.*?)loop/).filter(function(d){return 0!==d.length}):[]}function Q(d){if(2>d.split("==").length&&2>d.split("<=").length&&2>d.split(">=").length&&-1!==d.indexOf("="))return d.substring(d.indexOf("=")+1,d.length)}function G(d){var r=d.match(/^(\s*)(>)((.*?)+)/),n=d.match(/^(\s*)(<)((.*?)+)/);
d=d.replace(/(^<|^>)((.*?)+)/,"$2");var t=Q(d),q=d.match(/((==|<=|>=|<|>)((.*?)+))/g),u=d.match(/(([\+\*-\/])((.*?)+))/g);return{type:r?"insert":n?"outsert":void 0,set:t!==d?t:void 0,filters:q||u?{boolFilter:q?eval("(function(){ return function(v){ return (v"+q[0]+");};}())"):void 0,mathFilter:u?eval("(function(){ return function(v){ return (v"+u[0]+");};}())"):void 0}:void 0}}function L(d){if(0!==d.length){for(var r="",n=0,t=d.length;n<t;n++)if("string"===typeof d[n])r+=d[n];else if(void 0===d[n]._data)r+=
d[n].text;else var q=d[n]._data.get(d[n].key),r=r+O(void 0!==q?q:"",d[n].filters.filters,d[n]._data.filters);return r}return O(d[0]._data.get(d[0].key)||"",d[0].filters.filters,d[0]._data.filters)}function O(d,n,t){for(var q=0,u=n.length;q<u;q++)t[n[q]]&&(d=t[n[q]](d));return d}function P(d,n,q,t){for(var u=0,y=n.length;u<y;u++)if(q[n[u]])q[n[u]](d,t);return d}function M(){function d(e,f){var k=G(f);this.text=e;this.key=f.replace(/(^>|^<*)(.*?)([=*+-\/<>]+)((.*?)+)/g,"$2").replace(/\s/g,"");this.keyLength=
this.key.split(".").length;this.localKey=this.key.split(".").pop();var c;c=-1!==e.indexOf(I)?e.replace(new RegExp("["+E+"]","g"),"").replace(new RegExp("(.*?)(\\"+I.split("").join("\\")+")"),"").replace(/\s/g,"").split(","):[];this.filters=S(c);this.component="for"===this.type?R(e)[1]:void 0;this.id=0;this.subType=k.subtype;this.set=k.set;this.inlineFilters=k.filters;this.isBase=!1}function n(e,d){for(var f=0,c=d.length;f<c;f++)e.stopChange().appendChild(d[f])}function q(e){if(e&&window.model)return window.model.get(e[0])}
function t(e,d){if(d&&0!==d.length&&window.model)for(var f=0,c=d.length;f<c;f++)window.model.set(d[f],e)}function u(e){if(e&&window.localStorage)return localStorage.getItem(e[0])}function C(e,d){if(e&&0!==e.length&&window.localStorage)for(var f=0,c=e.length;f<c;f++)localStorage.setItem(e[f],d)}function w(e){if(e&&window.sessionStorage)return sessionStorage.getItem(e[0])}function f(e,d){if(e&&0!==e.length&&window.sessionStorage)for(var f=0,c=e.length;f<c;f++)sessionStorage.setItem(e[f],d)}Object.defineProperties(d.prototype,
{addPointer:A(function(e){for(var d=document.createElement(this.component),f=P(this._data.getLayer(this.key),this.filters.filters,this._data.filters,e)[e],c=0,b=Object.keys(f,"all"),g=b.length;c<g;c++)d.k_post||(d.k_post={}),d.k_post[b[c]]=f,d.k_post.x=e,d.k_post.loopid=this.component+"_"+e;e>=this.node.children.length?this.node.stopChange().appendChild(d):this.node.stopChange().insertBefore(d,this.node.children[e]);y({event:"loopitem",node:d,parent:this.node,map:this});return this}),removePointer:A(function(e){for(var d=
...
this.filters.session&&0!==this.filters.session.length?this._data.stopChange().set(this.key,w(this.filters.session)):this.filters.local&&0!==this.filters.local.length&&this._data.stopChange().set(this.key,u(this.filters.local)),this.isEvent?this.node.stopChange()[this.attr]=this._data.get(this.key):"innerHTML"===this.key?(this.node.stopChange().innerHTML="",n(this.node,this._data.innerHTML)):(this.local.stopChange()[this.localAttr]=L(this.bindText),this.isInput&&-1!==["value","checked"].indexOf(this.attr)&&
...
0,d=P(this._data.get(this.key),this.filters.filters,this._data.filters).length;e<d;e++)this.setLoop(e,"create");return this}),setData:A(function(e){e=O(e,this.filters.vmFilters,this._data.filters);this._data.stopChange().set(this.key,e);t(this.filters.model,e);f(this.filters.session,e);C(this.filters.local,e);return this}),setDom:A(function(e){t(this.filters.model,e);f(this.filters.session,e);C(this.filters.local,e);this.isEvent?this.node.stopChange()[this.attr]=this._data.get(this.key):this.isInput&&
...
parent:this.node,map:this.base}))})});return d}var H="{{",E="}}",I="|",n={},J=/(<\/.*?>)/g;D().call();var K=Object.keys(HTMLElement.prototype).filter(function(d){return 0===d.indexOf("on")}),F={loopitem:[],replaceNode:[]},y=function(d){for(var n=F[d.event],q=0,t=n.length;q<t;q++)n[q](d)};u.start=function(d){if(void 0===d)return H;H="string"===typeof d?d:H;return u};u.end=function(d){if(void 0===d)return E;E="string"===typeof d?d:E;return u};u.pipe=function(d){if(void 0===d)return I;I="string"===typeof d?
...
n){void 0!==F[d]?F[d].push(n):console.error("Class: KonnektMP Method: 'addEventListener', No event exists with the name %o",d);return u};u.removeEventListener=function(d,n){if(void 0!==F[d])for(var q=0,t=F[d].length;q<t;q++)F[d][q].toString()===n.toString()&&F[d].splice(q,1);else console.error("Class: KonnektMP Method: 'removeEventListener', No event exists with the name %o",d);return u};Object.defineProperties(u.prototype,{register:A(u.register),isRegistered:A(u.isRegistered),getUnknown:A(u.getUnknown),
map:A(function(n){function u(z,v){for(var y=0,A=z.length;y<A;y++)if(void 0===z[y].kb_maps&&8!==z[y].nodeType){z[y].kb_mapper=n;z[y].kb_maps=v;if(3===z[y].nodeType){var w=z[y],f=v,e=w.textContent;if(e.match(t())){var h=q(e),k=M();k.prototype.type=e.match(new RegExp("(\\"+H.split("").join("\\")+")(.*?)(for)(.*?)(loop)(.*?)(\\"+E.split("").join("\\")+")","g"))?"for":"text";k.prototype.text=e;k.prototype.bindText=h;k.prototype.listener="textContent";k.prototype.attr="textContent";k.prototype.localAttr=
"textContent";k.prototype.local=w;k.prototype.node=w.parentElement;k.prototype.binds=f;w=0;for(e=h.length;w<e;w++)if(0===h[w].indexOf(H)){var c="for"===k.prototype.type?R(h[w])[0]:d(h[w]),b=new k(h[w],c);void 0===f[c]&&(f[c]=[]);b.bindText[w]=b;b.bindMaps.push(b);b.id=f[c].length;f[c].push(b)}}}else for(f=z[y],h=v,k=Array.prototype.slice.call(f.attributes),w=f instanceof HTMLUnknownElement,e=0,c=k.length;e<c;e++)if(k[e].value.match(t())){var b=q(k[e].value),g=M();g.prototype.type=w?"component":"attribute";
...
T=new g(b[l],B);void 0===h[B]&&(h[B]=[]);T.bindText[l]=T;T.bindMaps.push(T);T.id=h[B].length;h[B].push(T)}}z[y].childNodes&&0!==z[y].childNodes.length&&(v=u(z[y].childNodes,v))}else if(8===z[y].nodeType&&(w=z[y],f=v,e=w.textContent,e.match(C())))for(h=q(e),k=M(),k.prototype.type="node",k.prototype.text=e,k.prototype.bindText=h,k.prototype.base=h[1],k.prototype.listener="textContent",k.prototype.attr="textContent",k.prototype.localAttr="textContent",k.prototype.local=w,k.prototype.node=w.parentElement,
k.prototype.binds=f,k.prototype.replacement=void 0,w=0,e=h.length;w<e;w++)0===h[w].indexOf(H)&&(c=d(h[w]),b=new k(h[w],c),void 0===f[c]&&(f[c]=[]),b.bindText[w]=b,b.bindMaps.push(b),b.id=f[c].length,1===w&&(k.prototype.base=b,b.isBase=!0),f[c].push(b));return v}return u(n.childNodes,{})})});return u}}(W),aa=function(){return function(){function D(q){0===q.length&&(q=A);q=new u(q);for(var d=0,S=C.length;d<S;d++)if(!q._stopPropogation)C[d](q);q._preventDefault||(document.body.innerHTML="<"+q.hash+"></"+
q.hash+">",t(q.hash));return D}function u(q){this.preventDefault=function(){this._preventDefault=!0};this.stopPropogation=function(){this._stopPropogation=!0};this.hash=q;this.url=window.location.href}var A="",t=function(){},C=[];D.base=function(q){if(void 0===q)return A;A="string"===typeof q?q:A;return D};D.addHashListener=function(q){C.push(q);return D};D.removeHashListener=function(q){for(var d=0,t=C.length;d<t;d++)if(C[d].toString()===q.toString()){C.splice(d,1);break}return D};D.onChange=function(q){if(void 0===
q)return t;t="function"===typeof q?q:t;return D};D.watch=function(q){window.onhashchange=q?function(){D(window.location.hash.replace("#",""))}:null;return D};return D}}(),V=function(D,u,A,t,C){return function(q){function d(b,c,e,f,k){function n(b,c,d,g,e){for(var f=F({},b),l=0,m=Object.keys(g),k=m.length;l<k;l++)-1!==h.indexOf(m[l])?Object.defineProperty(f,m[l],G(g[m[l]],"filters"!==m[l])):g.pointers?void 0===g.pointers[m[l]]&&f.set(m[l],g[m[l]]):f.set(m[l],g[m[l]]);if(g.pointers)for(f.pointers||
Object.defineProperty(f,"pointers",G({},!1,!0)),l=0,m=Object.keys(g.pointers),k=m.length;l<k;l++)f.pointers[m[l]]=g.pointers[m[l]],f.addPointer(f.pointers[m[l]].point,f.pointers[m[l]].key,m[l]);l=0;m=Object.keys(c.prototype);for(k=m.length;l<k;l++)Object.defineProperty(f,[m[l]],G(c.prototype[m[l]],!0));c.apply(f,d);l=0;m=Object.keys(e);for(k=m.length;l<k;l++)-1!==h.indexOf(m[l])?Object.defineProperty(f,m[l],G(e[m[l]],"filters"!==m[l])):e.pointers?void 0===e.pointers[m[l]]&&f.set(m[l],e[m[l]]):f.set(m[l],
...
HTMLUnknownElement&&d(b[c])}function t(b,e){r=new z(e,!0);r.wrapper.innerHTML=r.template;r.wrapper.kb_mapper=r.wrapper;Object.defineProperty(r.wrapper,"__kbcomponenttree",G(e.kb_mapper?e.kb_mapper.__kbcomponenttree.slice():[]));e.parentElement.stopChange().replaceChild(r.fragment,e);c.unshift(r.wrapper);p(r.wrapper,r,n(b,N[b],c,v,w));-1===r.wrapper.__kbcomponenttree.indexOf(b)||r.wrapper.kb_viewmodel.multiple?(r.wrapper.__kbcomponenttree.push(b),r.wrapper.className+=" "+r.wrapper.kb_viewmodel.local,
...
"multiple",G(!1,!0,!1,!0));f&&Q(f,w);w.innerHTML=Array.prototype.slice.call(b.childNodes);e=0;for(f=b.attributes.length;e<f;e++)w[b.attributes[e].name]=b.attributes[e].value;e=0;for(f=k.length;e<f;e++)b[k[e]]&&(w[k[e]]=b[k[e]]);b.k_post&&Q(b.k_post,w);d.isRegistered(u)||b.kb_isLoading?d.isRegistered(u)&&t(u,b):(d.loadWaitList(u,function(c,d){t(u,b)}),d.loadWaitList(u).loading||(d.loadWaitList(u).loading=!0,K(u)))}function A(b){var c=this.__kbref.local,d=this.__kbref.id,e=this.__kbref.loopid,h=this.__kbscopeString+
...
d.detectBrowser();d.device.screenSize=d.detectScreenSize();d.device.orientationSize=d.detectScreenOrientation();d.device.keyboard="desktop"!==d.device.type?window.innerHeight<screen.height-.4*screen.height:!1;document.body.className=d.device.type+" "+d.device.orientation+(d.device.keyboard?" keyboard":"")+" "+d.device.browser+" "+d.device.screenSize+" "+d.device.orientationSize}function H(b,c){var d=document.createElement("script");d.src=b;d.onerror=function(){c(null,!0)};d.onload=function(){c(y)};
document.head.stopChange().appendChild(d)}function E(b){H((void 0!==y.prefix?y.prefix:"")+"/node_modules/konnekt/config/config.js",b)}function I(b){H((void 0!==y.prefix?y.prefix:"")+"/bower_components/konnekt/config/config.js",b)}function n(b){H((void 0!==y.prefix?y.prefix:"")+"/config/config.js",b)}function J(){for(var b=0,c=r.length;b<c;b++)r[b]()}window.K_Components||(window.K_Components={});var K=u().onLoad(function(b,c){var e="<style>"+unescape(c.prototype.k_css)+"</style>"+unescape(c.prototype.k_html);
d.register(b,c,e,c.prototype.cms);p?(d.loadWaitList(b).forEach(function(d){d(b,c)}),d.loadWaitList(b,"clear")):r.push(function(){d.loadWaitList(b).forEach(function(d){d(b,c)});d.loadWaitList(b,"clear")})}),F=D(),y=q||{},p=!1,r=[],z=t().addEventListener("loopitem",R).addEventListener("replaceNode",R),v=C().base(void 0!==y.base?y.base:"default").watch(!0).onChange(function(b){d(document.querySelector(b))}),U=F({},"Model"),N={},w={},f={},e=function(){return window.location.search.replace("?","").split("&").filter(function(b){return 0!==
...
"desktop-size"};d.config=function(b){function c(b,d){for(var e=0,f=Object.keys(b),h=f.length;e<h;e++)"object"===typeof b[f[e]]?(void 0===d[f[e]]&&(d[f[e]]={}),c(b[f[e]],d[f[e]])):"object"!==d[f[e]]&&(d[f[e]]=b[f[e]])}c(b,y);return d};window.addEventListener("resize",M);document.body?M():document.addEventListener("DOMContentLoaded",function(){M()});d.register=function(b,c,e,f){z.register(b,e);N[b]=c;return d};d.isRegistered=function(b){return void 0!==N[b]&&z.isRegistered(b)};d.registered=function(){return Object.keys(N)};
...
e.env&&(e.env="qa"),d=b.src.replace(d[0],"").replace(/[\/\s]/g,""),b.src=(void 0!==y.prefix?y.prefix:"")+"/components/"+d+"/build/"+e.env+"/"+d+(e.debug&&"prod"!==e.env?"":".min")+".js",arguments[0]=b)}return c.apply(this,arguments)}):c&&(Node.prototype.appendChild=c,c=null);return d};d.hashRouting=function(b){b&&(document.body?p?v(window.location.hash.replace("#","")):r.push(function(){v(window.location.hash.replace("#",""))}):document.addEventListener("DOMContentLoaded",function(){p?v(window.location.hash.replace("#",
"")):r.push(function(){v(window.location.hash.replace("#",""))})}));return this};d.addHashRouter=function(b){v.addHashListener(b);return d};d.removeHashRouter=function(b){v.removeHashListener(b);return d};F.prototype._parse||(F.prototype._parse=F.prototype.parse);F.prototype.parse=function(){if(this.__kbref.kbnode){var b=this.__kbref.kbnode.kb_mapper.kb_maps;this._parse.apply(this,arguments);this.unsubscribeDeep("*",A);this.subscribeDeep("*",A).callAllSubscribers();Object.keys(b).forEach(function(c){b[c].forEach(function(b){b.reset()})})}else return this._parse.apply(this,
