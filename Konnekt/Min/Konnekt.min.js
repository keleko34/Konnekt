...
return this}),unsubscribe:d(function(b,c){var f=b.split("."),e=f.pop(),f=0!==f.length?this.__kbnonproxy.getLayer(f.join(".")):this.__kbnonproxy;if(void 0!==f.__kbsubscribers[e])for(var g=0,h=f.__kbsubscribers[e].length;g<h;g++)if(f.__kbsubscribers[e][g].toString()===c.toString()){f.__kbsubscribers[e].splice(g,1);break}return this}),subscribeDeep:d(function(b,c){function f(b,e){var g=Object.keys(b,"all").filter(function(c){return l.call(b[c])}.bind(b));if(void 0!==b[e]||"*"===e)void 0===b.__kbparentsubscribers[e]&&
(b.__kbparentsubscribers[e]=[]),b.__kbparentsubscribers[e].push(c);for(var h=0,n=g.length;h<n;h++)f(b[g[h]],e)}var e=-1!==b.indexOf("*"),g=b.split(".");g.slice(0,g.indexOf("*"));var h=-1!==g.indexOf("*")?g.slice(g.indexOf("*"),g.length):[],k=1===h.length,n=g.pop(),g=0!==g.length?this.__kbnonproxy.getLayer(g.join(".")):this.__kbnonproxy;e?k?f(g,"*"):(h.shift(),g.subscribeDeep(h.join("."),c)):f(g,n);return this}),unsubscribeDeep:d(function(b,c){function e(b,g){var h=Object.keys(b,"all").filter(function(c){return l.call(b[c])&&
...
removeDataMethodUpdateListener:d(z("removeDataMethodUpdateListener","__kbmethodupdatelisteners")),addChildDataListener:d(J("addChildDataListener","__kbparentlisteners")),removeChildDataListener:d(q("removeChildDataListener","__kbparentlisteners")),addChildDataUpdateListener:d(J("addChildDataUpdateListener","__kbparentupdatelisteners")),removeChildDataUpdateListener:d(q("removeChildDataUpdateListener","__kbparentupdatelisteners")),addChildDataCreateListener:d(J("addChildDataCreateListener","__kbparentcreatelisteners")),
removeChildDataCreateListener:d(q("removeChildDataCreateListener","__kbparentcreatelisteners")),addChildDataDeleteListener:d(J("addChildDataDeleteListener","__kbparentdeletelisteners")),removeChildDataDeleteListener:d(q("removeChildDataDeleteListener","__kbparentdeletelisteners"))});return O}}(),X=function(){return function(){function A(t){if("object"===typeof t)for(var v=0,C=t.length;v<C;v++)K_Components[t[v]]?m(t[v],K_Components[t[v]],document.getElementById("script_"+t[v])):A.load(t[v],"component/"+
...
"_parentStyleListeners";else{if("*"===e){h=f?"_parentStyleUpdateListeners":"_parentStyleListeners";c=q.length;for(var r=0;r<c;r++)l.injectStyleProperty(d[u],q[r]);void 0===n[h]["*"]&&(n[h]["*"]=[]);n[h]["*"].push({parent:this,func:b})}h=f?"_parentAttrUpdateListeners":"_parentAttrListeners"}void 0===n[h][e]&&(n[h][e]=[]);n[h][e].push({parent:this,func:b})}}else{n=this.attrListeners();if(g)h=f?"_styleUpdateListeners":"_styleListeners",l.injectStyleProperty(this,e);else{if(k||"*"===e)void 0!==this.addInputBinding&&
this.addInputBinding(),void 0!==this.addInputBoxBinding&&this.addInputBoxBinding();if("*"===e){h=f?"_styleUpdateListeners":"_styleListeners";c=q.length;for(u=0;u<c;u++)l.injectStyleProperty(this,q[u]);void 0===n[h][e]&&(n[h][e]=[]);n[h][e].push(b)}h=f?"_attrUpdateListeners":"_attrListeners"}void 0===n[h][e]&&(n[h][e]=[]);n[h][e].push(b)}else{if(k||"*"===e)for(r=document.querySelectorAll("input, textarea"),c=r.length,u=0;u<c;u++)void 0!==r[u].addInputBinding&&r[u].addInputBinding(),void 0!==r[u].addInputBoxBinding&&
r[u].addInputBoxBinding();if(g){g=Array.prototype.slice.call(document.body.querySelectorAll("*"));c=g.length+1;g.unshift(document.body);for(u=0;u<c;u++)l.injectStyleProperty(g[u],e);h=f?I:x}else{if("*"===e){g=Array.prototype.slice.call(document.body.querySelectorAll("*"));c=g.length+1;k=q.length;g.unshift(document.body);for(u=0;u<c;u++)for(r=0;r<k;r++)l.injectStyleProperty(g[u],q[r]);h=f?I:x;void 0===h[e]&&(h[e]=[]);h[e].push(b)}h=f?w:F}void 0===h[e]&&(h[e]=[]);h[e].push(b)}}function M(e,b,c,f){function k(c,
...
g=f?"_childAttrUpdateListeners":"_childAttrListeners",k(e,this.attrListeners()[g]),g=f?"_parentAttrUpdateListeners":"_parentAttrListeners");for(h=0;h<d;h++){for(var n=c[h].attrListeners()[g][e],u=n.length,r=0;r<u;r++)n[r].isEqualNode(this)&&n.slice(r,1);if("*"===e)for(listenersStyle=f?"_parentStyleUpdateListeners":"_parentStyleListeners",n=c[h].attrListeners()[g][e],u=n.length,r=0;r<u;r++)n[r].isEqualNode(this)&&n.slice(r,1)}}else g?g=f?"_styleUpdateListeners":"_styleListeners":("*"===e&&(g=f?"_styleUpdateListeners":
...
b&&(b="innerHTML");"events"===b&&(b="onclick");switch(e){case "attr":if(t(f._attrListeners[b],c))return!0;break;case "attrupdate":if(t(f._attrUpdateListeners[b],c))return!0}return!1}function K(){this._stopChange=!0;return this}function l(){function e(b,c){var e,f=c.length;for(e=0;e<f;e++)-1===b.indexOf(c[e])&&b.push(c[e]);return b}function b(b,c){for(var e=Object.keys(b),f,g,h=0,k=e.length;h<k;h++)if(f=e[h],void 0===c[f])c[f]=b[f].slice();else for(var d=0,p=b[f].length;d<p;d++)g=b[f][d],c[f].push(g)}
function c(c){if(3!==c.target.nodeType&&8!==c.target.nodeType){var f=c.target.attrListeners(),g,h=["value","checked"],k=f._attrListeners,d=f._attrUpdateListeners,p=f._parentAttrListeners;g=f._parentAttrUpdateListeners;var r=!1;if(void 0!==F["*"]||void 0!==w["*"])r=!0;if(!0!==r&&void 0!==k["*"]||void 0!==d["*"]||void 0!==p["*"]||void 0!==g["*"])r=!0;if(!0!==r)for(var B=0;B<h.length;B++)if(void 0!==F[h[B]]||void 0!==w[h[B]]||void 0!==k[h[B]]||void 0!==d[h[B]]||void 0!==p[h[B]]||void 0!==g[h[B]]){r=
!0;break}g=r;h=Object.keys(x);k=Object.keys(I);Object.keys(f._styleListeners);Object.keys(f._styleUpdateListeners);d=Object.keys(f._parentStyleListeners);f=Object.keys(f._parentStyleUpdateListeners);p=[];if(0!==h.length||0!==k.length)p=e(p,h),p=e(p,k);if(0!==p.length&&0!==d.length||0!==f.length)p=e(p,d),p=e(p,f);-1!==p.indexOf("*")&&(p=q);var f=p,h=f.length,z,y,k=[],m,d="outerHTML"===c.attr||"outerText"===c.attr?c.attr:void 0,p=c.target;void 0!==d&&(c.attr="appendChild",c.arguments=[c.target],c.target=
...
c);l.addAttrUpdateListener("textContent",c);l.addAttrListener("setAttribute",f);l.addAttrListener("removeAttribute",f);l.addAttrUpdateListener("setAttribute",d);l.addAttrUpdateListener("removeAttribute",d);return l}var F={},w={},x={},I={},z={},J="textContent innerHTML innerText outerHTML outerText appendChild removeChild replaceChild insertAdjacentHTML insertBefore".split(" "),q=Object.getOwnPropertyNames(document.documentElement.style),r=Object.keys(HTMLElement.prototype).filter(function(e){return 0===
...
e;d++)this.setLoop(d,"create");return this}),setData:v(function(d){d=M(d,this.filters.vmFilters,this._data.filters);this._data.stopChange().set(this.key,d);t(this.filters.model,d);y(this.filters.session,d);r(this.filters.local,d);return this}),setDom:v(function(d){t(this.filters.model,d);y(this.filters.session,d);r(this.filters.local,d);this.isEvent?this.node.stopChange()[this.attr]=this._data.get(this.key):this.isInput&&-1!==["value","checked"].indexOf(this.attr)?this.node.stopChange()[this.attr]=
...
")","g"),v,q,r;v=t.exec(l);)q=d(v[1]).replace(">",""),v=P(v[1]),(r=m.get(q))&&(l=l.replace(O(q),M(r,v,m.filters)));return l};Object.defineProperties(m.prototype,{register:v(m.register),isRegistered:v(m.isRegistered),getUnknown:v(m.getUnknown),map:v(function(l){function m(v,w){for(var q=0,r=v.length;q<r;q++)if(void 0===v[q].kb_maps&&8!==v[q].nodeType){v[q].kb_mapper=l;v[q].kb_maps=w;if(3===v[q].nodeType){var B=v[q],y=w,k=B.textContent;if(k.match(t())){var e=C(k),b=L();b.prototype.type=k.match(new RegExp("(\\"+
...
y[c].length;y[c].push(f)}}}else for(y=v[q],e=w,b=Array.prototype.slice.call(y.attributes),B=y instanceof HTMLUnknownElement,k=0,c=b.length;k<c;k++)if(b[k].value.match(t())){var f=C(b[k].value),p=L();p.prototype.type=B?"component":"attribute";p.prototype.text=b[k].value;p.prototype.bindText=f;p.prototype.isEvent=-1!==F.indexOf(b[k].name);p.prototype.isInput="input"===y.tagName.toLowerCase();p.prototype.isRadio=p.prototype.isInput?-1!==["radio","checkbox"].indexOf(y.type):!1;p.prototype.listener=b[k].name;
p.prototype.attr=b[k].name;p.prototype.localAttr="value";p.prototype.local=b[k];p.prototype.node=y;p.prototype.binds=e;p.prototype.isEvent&&y.removeAttribute(b[k].name);for(var g=0,h=f.length;g<h;g++)if(0===f[g].indexOf(D)){var A=d(f[g]),n=new p(f[g],A);void 0===e[A]&&(e[A]=[]);n.bindText[g]=n;n.bindMaps.push(n);n.id=e[A].length;e[A].push(n)}}v[q].childNodes&&0!==v[q].childNodes.length&&(w=m(v[q].childNodes,w))}return w}return m(l.childNodes,{})}),insert:v(m.insert)});return m}}(U),Z=function(){return function(){function A(t){0===
t.length&&(t=m);document.body.innerHTML="<"+t+"></"+t+">";v(t);return A}var m="",v=function(){};A.base=function(t){if(void 0===t)return m;m="string"===typeof t?t:m;return A};A.onChange=function(m){if(void 0===m)return v;v="function"===typeof m?m:v;return A};A.watch=function(m){window.onhashchange=m?function(){A(window.location.hash.replace("#",""))}:null;return A};return A}}(),T=function(A,m,v,t,O){return function(v){function d(q,r,m,y){function k(b,c,e,d,f){for(var g=L({},b),h=0,k=Object.keys(c.prototype),
...
for(q=k.length;h<q;h++)-1!==I.indexOf(k[h])?Object.defineProperty(g,k[h],H(f[k[h]],"filters"!==k[h])):f.pointers?void 0===f.pointers[k[h]]&&g.set(k[h],f[k[h]]):g.set(k[h],f[k[h]]);if(f.pointers)for(g.pointers||Object.defineProperty(g,"pointers",H({},!1,!0)),h=0,k=Object.keys(f.pointers),q=k.length;h<q;h++)g.pointers[k[h]]=f.pointers[k[h]],g.addPointer(g.pointers[k[h]].point,g.pointers[k[h]].key,k[h]);h=0;k=Object.keys(g.filters);for(q=k.length;h<q;h++)g.filters[k[h]]=g.filters[k[h]].bind(g);if(g.sessionStorage){if(c=
sessionStorage.getItem(g.id||b))for(c=JSON.parse(c),h=0,k=Object.keys(c),q=k.length;h<q;h++)g.set(k[h],c[k[h]]);else sessionStorage.setItem(g.id||b,g.stringify());g.addChildDataUpdateListener("*",function(){sessionStorage.setItem(g.id||b,g.stringify())})}if(g.localStorage){if(c=localStorage.getItem(g.id||b))for(c=JSON.parse(c),h=0,k=Object.keys(c),q=k.length;h<q;h++)g.set(k[h],c[k[h]]);else localStorage.setItem(g.id||b,g.stringify());g.addChildDataUpdateListener("*",function(){localStorage.setItem(g.id||
b,g.stringify())})}g.store&&K.set(g.id||b,g);return g}function e(b,c,e){b.kb_viewmodel=e;c.wrapper.innerHTML=E.insert(c.template,e);var d=c.maps=c.map(c.wrapper);c.wrapper.kb_maps=d;Object.keys(d).forEach(function(b){d[b].forEach(function(b){switch(b.type){case "for":b.connect(e).createloop();break;case "component":b.connect(e).unsync();break;default:b.connect(e)}})});c.wrapper.kb_viewmodel.onFinish.call(c.wrapper.kb_viewmodel,c.wrapper)}function b(b){b=b.querySelectorAll("*");for(var c=0,e=b.length;c<
e;c++)b[c]instanceof HTMLUnknownElement&&d(b[c])}function c(c,d){p=new E(d,!0);Object.defineProperty(p.wrapper,"__kbcomponenttree",H(d.kb_mapper?d.kb_mapper.__kbcomponenttree.slice():[]));d.parentElement.replaceChild(p.fragment,d);r.unshift(p.wrapper);e(p.wrapper,p,k(c,l[c],r,h,t));-1===p.wrapper.__kbcomponenttree.indexOf(c)||p.wrapper.kb_viewmodel.multiple?(p.wrapper.__kbcomponenttree.push(c),p.wrapper.className+=" "+p.wrapper.kb_viewmodel.local,p.wrapper.className+=" "+p.wrapper.kb_viewmodel.id,
p.wrapper.className+=p.wrapper.kb_viewmodel.loopid?" "+p.wrapper.kb_viewmodel.loopid:"",p.wrapper.kb_viewmodel.subscribeDeep("*",function(b){var c=this.__kbref.local,e=this.__kbref.id,d=this.__kbref.loopid,f=this.__kbscopeString+(0!==this.__kbscopeString.length?".":"")+b.key;if(w[c]&&w[c][f])for(var g=0,h=w[c][f].length;g<h;g++)w[c][f][g](b);if(w[e]&&w[e][f])for(g=0,h=w[e][f].length;g<h;g++)w[e][f][g](b);if(w[d]&&w[d][f])for(g=0,h=w[d][f].length;g<h;g++)w[d][f][g](b)}).callAllSubscribers(),b(p.wrapper)):
(console.error("Warning!! You are attempting to make a recursive component %o, recursive components can lead to memory stack overflows unless properly handled, Please check your components html for use of this component, if You want this to be a recursive component please set `this.multiple = true;`",c),console.error("Recursive Component %o on %o",p.wrapper,p.wrapper.parentElement),p.wrapper.parentElement.removeChild(p.wrapper))}var f=q.tagName.toLowerCase(),p,g=Object.keys(HTMLElement.prototype).filter(function(b){return 0===
b.indexOf("on")}),h={},t={};void 0===r&&(r=[]);m&&P(m,h);Object.defineProperty(h,"local",H(h.local||"local_"+f+"-"+(Math.floor(Math.random()*Date.now())+1),!0,!1,!0));Object.defineProperty(h,"id",H(h.id||"id_"+f+"-"+(Math.floor(Math.random()*Date.now())+1),!0,!1,!0));Object.defineProperty(h,"filters",H(h.filters||{},!1,!1,!0));"function"!==typeof h.onFinish&&(h.onFinish=function(){});Object.defineProperty(h,"onFinish",H(h.onFinish,!0,!1,!0));"function"!==typeof h.listen&&(h.listen=N);Object.defineProperty(h,
...
"localStorage",H(void 0!==h.localStorage?h.localStorage:!1,!0,!1,!0));"string"===typeof h.store&&(h.store="true"===h.store);Object.defineProperty(h,"store",H(void 0!==h.store?h.store:!1,!0,!1,!0));"string"===typeof h.multiple&&(h.multiple="true"===h.multiple);Object.defineProperty(h,"multiple",H(void 0!==h.multiple?h.multiple:!1,!0,!1,!0));y&&P(y,t);t.innerHTML=Array.prototype.slice.call(q.childNodes);m=0;for(y=q.attributes.length;m<y;m++)t[q.attributes[m].name]=q.attributes[m].value;m=0;for(y=g.length;m<
y;m++)q[g[m]]&&(t[g[m]]=q[g[m]]);q.k_post&&P(q.k_post,t);d.isRegistered(f)||q.kb_isLoading?d.isRegistered(f)&&c(f,q):(d.loadWaitList(f,function(b,e){c(f,q)}),d.loadWaitList(f).loading||(d.loadWaitList(f).loading=!0,Q(f)))}function P(d,r){var l=Object.keys(d);r.pointers||Object.defineProperty(r,"pointers",{value:{},writable:!0,enumerable:!1,configurable:!0});for(var m=0,k=l.length;m<k;m++)if(L.prototype.isObservable(d,l[m]))r.pointers[l[m]]={key:d.__kbscopeString.split(".").pop(),point:d.__kbImmediateParent};
else if(L.prototype.isMixed(d[l[m]]))r.pointers[l[m]]={key:d[l[m]].__kbscopeString.split(".").pop(),point:d[l[m]].__kbImmediateParent};else if(L.prototype.isObject(d[l[m]]))for(var e=0,b=Object.keys(d[l[m]]);e<k;e++)r[l[m]][b[e]]=d[l[m]][b[e]];else if(L.prototype.isArray(d[l[m]]))for(e=0;e<k;e++)r[l[m]][e]=d[l[m]][e];else r[l[m]]=d[l[m]]}function H(d,r,l,m){return{value:d,writable:!!r,enumerable:!!m,configurable:!!l}}function R(d,r,l){if(2===arguments.length)if(l=r.bind(this),r=d,F[r])for(var m=0,
k=F[r].length;m<k;m++)F[r][m].toString()===l.toString()&&F[r].splice(m,1);else console.error("no listeners exists by key %o",r);else if(l=l.bind(this),w[d]&&w[d][r])for(m=0,k=w[d][r].length;m<k;m++)w[d][r].toString()===l.toString()&&w[d][r].splice(m,1);return this}function N(d,m,l){2===arguments.length?(l=m.bind(this),m=d,F[m]||(F[m]=[]),F[m].push(l)):(l=l.bind(this),w[d]||(w[d]={}),w[d][m]||(w[d][m]=[]),w[d][m].push(l));return this}function M(d,m){if(F[d])for(var l=0,t=F[d].length;l<t;l++)F[d][l](m);
return this}window.K_Components||(window.K_Components={});var Q=m().onLoad(function(m,l){var t="<style>"+unescape(l.prototype.k_css)+"</style>"+unescape(l.prototype.k_html);d.register(m,l,t,l.prototype.cms);d.loadWaitList(m).forEach(function(d){d(m,l)});d.loadWaitList(m,"clear")}),L=A(),D=v||{},E=t().addEventListener("loopitem",function(m){var l=m.node.tagName.toLowerCase();d.isRegistered(l)||m.node.kb_isLoading?d.isRegistered(l)&&d(m.node):(m.node.kb_isLoading=!0,d.loadWaitList(l,function(l,r){d(m.node)}),
d.loadWaitList(l).loading||(d.loadWaitList(l).loading=!0,Q(l)))}),G=O().base(void 0!==D.base?D.base:"default").watch(!0).onChange(function(l){d(document.querySelector(l))}),K=L({},"Model"),l={},F={},w={},x=function(){return window.location.search.replace("?","").split("&").filter(function(d){return 0!==d.length}).reduce(function(d,l){d[l.split("=")[0]]=l.split("=")[1];return d},{})}(),I="id filters class sessionStorage localStorage store component multiple".split(" "),z={},J;d.register=function(m,
r,t,v){E.register(m,t);l[m]=r;return d};d.isRegistered=function(d){return void 0!==l[d]&&E.isRegistered(d)};d.registered=function(){return Object.keys(l)};d.loadWaitList=function(l,m){if("undefined"===typeof m&&l)return z[l];if(l){if(void 0===z[l]||"clear"===m){var t=void 0===z[l]?!1:!!z[l].loading;z[l]=[];z[l].loading=t}"function"===typeof m&&z[l].push(m)}return d};d.localRouting=function(l){l?(J=Node.prototype.appendChild,Node.prototype.appendChild=function(d){if("script"===d.nodeName.toLowerCase()){d.src=
d.src.substring(0,-1!==d.src.indexOf("?")?d.src.indexOf("?"):d.src.length);var l=d.src.match(/(.*?component\/)/);l&&(x.env||(x.env="prod"),"dev"===x.env&&(x.env="qa"),l=d.src.replace(l[0],"").replace(/[\/\s]/g,""),d.src=(void 0!==D.prefix?D.prefix:"")+"/components/"+l+"/build/"+x.env+"/"+l+(x.debug&&"prod"!==x.env?"":".min")+".js",arguments[0]=d)}return J.apply(this,arguments)}):J&&(Node.prototype.appendChild=J,J=null);return d};d.hashRouting=function(d){d&&(document.body?G(window.location.hash.replace("#",
"")):document.addEventListener("DOMContentLoaded",function(){G(window.location.hash.replace("#",""))}))};return d}}(W,X,U,Y,Z);"undefined"!==typeof window&&"undefined"!==typeof window.define&&"undefined"!==typeof window.require?define([],function(){return T}):"undefined"!==typeof module&&(module.exports=T);return T}();
