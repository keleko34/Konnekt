...
b.arguments[1])}).addActionListener("removelistener",function(b){if("string"===typeof b.arguments[0]&&void 0!==b.local.__kbpointers[b.arguments[0]])b.local.__kbpointers[b.arguments[0]][b.arguments[2]](b.arguments[0],b.arguments[1])});return m}function w(c,b,g,p,k,m,d,h){this.stopPropogation=function(){this._stopPropogration=!0};this.preventDefault=function(){this._preventDefault=!0};this.local=c;this.key=b;this.arguments=m;this.type=this.event=g;this.listener=d;this.name=c.__kbname;this.root=c.__kbref;
this.scope=c.__kbscopeString;this.parent=c.___kbImmediateParent;this.value=p;this.oldValue=k;this.stopChange=h}function e(c,b,g){return{value:c,writable:!!b,enumerable:!1,configurable:!!g}}function M(c,b,g){return{get:function(){return c.call(this)},set:function(g){b&&(c=g)},enumerable:!1,configurable:!!g}}function O(c,b){var g=b,p=b;return{get:function(){return g},set:function(b){var m=new w(this,c,"set",b,g,arguments,"__kblisteners",this._stopChange);!0!==f(m)&&(p=g,g=b,m.stopChange||(m.listener=
...
"mixed"===Object.prototype["typeof"](void 0!==c?"object"===typeof c?c:this[c]:this)}function G(c,b){if(this==Object.prototype&&void 0===c&&void 0===b)return console.error("No object and property specified in Object.prototype.isObservable to check");if(void 0===c)return console.error("No property specified in isObservable to check");var g=Object.getOwnPropertyDescriptor(void 0!==c&&"string"!==typeof c?c:this,void 0!==b?b:c);return g?void 0===g.value:!1}function z(c){return c.split(".")}function K(c,
b){return function(g,p){arguments=Array.prototype.slice.call(arguments);arguments.push(c);var k=this[b],m=new w(this,b,"addlistener",k,void 0,arguments,"");"string"===typeof g&&1!==z(g).length&&(k=z(g),k.pop(),k.join("."),m.local=this.getLayer(k),k=m.local[b],m.value=k,g=z(g).pop());!0!==f(m)&&(J.call(k)?(void 0===k[g]&&(k[g]=[]),k[g].push(p),m.type="postaddlistener",f(m)):Q.call(k)&&"function"===typeof g&&(k.push(g),m.type="postaddlistener",f(m)));return this}}function A(c,b){return function(g,p){arguments=
Array.prototype.slice.call(arguments);arguments.push(c);var k=this[b],m=new w(this,b,"removelistener",k,void 0,arguments,"");"string"===typeof g&&1!==z(g).length&&(k=z(g),k.pop(),k.join("."),m.local=this.getLayer(k),k=m.local[b],m.value=k,g=z(g).pop());if(!0!==f(m))if(J.call(k)){if(void 0!==k[g])for(var d=0,h=k[g].length;d<h;d++)if(k[g][d].toString()===p.toString()){k[g].splice(d,1);m.type="postremovelistener";f(m);break}}else if(Q.call(k)&&"function"===typeof g)for(d=0,h=k.length;d<h;d++)if(k[d].toString()===
p.toString()){k.splice(d,1);m.type="postremovelistener";f(m);break}return this}}function C(c,b){function g(b,c,m){var d=Object.keys(this,"all").filter(function(b){return r.call(this[b])}.bind(this)),h=this,t=b;"string"===typeof b&&1!==z(b).length&&(h=z(b),t=h.pop(),h.join("."),h=this.getLayer(h),void 0===h[m][b]&&(h[m][b]=[]),h[m][b].push(c));J.call(h[m])?(void 0===h[m][t]&&(h[m][t]=[]),h[m][t].push(c),void 0!==h.__kbpointers[t]&&(void 0===h.__kbpointers[t][t]&&(h.__kbpointers[t][t]=[]),h.__kbpointers[t][t].push(_func))):
h[m].push(c);t=0;for(h=d.length;t<h;t++)g.call(this[d[t]],b,c,m)}return function(p,k){arguments=Array.prototype.slice.call(arguments);arguments.push(c);var d=new w(this,b,"addchildlistener",void 0,void 0,arguments,"");!0!==f(d)&&(g.call(this,p,k,b),d.type="postaddchildlistener",f(d));return this}}function I(c,b){function g(b,c,d){var l=Object.keys(this,"all").filter(function(b){return r.call(this[b])}.bind(this)),h=this,t=b;if("string"===typeof b&&1!==z(b).length&&(h=z(b),t=h.pop(),h.join("."),h=
...
1);break}}}else for(f=0,e=h[d].length;f<e;f++)if(h[d][f].toString()===c.toString()){h[d].splice(f,1);break}f=0;for(e=l.length;f<e;f++)g.call(this[l[f]],b,c,d)}return function(p,d){arguments=Array.prototype.slice.call(arguments);arguments.push(c);var m=new w(this,b,"removechildlistener",void 0,void 0,arguments,"");!0!==f(m)&&(g.call(this,p,d,b),m.type="postremovechildlistener",f(m));return this}}var L={set:[],postset:[],create:[],postcreate:[],"delete":[],postdelete:[],splice:[],postsplice:[],push:[],
...
1);break}return this}),callSubscribers:e(function(c,b,g){if(void 0!==this.__kbsubscribers[c])for(var d=0,k=this.__kbsubscribers[c].length;d<k;d++)this.__kbsubscribers[c].call(this,c,b,g);return this}),stopChange:e(function(){this._stopChange=!0;return this}),_stopChange:e(void 0,!0)});Object.defineProperties(q.prototype,{addDataListener:e(K("addDataListener","__kblisteners")),removeDataListener:e(A("removeDataListener","__kblisteners")),addDataUpdateListener:e(K("addDataUpdateListener","__kbupdatelisteners")),
removeDataUpdateListener:e(A("removeDataUpdateListener","__kbupdatelisteners")),addDataCreateListener:e(K("addDataCreateListener","__kbcreatelisteners")),removeDataCreateListener:e(A("removeDataCreateListener","__kbcreatelisteners")),addDataDeleteListener:e(K("addDataDeleteListener","__kbdeletelisteners")),removeDataDeleteListener:e(A("removeDataDeleteListener","__kbdeletelisteners")),addChildDataListener:e(C("addChildDataListener","__kbparentlisteners")),removeChildDataListener:e(I("removeChildDataListener",
"__kbparentlisteners")),addChildDataUpdateListener:e(C("addChildDataUpdateListener","__kbparentupdatelisteners")),removeChildDataUpdateListener:e(I("removeChildDataUpdateListener","__kbparentupdatelisteners")),addChildDataCreateListener:e(C("addChildDataCreateListener","__kbparentcreatelisteners")),removeChildDataCreateListener:e(I("removeChildDataCreateListener","__kbparentcreatelisteners")),addChildDataDeleteListener:e(C("addChildDataDeleteListener","__kbparentdeletelisteners")),removeChildDataDeleteListener:e(I("removeChildDataDeleteListener",
"__kbparentdeletelisteners"))});return q}}(),V=function(){return function(){function H(n){if("object"===typeof n)for(var q=0,w=n.length;q<w;q++)K_Components[n[q]]?u(n[q],K_Components[n[q]],document.getElementById("script_"+n[q])):H.load(n[q],"component/"+n[q]+"/"+location.search,u);else"string"===typeof n&&(K_Components[n[q]]?u(n,K_Components[n],document.getElementById("script_"+n)):H.load(n,"component/"+n+"/"+location.search,u))}var u=function(){},B=/(<\/.*?>)/g;window.K_Components||(window.K_Components=
{});H.getUnknowns=function(n){var q=n.match(B);return q.map(function(n){return n.replace(/[<\/>]/g,"")}).filter(function(n,e){return document.createElement(n)instanceof HTMLUnknownElement&&-1===q.indexOf(n,e+1)&&!K_Components[n]})};H.load=function(n,q,w){document.head.appendChild(function(e,n,q){var w=document.createElement("script");w.type="text/javascript";w.charset="utf-8";w.async=!0;w.src=n;w.id="script_"+e;w.onload=function(){q(e,K_Components[e],this)};return w}(n,q,w));return H};H.onLoad=function(n){if(void 0===
n)return u;u="function"===typeof n?n:u;return H};return H}}(),W=function(H){return function(){function u(d){var v=d.tagName.toLowerCase(),f=z[v],c=document.createElement("div");c.className=v+"__Wrapper";c.innerHTML=f;return{node:d,wrapper:c,unkowns:w(c.innerHTML),maps:G(c),unloaded:e(c.innerHTML)}}function B(d,e){this.preventDefault=function(){this._preventDefault=!0};this.stopPropagation=function(){this._stopPropogation=!0};this.type=d;this.data=e}function n(d){for(var e=L[d.type],f=0,c=e.length;f<
c&&(e[f](d),d._stopPropogation);f++);return d._preventDefault}function q(d,e,f){return{value:d,writable:!!e,enumerable:!1,configurable:!!f}}function w(d){var e=d.match(K);return e.map(function(d){return d.replace(/[<\/>]/g,"")}).filter(function(d,c){return document.createElement(d)instanceof HTMLUnknownElement&&-1===e.indexOf(d,c+1)})}function e(d){return w(d).filter(function(d,f){return void 0===z[d]})}function M(d,e,f,c,b,g,p,k,m,l,h){this.text=d;this.texts=e;this.bindTexts=f;this.type=c;this.binds=
b;this.filters=g;this.target=p;this.prop=k;this.element=m;this.listener=h;this.parent=l}function O(d,e,f,c,b){this.key=d;this.text=e;this.value=f;this.filters=c}function N(d){return d.split(new RegExp("("+A.split("").join("\\")+")(.*?)("+C.split("").join("\\")+")","g")).map(function(d,f,c){return c[f-1]===A?A+d+C:d}).filter(function(d,f,c){return 0!==d.length&&d!==A&&d!==C&&0!==d.length})}function F(d){return d.split(new RegExp("("+A.split("").join("\\")+")(.*?)("+C.split("").join("\\")+")","g")).filter(function(d,
f,c){return d!==A&&d!==C})}function x(d){return d.split(new RegExp("("+A.split("").join("\\")+")(.*?)("+C.split("").join("\\")+")","g")).filter(function(d,f,c){return c[f-1]===A})}function P(d){return d.replace(new RegExp("\\"+I.split("").join("\\")+"(.*)"),"").replace(/\s/g,"")}function D(d){return-1!==d.indexOf(I)?d.replace(new RegExp("(.*?)(\\"+I.split("").join("\\")+")"),"").replace(/\s/g,"").split(","):[]}function S(d){if(-1!==d.indexOf("for")){var e=d.replace(/\s/g,"").split(/for(.*?)loop/).filter(function(d){return 0!==
d.length});return{key:e[0],component:P(e[1]),filters:D(d)}}return null}function R(d){function e(f){for(var c=[],b=0,g=f.length;b<g;b++)void 0===f[b].kb_maps&&(f[b].kb_mapper=d,c=3===f[b].nodeType?c.concat(r(f[b])):c.concat(Q(f[b])),f[b].childNodes&&0!==f[b].childNodes.length&&(c=c.concat(e(f[b].childNodes))));return c}return e(d.childNodes)}function J(d){for(var e=0,f=d.length;e<f;e++)null===d[e].element.parentElement&&(f=new B("unsync",d[e]),n(f),d.splice(e,1),f=d.length);return d}function Q(d){for(var e=
d.attributes,f=d instanceof HTMLUnknownElement,c=[],b=0,g=e.length;b<g;b++)if(e[b].value.match(new RegExp("(\\"+A.split("").join("\\")+")(.*?)(\\"+C.split("").join("\\")+")","g"))){var p=x(e[b].value),k=N(e[b].value),m=F(e[b].value),l=new B("mapper",{}),h=new M(e[b].value,k,[],f?"component":"attribute",{},{},f?void 0:e[b],e[b].name,f?d.parentElement:d,f?void 0:d.parentElement,f?void 0:e[b].name);h.binds=p.reduce(function(b,c,g,d){l.type="map";l.data=new O(P(c),c,"",D(c),h);m[m.indexOf(c)]=l.data;
!0!==n(l)&&(b[l.data.key]=l.data);return b},{});h.bindTexts=m;l.type="mapper";l.data=h;!0!==n(l)&&c.push(l.data)}f&&(d.kb_maps=c);return c}function r(d){if(d.textContent.match(new RegExp("(\\"+A.split("").join("\\")+")(.*?)(\\"+C.split("").join("\\")+")","g"))){var e=x(d.textContent),f=N(d.textContent),c=F(d.textContent),b=new B("mapper",{});if(1===e.length&&-1!==e[0].indexOf("for"))b.data=new M(d.textContent,f,[],"for",S(e[0]),{},d,void 0,d,d.parentElement);else{var g=new M(d.textContent,f,[],"text",
...
function(c){void 0===d.kb_maps[b].element.parentElement?(c=new B("unsync",binds[f]),n(c),d.kb_maps.splice(b,1)):1!==d.kb_maps[b].element.childNodes.length&&(c.map=d.kb_maps[b],c=new B("update",c),n(c))});d.kb_maps[b].element.addAttrUpdateListener(d.kb_maps[b].listener,function(c){c.map=d.kb_maps[b];c=new B("update",c);n(c)});break;case "attribute":0===d.kb_maps[b].listener.indexOf("on")&&(d.kb_maps[b].element.setAttribute(d.kb_maps[b].listener.replace("on",""),d.kb_maps[b].element.getAttribute(d.kb_maps[b].listener)),
d.kb_maps[b].element.removeAttribute(d.kb_maps[b].listener),d.kb_maps[b].listener=d.kb_maps[b].listener.replace("on","")),d.kb_maps[b].element.addAttrUpdateListener(d.kb_maps[b].listener,function(c){c.map=d.kb_maps[b];c=new B("update",c);n(c)})}})(f);return d.kb_maps}var z={},K=/(<\/.*?>)/g;H().call();var A="{{",C="}}",I="|",L={mapper:[],unsync:[],map:[],update:[]};Object.defineProperties(u,{getUnkownTemplates:q(w),getUnregisteredTenplates:q(e),isRegistered:q(function(d){return void 0!==z[d]}),register:q(function(d,
e){void 0===z[d]?z[d]=e:console.error("A template with the name",d," already exists");return w(e)}),getTemplate:q(function(d){return z[d]})});Object.defineProperties(u,{startChars:q(function(d){if(void 0===d)return A;A="string"===typeof d&&d!==C?d:A;return this}),endChars:q(function(d){if(void 0===d)return C;C="string"===typeof d&&d!==A?d:C;return this}),pipeChars:q(function(d){if(void 0===d)return I;I="string"===typeof d&&d!==A&&d!==C?d:I;return this}),checkUnsynced:q(J),mapTemplate:q(G),mapNode:q(R)});
return u}}(function(){function H(){function u(b,c){var d=b.length,k;for(k=0;k<d&&(b[k](c),void 0===c._stopPropogation);k++);}function B(b,c){var d=b.length,k;for(k=0;k<d&&(c.child=c.target,c.target=b[k].parent,b[k].func(c),void 0===c._stopPropogation);k++);}function n(b,c){for(var d=b.length;0<d;v++)if(b[v].toString()===c.toString())return!0;return!1}function q(b,c,d,k,e,f,h,t){this.stopPropagation=function(){this._stopPropogation=!0};this.preventDefault=function(){this._preventDefault=!0};this.value=
d;this.oldValue=k;this.target=b;this.attr=c;this.arguments=e;this.action=f;this.child=void 0;this.type=h;this.stopChange=t}function w(){this._attrListeners={};this._attrUpdateListeners={};this._styleListeners={};this._styleUpdateListeners={};this._parentStyleListeners={};this._parentStyleUpdateListeners={};this._parentAttrListeners={};this._parentAttrUpdateListeners={};this._injectedStyle={}}function e(b,c,d,k){var e=b.get,f=b.set,h;return function(b){h=e.call(this);d(this,c,b,h,void 0,this._stopChange)&&
...
"-$1").replace("webkit","-webkit"),t,r;return{get:function(){return r},set:function(b){t=r;d(e,c,b,t,void 0,this._stopChange)&&(r=b,l.setProperty(h,b));this._stopChange||f(e,c,b,t);this._stopChange=void 0},enumerable:!0,configurable:!0}}function F(b,c,d,e){if("function"!==typeof c)return r;var f=-1!==["value","checked"].indexOf(b),l=-1!==L.indexOf(b),h;if(this.toString()!==r.toString())if(d){var t=this.querySelectorAll("*");d=t.length;for(var n,y=0;y<d;y++){n=t[y].attrListeners();if(f||"*"===b)void 0!==
t[y].addInputBinding&&t[y].addInputBinding(),void 0!==t[y].addInputBoxBinding&&t[y].addInputBoxBinding();if(l)r.injectStyleProperty(t[y],b),h=e?"_parentStyleUpdateListeners":"_parentStyleListeners";else{if("*"===b){h=e?"_parentStyleUpdateListeners":"_parentStyleListeners";d=L.length;for(var E=0;E<d;E++)r.injectStyleProperty(t[y],L[E]);void 0===n[h]["*"]&&(n[h]["*"]=[]);n[h]["*"].push({parent:this,func:c})}h=e?"_parentAttrUpdateListeners":"_parentAttrListeners"}void 0===n[h][b]&&(n[h][b]=[]);n[h][b].push({parent:this,
func:c})}}else{n=this.attrListeners();if(l)h=e?"_styleUpdateListeners":"_styleListeners",r.injectStyleProperty(this,b);else{if(f||"*"===b)void 0!==this.addInputBinding&&this.addInputBinding(),void 0!==this.addInputBoxBinding&&this.addInputBoxBinding();if("*"===b){h=e?"_styleUpdateListeners":"_styleListeners";d=L.length;for(y=0;y<d;y++)r.injectStyleProperty(this,L[y]);void 0===n[h][b]&&(n[h][b]=[]);n[h][b].push(c)}h=e?"_attrUpdateListeners":"_attrListeners"}void 0===n[h][b]&&(n[h][b]=[]);n[h][b].push(c)}else{if(f||
"*"===b)for(E=document.querySelectorAll("input, textarea"),d=E.length,y=0;y<d;y++)void 0!==E[y].addInputBinding&&E[y].addInputBinding(),void 0!==E[y].addInputBoxBinding&&E[y].addInputBoxBinding();if(l){l=Array.prototype.slice.call(document.body.querySelectorAll("*"));d=l.length+1;l.unshift(document.body);for(y=0;y<d;y++)r.injectStyleProperty(l[y],b);h=e?A:K}else{if("*"===b){l=Array.prototype.slice.call(document.body.querySelectorAll("*"));d=l.length+1;f=L.length;l.unshift(document.body);for(y=0;y<
d;y++)for(E=0;E<f;E++)r.injectStyleProperty(l[y],L[E]);h=e?A:K;void 0===h[b]&&(h[b]=[]);h[b].push(c)}h=e?z:G}void 0===h[b]&&(h[b]=[]);h[b].push(c)}}function x(b,c,d,e){function f(b,d){var e=d[b],p=e.length;for(h=0;h<p;h++)e[h].toString()===c.toString()&&e.splice(h,1)}if("function"!==typeof c)return r;["value","checked"].indexOf(b);var l=-1!==L.indexOf(b),h;if(this.toString()!==r.toString())if(d){d=this.querySelectorAll("*");var t=d.length;l?(l=e?"_childStyleUpdateListeners":"_childStyleListeners",
f(b,this.attrListeners()[l]),l=e?"_parentStyleUpdateListeners":"_parentStyleListeners"):("*"===b&&(l=e?"_childStyleUpdateListeners":"_childStyleListeners",f(b,this.attrListeners()[l])),l=e?"_childAttrUpdateListeners":"_childAttrListeners",f(b,this.attrListeners()[l]),l=e?"_parentAttrUpdateListeners":"_parentAttrListeners");for(h=0;h<t;h++){for(var n=d[h].attrListeners()[l][b],y=n.length,E=0;E<y;E++)n[E].isEqualNode(this)&&n.slice(E,1);if("*"===b)for(listenersStyle=e?"_parentStyleUpdateListeners":
"_parentStyleListeners",n=d[h].attrListeners()[l][b],y=n.length,E=0;E<y;E++)n[E].isEqualNode(this)&&n.slice(E,1)}}else l?l=e?"_styleUpdateListeners":"_styleListeners":("*"===b&&(l=e?"_styleUpdateListeners":"_styleListeners",f(b,this.attrListeners()[l])),l=e?"_attrUpdateListeners":"_attrListeners"),f(b,this.attrListeners()[l]);else l?l=e?A:K:("*"===b&&(l=e?A:K,f(b,l)),l=e?z:G),f(b,l)}function P(b,c){r.addAttrListener.call(this,b,c,!0);return this}function D(b,c){r.addAttrUpdateListener.call(this,b,
...
b.indexOf(c[d])&&b.push(c[d]);return b}function d(b,c){for(var g=Object.keys(b),e,f,p=0,h=g.length;p<h;p++)if(e=g[p],void 0===c[e])c[e]=b[e].slice();else for(var k=0,m=b[e].length;k<m;k++)f=b[e][k],c[e].push(f)}function e(c){if(3!==c.target.nodeType&&8!==c.target.nodeType){var f=c.target.attrListeners(),p,h=["value","checked"],k=f._attrListeners,m=f._attrUpdateListeners,l=f._parentAttrListeners;p=f._parentAttrUpdateListeners;var n=!1;if(void 0!==G["*"]||void 0!==z["*"])n=!0;if(!0!==n&&void 0!==k["*"]||
void 0!==m["*"]||void 0!==l["*"]||void 0!==p["*"])n=!0;if(!0!==n)for(var q=0;q<h.length;q++)if(void 0!==G[h[q]]||void 0!==z[h[q]]||void 0!==k[h[q]]||void 0!==m[h[q]]||void 0!==l[h[q]]||void 0!==p[h[q]]){n=!0;break}p=n;h=Object.keys(K);k=Object.keys(A);Object.keys(f._styleListeners);Object.keys(f._styleUpdateListeners);m=Object.keys(f._parentStyleListeners);f=Object.keys(f._parentStyleUpdateListeners);l=[];if(0!==h.length||0!==k.length)l=b(l,h),l=b(l,k);if(0!==l.length&&0!==m.length||0!==f.length)l=
b(l,m),l=b(l,f);-1!==l.indexOf("*")&&(l=L);var f=l,h=f.length,v,x,k=[],w,m="outerHTML"===c.attr||"outerText"===c.attr?c.attr:void 0,l=c.target;void 0!==m&&(c.attr="appendChild",c.arguments=[c.target],c.target=c.target.parentElement);if(p){"appendChild"===c.attr&&3!==c.arguments[0].nodeType&&8!==c.arguments[0].nodeType?(k=Array.prototype.slice.call(c.arguments[0].querySelectorAll("input,textarea")),"INPUT"!==c.arguments[0].tagName&&"TEXTAREA"!==c.arguments[0].tagName||k.unshift(c.arguments[0])):k=
Array.prototype.slice.call(c.target.querySelectorAll("input,textarea"));w=k.length;for(var u=0;u<w;u++)void 0!==k[u].addInputBinding&&k[u].addInputBinding(),void 0!==k[u].addInputBoxBinding&&k[u].addInputBoxBinding()}"appendChild"===c.attr&&"#text"!==c.arguments[0].nodeName&&"#comment"!==c.arguments[0].nodeName?(k=Array.prototype.slice.call(c.arguments[0].querySelectorAll("*")),k.unshift(c.arguments[0])):k=Array.prototype.slice.call(c.target.querySelectorAll("*"));p=c.target.__kb._parentAttrListeners;
n=c.target.__kb._parentAttrUpdateListeners;q=c.target.__kb._parentStyleListeners;v=c.target.__kb._parentStyleUpdateListeners;w=k.length;for(u=0;u<w;u++){if(0!==h)for(x=0;x<h;x++)r.injectStyleProperty(k[u],f[x]);x=k[u].attrListeners();d(p,x._parentAttrListeners);d(n,x._parentAttrUpdateListeners);d(q,x._parentStyleListeners);d(v,x._parentStyleUpdateListeners)}void 0!==m&&(c.attr=m,c.target=l,c.arguments=[])}}function k(b){var c=b.target.attributes[b.arguments[0]],d="setAttribute"===b.attr?b.arguments[1]:
...
var l=f,h=c;r.addAttrUpdateListener("appendChild",e);r.addAttrUpdateListener("removeChild",e);r.addAttrUpdateListener("innerHTML",e);r.addAttrUpdateListener("outerHTML",e);r.addAttrUpdateListener("innerText",e);r.addAttrUpdateListener("outerText",e);r.addAttrUpdateListener("textContent",e);r.addAttrListener("setAttribute",k);r.addAttrListener("removeAttribute",k);r.addAttrUpdateListener("setAttribute",m);r.addAttrUpdateListener("removeAttribute",m);return r}var G={},z={},K={},A={},C={},I="textContent innerHTML innerText outerHTML outerText appendChild removeChild replaceChild insertAdjacentHTML insertBefore".split(" "),
L=Object.getOwnPropertyNames(document.body.style),d=Object.keys(HTMLElement.prototype).filter(function(b){return 0===b.indexOf("on")}).concat(["addEventListener","removeEventListener"]),v,f=function(b,c,d,e,f,l){d=new q(b,c,d,e,f,void 0,"set",l);void 0!==b.__kb&&(e=b.__kb._attrListeners,f=b.__kb._styleListeners,l=b.__kb._parentAttrListeners,b=b.__kb._parentStyleListeners,void 0!==e[c]&&u(e[c],d),void 0===d._stopPropogation&&void 0!==f[c]&&u(f[c],d),void 0===d._stopPropogation&&void 0!==e["*"]&&(u(e["*"],
d),void 0===d._stopPropogation&&u(f["*"],d)),void 0===d._stopPropogation&&void 0!==l[c]&&B(l[c],d),void 0===d._stopPropogation&&void 0!==b[c]&&B(b[c],d),void 0===d._stopPropogation&&void 0!==l["*"]&&(B(l["*"],d),void 0===d._stopPropogation&&B(b["*"],d)));void 0===d._stopPropogation&&void 0!==G[c]&&u(G[c],d);void 0===d._stopPropogation&&void 0!==K[c]&&u(K[c],d);void 0===d._stopPropogation&&void 0!==G["*"]&&(u(G["*"],d),void 0===d._stopPropogation&&u(K["*"],d));return void 0!==d._preventDefault?!1:
!0},c=function(b,c,d,e,f,l){d=new q(b,c,d,e,f,l,"update");void 0!==b.__kb&&(e=b.__kb._attrUpdateListeners,f=b.__kb._styleUpdateListeners,l=b.__kb._parentAttrUpdateListeners,b=b.__kb._parentStyleUpdateListeners,void 0!==e[c]&&u(e[c],d),void 0===d._stopPropogation&&void 0!==f[c]&&u(f[c],d),void 0===d._stopPropogation&&void 0!==e["*"]&&(u(e["*"],d),void 0===d._stopPropogation&&u(f["*"],d)),void 0===d._stopPropogation&&void 0!==l[c]&&B(l[c],d),void 0===d._stopPropogation&&void 0!==b[c]&&B(b[c],d),void 0===
d._stopPropogation&&void 0!==l["*"]&&(B(l["*"],d),void 0===d._stopPropogation&&B(b["*"],d)));void 0===d._stopPropogation&&void 0!==z[c]&&u(z[c],d);void 0===d._stopPropogation&&void 0!==A[c]&&u(A[c],d);void 0===d._stopPropogation&&void 0!==z["*"]&&(u(z["*"],d),void 0===d._stopPropogation&&u(A["*"],d));return void 0!==d._preventDefault?!1:!0};r.injectPrototypeProperty=function(b,d,p,k,m){var l=b.prototype,h=Object.getOwnPropertyDescriptor(l,d);p=p||b.toString().split(/\s+/)[1].split("{")[0].replace("()",
"");var n=C[p];k=k||f;m=m||c;void 0===l.attrListeners&&(l={},l.attrListeners=function(){void 0===this.__kb&&(this.__kb=new w);return this.__kb}.bind(l),l.addAttrListener=r.addAttrListener,l.addAttrUpdateListener=r.addAttrUpdateListener,l.addChildAttrListener=P,l.addChildAttrUpdateListener=D,l.hasListener=J,l.removeAttrListener=r.removeAttrListener,l.removeAttrUpdateListener=r.removeAttrUpdateListener,l.removeChildAttrListener=S,l.removeChildAttrUpdateListener=R,l.stopChange=Q);void 0===n&&(C[p]={obj:b,
proto:l,descriptors:{},set:void 0,update:void 0},n=C[p],n.set=k,n.update=m);void 0===n.descriptors[d]&&(n.descriptors[d]=h);h.configurable&&(void 0!==h.set?Object.defineProperty(l,d,{get:h.get,set:e(h,d,k,m),enumerable:!0,configurable:!0}):"function"===typeof h.value?Object.defineProperty(l,d,{value:O(h,d,k,m),writable:!0,enumerable:!0,configurable:!0}):void 0!==h.value&&Object.defineProperty(l,d,{get:function(){return h.value},set:H(h,d,k,m),enumerable:!0,configurable:!0}));return r};r.injectStyleProperty=
...
d=d||b.toString().split(/\s+/)[1].split("{")[0].replace("()","");var l=C[d],h=Object.getOwnPropertyNames(m);e=e||f;k=k||c;var n;void 0===m.attrListeners&&(m.attrListeners=function(){void 0===this.__kb&&(this.__kb=new w);return this.__kb},m.addAttrListener=r.addAttrListener,m.addAttrUpdateListener=r.addAttrUpdateListener,m.addChildAttrListener=P,m.addChildAttrUpdateListener=D,m.hasListener=J,m.stopChange=Q);void 0===l&&(C[d]={obj:b,proto:m,descriptors:{},set:void 0,update:void 0},l=C[d],l.set=e,l.update=
...
function(b,c,e){if("html"===b){b=0;for(var f=I.length;b<f;b++)x.call(this,I[b],c,e,!1)}else if("events"===b)for(b=0,f=d.length;b<f;b++)x.call(this,d[b],c,e,!1);else x.call(this,b,c,e,!1);return this};r.removeAttrUpdateListener=function(b,c,e){if("html"===b){b=0;for(var f=I.length;b<f;b++)x.call(this,I[b],c,e,!0)}else if("events"===b)for(b=0,f=d.length;b<f;b++)x.call(this,d[b],c,e,!0);else x.call(this,b,c,e,!0);return this};r.hasListener=function(b,c,d){"html"===c&&(c="innerHTML");"events"===c&&(c=
"onclick");switch(b){case "attr":if(n(G[c],d))return!0;break;case "attrupdate":if(n(z[c],d))return!0}return!1};r.injectedPrototypes=function(){return C};return r}"function"===typeof define&&define.amd&&define("KB",H);return H}()),T=function(H,u,B){return function(){function n(x,u,D,B){function H(n,r,q,x,u){var d=e({},n);d.ignoreCreate("__proto__");d.__proto__=r.prototype;for(var v=0,f=Object.keys(x),c=f.length;v<c;v++)d.isObservable(x,f[v])?d.addPointer(x,f[v]):d.add(f[v],x[f[v]]);r.apply(d,q);v=
...
Object.keys(r),c=f.length;v<c;v++)d.set(f[v],r[f[v]]);else localStorage.setItem(d.id||n,d.stringify());d.addChildDataUpdateListener("*",function(){localStorage.setItem(d.id||n,d.stringify())})}d.store&&O.set(d.id||n,d);return d}function J(e,n){r=M(n);n.replaceWith(r.wrapper);var q=H(e,N[e],u,D,B);console.log(r.maps,q)}var F=x.tagName.toLowerCase(),r;void 0===u&&(u=[]);void 0===D&&(D={});D.filters||Object.defineProperty(D,"filters",q({}));D.sessionStorage||Object.defineProperty(D,"sessionStorage",
q(!1,!0));D.localStorage||Object.defineProperty(D,"localStorage",q(!1,!0));D.store||Object.defineProperty(D,"store",q(!1,!0));D.multiple||Object.defineProperty(D,"multiple",q(!1,!0));void 0===B&&(B={});B.innerhtml=x.innerHTML;for(var G=0,z=x.attributes.length;G<z;G++)-1===["id","class"].indexOf(x.attributes[G].name)&&(B[x.attributes[G].name]=x.attributes[G].value);M.isRegistered(F)?J(F,x):(n.loadWaitList(F,function(e,n){J(F,x)}),w(F))}function q(e,n,q){return{value:e,writable:!!n,enumerable:!1,configurable:!!q}}
window.K_Components||(window.K_Components={});var w=u().onLoad(function(e,q){n.register(e,q,"<style>"+q.prototype.k_css+"</style>"+q.prototype.k_html,q.prototype.cms);n.loadWaitList(e)(e,q);n.loadWaitList(e,function(){})}),e=H(),M=B(),O=e({},"Model"),N={};(function(){return window.location.search.replace("?","").split("&").filter(function(e){return 0!==e.length}).reduce(function(e,n){e[n.split("=")[0]]=n.split("=")[1];return e},{})})();var F={};n.register=function(e,q,u,w){M.register(e,u);N[e]=q;
return n};n.loadWaitList=function(e,q){if("undefined"===typeof q&&e)return F[e];e&&(F[e]="function"===typeof q?q:F[e]);return n};return n}}(U,V,W);"undefined"!==typeof window&&"undefined"!==typeof window.define&&"undefined"!==typeof window.require?define([],function(){return T}):"undefined"!==typeof module&&(module.exports=T);return T}();
