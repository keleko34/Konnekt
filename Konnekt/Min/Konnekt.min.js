...
action:"addChildListener"},{listener:"__kbparentupdatelisteners",action:"addChildUpdateListener"},{listener:"__kbparentcreatelisteners",action:"addChildCreateListener"},{listener:"__kbparentdeletelisteners",action:"addChildDeleteListener"}],m=[],k,B=0,f=g.length;B<f;B++)if(k=c[g[B].listener],F.call(k))for(var m=Object.keys(k),d=0,h=m.length;d<h;d++)for(var l=0,e=k[m[d]].length;l<e;l++)b[g[B].method](m[d],k[m[d]][l]);else for(d=0,h=k.length;d<h;d++)b[g[B].method](k[d])}function L(c,b,g){if(J(c,b)||
"length"===b||"__kbsetindex"===b){if("length"===b)if(g>c.length&&void 0!==c[g-1])c.length=g;else{if(g<c.length){b=g;for(var m=c.length;b<m;b++)c[b]&&delete c[b];c.length=g}}else c[b]=g;return!0}c.set(b,g)}function O(c,b){c.del(b);return!0}function P(c,b,g){var m=n(g),k=F(g),B=I(g);if(m&&g.__kbname!==c.__kbname)"default"===g.__kbname?c.merge(g,b):c.__kbpointers[b]||c.addPointer(g,b);else{var m=new p(this,b,"create",g,void 0,[],"__kbcreatelisteners",this._stopChange),d=f(m),h=parseInt(b,10);if(!0!==
d)if((k||B)&&0!==Object.keys(g,"all").length)for(P.call(this,c,b,{}),k=0,B=Object.keys(g,"all"),m=B.length;k<m;k++)P.call(this[b],c[b],B[k],g[B[k]]);else{if(k||B)g=new C(g,c.__kbname,c,c.__kbscopeString+(0!==c.__kbscopeString.length?".":"")+b),G(c,g);Object.defineProperty(c,b,R(b,g));!isNaN(h)&&c.length<=h&&(c.length=h+1);m.listener="__kbupdatelisteners";m.type="postcreate";f(m)}}}function M(c,b,g,m){var k=n(g),B=F(g),f=I(g);if(k&&g.__kbname!==c.__kbname)"default"===g.__kbname?c.merge(g,b):c.__kbpointers[b]||
c.addPointer(g,b);else if(void 0===c[b])-1===N.indexOf(b)?P.call(this,c,b,g):(m?c.stopChange():c)[b]=g;else if(B||f)for(k=0,B=Object.keys(g,"all"),f=B.length;k<f;k++)M.call(this[b],c[b],B[k],g[B[k]],m);else(m?c.stopChange():c)[b]=g}function H(c){return l.call(c).replace(/(\[object\s|\])/g,"").toLowerCase()}function F(c){return"object"===H(void 0!==c?c:this)}function I(c){return"array"===H(void 0!==c?c:this)}function n(c){return"mixed"===H(void 0!==c?c:this)}function J(c,b){b="string"===typeof c?c:
...
UKeys=[];isValue=isKey=!1;r="";for(var k=1,B=split.length,f,d,h,l;k<B;k++)f=split[k],d=split[k-1],h=split[k+1],l=UKeys[UKeys.length-1],'":'===d&&'{"'===f||'":'===d&&"["===f?(r+=(0!==r.length?".":"")+l,m[l]||m.set(l,b?b(l,{},r,m):{}),m=m[l],UKeys.pop()):"["===d||","===d&&0!==m.length?"{"===f||'{"'===f?(r+=(0!==r.length?".":"")+m.__kbsetindex,"object"!==typeof m[m.__kbsetindex]&&m.set(m.__kbsetindex,b?b(m.length,{},r,m):{}),m.__kbsetindex+=1,m=m[m.__kbsetindex-1]):(m.set(m.__kbsetindex,b?b(m.length,
g(f),r,m):g(f)),m.__kbsetindex+=1):'":'===d?(m.set(l,b?b(l,g(f),r,m):g(f)),UKeys.pop()):'{"'===d||","===d&&'":'===h?UKeys[UKeys.length]=f.replace(/\"/g,""):"}"!==d&&"]"!==d||void 0===f||(r=-1!==r.indexOf(".")?r.substring(0,r.lastIndexOf(".")-1):"",m=m.__kbImmediateParent);return this}function E(c,b){"number"===typeof c&&(c=c.toString());var g=-1!==c.indexOf(".")?this.__kbnonproxy.setLayer(c):this.__kbnonproxy;-1!==c.indexOf(".")&&(c=c.split(".").pop());var m=new p(this,c,"set",b,this[c],arguments,
"__kbmethodlisteners");!0!==f(m)&&(M.call(this,g,c,b,this._stopChange),this.stopChange=void 0,m.type="postset",m.listener="__kbmethodupdatelisteners",f(m));return this}function y(c){return c.split(".")}function q(c,b){return function(g,m){arguments=Array.prototype.slice.call(arguments);arguments.push(c);var k=this[b],d=new p(this,b,"addlistener",k,void 0,arguments,"");"string"===typeof g&&1!==y(g).length&&(k=y(g),g=k.pop(),k=k.join("."),d.local=this.getLayer(k),k=d.local[b],d.value=k);!0!==f(d)&&
(F.call(k)?(void 0===k[g]&&(k[g]=[]),k[g].push(m),d.type="postaddlistener",f(d)):I.call(k)&&"function"===typeof g&&(k.push(g),d.type="postaddlistener",f(d)));return this}}function t(c,b){return function(g,m){arguments=Array.prototype.slice.call(arguments);arguments.push(c);var k=this[b],d=new p(this,b,"removelistener",k,void 0,arguments,"");"string"===typeof g&&1!==y(g).length&&(k=y(g),k.pop(),k.join("."),d.local=this.getLayer(k),k=d.local[b],d.value=k,g=y(g).pop());if(!0!==f(d))if(F.call(k)){if(void 0!==
k[g])for(var h=0,l=k[g].length;h<l;h++)if(k[g][h].toString()===m.toString()){k[g].splice(h,1);d.type="postremovelistener";f(d);break}}else if(I.call(k)&&"function"===typeof g)for(h=0,l=k.length;h<l;h++)if(k[h].toString()===g.toString()){k.splice(h,1);d.type="postremovelistener";f(d);break}return this}}function z(c,b){function g(b,c,d){var f=Object.keys(this,"all").filter(function(b){return n.call(this[b])}.bind(this)),h=this,l=b;"string"===typeof b&&1!==y(b).length&&(h=y(b),l=h.pop(),h=h.join("."),
h=this.getLayer(h),void 0===h[d][l]&&(h[d][l]=[]),h[d][l].push(c));F.call(h[d])?(void 0===h[d][l]&&(h[d][l]=[]),h[d][l].push(c),h=h.__kbpointers[l],h=h.point.getLayer(h.keys),void 0!==h[l]&&(void 0===h[d][l]&&(h[d][l]=[]),h[d][l].push(_func))):h[d].push(c);l=0;for(h=f.length;l<h;l++)g.call(this[f[l]],b,c,d)}return function(m,k){arguments=Array.prototype.slice.call(arguments);arguments.push(c);var d=new p(this,b,"addchildlistener",void 0,void 0,arguments,"");!0!==f(d)&&(g.call(this.__kbnonproxy,m,
k,b),d.type="postaddchildlistener",f(d));return this}}function v(c,b){function g(b,c,d){var f=Object.keys(this,"all").filter(function(b){return n.call(this[b])}.bind(this)),h=this,l=b;if("string"===typeof b&&1!==y(b).length){var e=y(b),l=e.pop();e.join(".");h=this.getLayer(e);if(void 0!==h[d][b])for(var e=0,q=h[d][b].length;e<q;e++)if(h[d][b][e].toString()===c.toString()){h[d][b].splice(e,1);break}}if(F.call(h[d])){if(void 0!==h[d][l]){e=0;for(q=h[d][l].length;e<q;e++)if(h[d][l][e].toString()===c.toString()){h[d][l].splice(e,
1);break}if(-1!==h.__kbpointers.indexOf(l)&&(e=h.__kbpointers[l],h=e.point.getLayer(e.keys),void 0!==h[d][l]))for(e=0,q=h[d][l].length;e<q;e++)if(h[d][l][e].toString()===c.toString()){h[d][l].splice(e,1);break}}}else for(e=0,q=h[d].length;e<q;e++)if(h[d][e].toString()===c.toString()){h[d].splice(e,1);break}e=0;for(q=f.length;e<q;e++)g.call(this[f[e]],b,c,d)}return function(m,k){arguments=Array.prototype.slice.call(arguments);arguments.push(c);var d=new p(this,b,"removechildlistener",void 0,void 0,
...
del:e(function(c,b){var g="number"===typeof c||!isNaN(parseInt(c,10));g&&(c=c.toString());var m=-1!==c.indexOf(".")?this.getLayer(c):this,k=c.split(".").pop();if(m&&void 0!==m[k])if(g&&m.length>parseInt(c,10)&&!b)m=m.__kbnonproxy,m.splice(k,1);else{var d=new p(m,c,"delete",m[k],void 0,[],"__kbmethodlisteners"),h=f(d),l=new p(m,c,"delete",m[k],void 0,[],"__kbdeletelisteners",this._stopChange);!0!==f(l)&&!0!==h&&(m=m.__kbnonproxy,Object.defineProperty(m,k,e(void 0,!0,!0,!1)),delete m[k],g&&m.length>
parseInt(c,10)&&b&&--m.length,d.type="postdelete",d.listener="__kbmethodupdatelisteners",f(d),l.listener="__kbupdatelisteners",l.type="postdelete",l.oldValue=l.value,l.value=void 0,f(l))}return this}),exists:e(function(c){function b(g,c){return 1!==g.length?void 0!==c[g[0]]?b(g.slice(1,g.length),c[g[0]]):!1:void 0!==c[g[0]]}return b(c.split("."),this.__kbnonproxy)}),addPrototype:e(function(c,b){var g=-1!==c.indexOf(".")?this.__kbnonproxy.setLayer(c):this.__kbnonproxy;-1!==c.indexOf(".")&&(c=c.split(".").pop());
...
g,Q.apply(k,[b].concat(c)));k.__kbpointers[g]={keys:c.join("."),point:b};var c=k,b=[{listener:"__kblisteners",method:"addDataListener"},{listener:"__kbupdatelisteners",method:"addDataUpdateListener"}],k=[],d;if(c[g]&&c[g].__kbImmediateParent)for(var h=0,l=b.length;h<l;h++){d=c[b[h].listener];for(var k=Object.keys(d),e=0,q=k.length;e<q;e++)if(g===k[h])for(var t=0,z=d[k[h]].length;t<z;t++)void 0===c[g].__kbImmediateParent[b[h].listener][g]&&(c[g].__kbImmediateParent[b[h].listener][g]=[]),c[g].__kbImmediateParent[b[h].listener][g].push(d[k[h]][t])}G(c,
c[g]);m.listener="__kbupdatelisteners";m.type="postcreate";f(m)}return this}),move:e(function(c,b){this.__kbnonproxy.set(b,c[b]);n(c)?c.del(b):(c[b]=null,delete c[b]);return this}),copy:e(function(c,b){var g=this.__kbnonproxy;n(c)?"default"===c.__kbname?g.merge(c[b],b):g.addPointer(c,b):g.set(b,c[b]);return this}),merge:e(function(c,b){function g(b,c){for(var d=n(b)?b.keys("object"):Object.keys(b),k,f=0,h=d.length;f<h;f++)k=b[d[f]],"object"===typeof k&&-1===m.indexOf(k)&&"undefined"!==c[d[f]]?g(k,
c):void 0===c[d[f]]&&c.set(d[f],"object"===typeof k?{}:k)}var m=[],d=this.__kbnonproxy;b&&void 0===d[b]&&d.set(b,{});g(c,b?d[b]:d);return this}),replace:e(function(c,b){function g(b,c){var d=n(b)?b.keys("object"):Object.keys(b),k;k=b[d[x]];"object"===typeof k&&-1===m.indexOf(k)&&"undefined"!==c[d[x]]?g(k,c):c.set(d[x],"object"===typeof k?{}:k)}var m=[],d=this.__kbnonproxy;b&&void 0===d[b]&&d.set(b,{});g(c,b?d[b]:d);return this}),copyWithin:e(function(c,b,g){b=b||0;g=g||0;var m=new p(this,c,"copyWithin",
this[c],void 0,arguments,"__kbmethodlisteners"),d=this.__kbnonproxy;if(!0!==f(m)&&c<d.length){c=0>c?d.length-1:c;b=b<d.length?b:d.length-1;g=g<d.length?g:d.length-1;b=0>b?d.length-1:b;g=0>b?d.length-1:g;for(var h=b;h<=g;h++)d.set(c+(h-b),d[h]);m.type="postcopyWithin";m.listener="__kbmethodupdatelisteners";f(m)}return this}),fill:e(function(c,b,g){b=void 0!==b?Math.max(0,b):0;g=void 0!==g&&g<=this.length?Math.min(this.length,Math.max(0,g)):this.length;var m=new p(this,_start,"fill",this[_start],void 0,
arguments,"__kbmethodlisteners"),d=this.__kbnonproxy;if(!0!==f(m)){for(var h=a.key;h<g;h++)d[h]=c;m.type="postfill";m.listener="__kbmethodupdatelisteners";f(m)}return this}),pop:e(function(){var c=new p(this,this.length-1,"pop",this[this.length-1],void 0,arguments,"__kbmethodlisteners"),b=this.__kbnonproxy;if(!0!==f(c)){var g=b[b.length-1];b.del(this.length-1);c.type="postpop";c.listener="__kbmethodupdatelisteners";f(c);return g}return null}),push:e(function(c){var b=new p(this,this.length,"push",
...
f(c)}return this}),splice:e(function(c,b,g){c="string"===typeof c?parseInt(c,10):c;var m=new p(this,c,"splice",void 0,void 0,arguments,"__kbmethodlisteners"),d=this.__kbnonproxy;if(!0!==f(m)){var h=[],l=Array.prototype.slice.call(arguments,2),e=l.length-2,q=0;if(0!==b&&void 0!==d[c-1+b])for(var t=0,z=b;t<z;t++){h.push(d[c+t]);for(var n=c+t,v=this.length-1;n<v;n++)d[n]=d[n+1];d.del(d.length-1,!0)}if(0!==e)for(t=0,z=e;t<z;t++){q=c+Math.min(1,t);n=d.length;for(v=q;n>v;n--)d.set(n,d[n-1]);d.set(q,l[t])}m.type=
"postsplice";m.listener="__kbmethodupdatelisteners";f(m);return h}return[]}),unshift:e(function(){var c=new p(this,0,"unshift",this[0],void 0,arguments,"__kbmethodlisteners"),b=this.__kbnonproxy;if(!0!==f(c)){for(var g=Array.prototype.slice.call(arguments),d=b.length-1+g.length,k=g.length;-1!==d;d--)d<k?b.set(d,g[d]):b.set(d,b[d-g.length]);c.type="postunshift";c.listener="__kbmethodupdatelisteners";f(c)}return this.length}),getLayer:e(function(c){function b(g){var c=g[0];return void 0===this[c]&&
...
D.load=function(r,u,p){document.head.appendChild(function(e,p,u){var r=document.createElement("script");r.type="text/javascript";r.charset="utf-8";r.async=!0;r.src=p;r.id="script_"+e;r.onload=function(){u(e,K_Components[e],this)};return r}(r,u,p));return D};D.onLoad=function(r){if(void 0===r)return u;u="function"===typeof r?r:u;return D};return D}}(),W=function(){function D(){function u(f,d){var h=f.length,l;for(l=0;l<h&&(f[l](d),void 0===d._stopPropogation);l++);}function A(f,d){var h=f.length,l;
for(l=0;l<h&&(d.child=d.target,d.target=f[l].parent,f[l].func(d),void 0===d._stopPropogation);l++);}function r(f,d){for(var h=f.length;0<h;U++)if(f[U].toString()===d.toString())return!0;return!1}function C(f,d,h,l,c,b,g,m){this.stopPropagation=function(){this._stopPropogation=!0};this.preventDefault=function(){this._preventDefault=!0};this.value=h;this.oldValue=l;this.target=f;this.attr=d;this.arguments=c;this.action=b;this.child=void 0;this.type=g;this.stopChange=m}function p(){this._attrListeners=
{};this._attrUpdateListeners={};this._styleListeners={};this._styleUpdateListeners={};this._parentStyleListeners={};this._parentStyleUpdateListeners={};this._parentAttrListeners={};this._parentAttrUpdateListeners={};this._injectedStyle={}}function e(f,d,h,l){var c=f.get,b=f.set,g;return function(m){g=c.call(this);h(this,d,m,g,void 0,this._stopChange)&&b.call(this,m);this._stopChange||l(this,d,m,g);this._stopChange=void 0}}function D(f,d,h,l){var c;return function(b){c=f.value;h(this,d,b,c,arguments,
this._stopChange)&&(f.value=b);this._stopChange||l(this,d,b,c,arguments);this._stopChange=void 0}}function R(f,d,h,l){var c=f.value,b;return function(){h(this,d,null,null,arguments,this._stopChange)&&(b=c.apply(this,arguments));this._stopChange||l(this,d,null,null,arguments,b);this._stopChange=void 0;return b}}function Q(f,d,h,l,c){var b=c.style,g=d.replace(/([A-Z])/g,"-$1").replace("webkit","-webkit"),m,k;return{get:function(){return k},set:function(f){m=k;h(c,d,f,m,void 0,this._stopChange)&&(k=
f,b.setProperty(g,f));this._stopChange||l(c,d,f,m);this._stopChange=void 0},enumerable:!0,configurable:!0}}function G(f,d,h,l){if("function"!==typeof d)return n;var c=-1!==["value","checked"].indexOf(f),b=-1!==z.indexOf(f),g;if(this.toString()!==n.toString())if(h){var m=this.querySelectorAll("*");h=m.length;for(var k,e=0;e<h;e++){k=m[e].attrListeners();if(c||"*"===f)void 0!==m[e].addInputBinding&&m[e].addInputBinding(),void 0!==m[e].addInputBoxBinding&&m[e].addInputBoxBinding();if(b)n.injectStyleProperty(m[e],
f),g=l?"_parentStyleUpdateListeners":"_parentStyleListeners";else{if("*"===f){g=l?"_parentStyleUpdateListeners":"_parentStyleListeners";h=z.length;for(var q=0;q<h;q++)n.injectStyleProperty(m[e],z[q]);void 0===k[g]["*"]&&(k[g]["*"]=[]);k[g]["*"].push({parent:this,func:d})}g=l?"_parentAttrUpdateListeners":"_parentAttrListeners"}void 0===k[g][f]&&(k[g][f]=[]);k[g][f].push({parent:this,func:d})}}else{k=this.attrListeners();if(b)g=l?"_styleUpdateListeners":"_styleListeners",n.injectStyleProperty(this,
f);else{if(c||"*"===f)void 0!==this.addInputBinding&&this.addInputBinding(),void 0!==this.addInputBoxBinding&&this.addInputBoxBinding();if("*"===f){g=l?"_styleUpdateListeners":"_styleListeners";h=z.length;for(e=0;e<h;e++)n.injectStyleProperty(this,z[e]);void 0===k[g][f]&&(k[g][f]=[]);k[g][f].push(d)}g=l?"_attrUpdateListeners":"_attrListeners"}void 0===k[g][f]&&(k[g][f]=[]);k[g][f].push(d)}else{if(c||"*"===f)for(q=document.querySelectorAll("input, textarea"),h=q.length,e=0;e<h;e++)void 0!==q[e].addInputBinding&&
q[e].addInputBinding(),void 0!==q[e].addInputBoxBinding&&q[e].addInputBoxBinding();if(b){b=Array.prototype.slice.call(document.body.querySelectorAll("*"));h=b.length+1;b.unshift(document.body);for(e=0;e<h;e++)n.injectStyleProperty(b[e],f);g=l?y:E}else{if("*"===f){b=Array.prototype.slice.call(document.body.querySelectorAll("*"));h=b.length+1;c=z.length;b.unshift(document.body);for(e=0;e<h;e++)for(q=0;q<c;q++)n.injectStyleProperty(b[e],z[q]);g=l?y:E;void 0===g[f]&&(g[f]=[]);g[f].push(d)}g=l?K:J}void 0===
g[f]&&(g[f]=[]);g[f].push(d)}}function L(f,d,h,l){function c(b,c){var m=c[b],k=m.length;for(g=0;g<k;g++)m[g].toString()===d.toString()&&m.splice(g,1)}if("function"!==typeof d)return n;["value","checked"].indexOf(f);var b=-1!==z.indexOf(f),g;if(this.toString()!==n.toString())if(h){h=this.querySelectorAll("*");var m=h.length;b?(b=l?"_childStyleUpdateListeners":"_childStyleListeners",c(f,this.attrListeners()[b]),b=l?"_parentStyleUpdateListeners":"_parentStyleListeners"):("*"===f&&(b=l?"_childStyleUpdateListeners":
"_childStyleListeners",c(f,this.attrListeners()[b])),b=l?"_childAttrUpdateListeners":"_childAttrListeners",c(f,this.attrListeners()[b]),b=l?"_parentAttrUpdateListeners":"_parentAttrListeners");for(g=0;g<m;g++){for(var k=h[g].attrListeners()[b][f],e=k.length,q=0;q<e;q++)k[q].isEqualNode(this)&&k.slice(q,1);if("*"===f)for(listenersStyle=l?"_parentStyleUpdateListeners":"_parentStyleListeners",k=h[g].attrListeners()[b][f],e=k.length,q=0;q<e;q++)k[q].isEqualNode(this)&&k.slice(q,1)}}else b?b=l?"_styleUpdateListeners":
"_styleListeners":("*"===f&&(b=l?"_styleUpdateListeners":"_styleListeners",c(f,this.attrListeners()[b])),b=l?"_attrUpdateListeners":"_attrListeners"),c(f,this.attrListeners()[b]);else b?b=l?y:E:("*"===f&&(b=l?y:E,c(f,b)),b=l?K:J),c(f,b)}function O(f,d){n.addAttrListener.call(this,f,d,!0);return this}function P(f,d){n.addAttrUpdateListener.call(this,f,d,!0);return this}function M(f,d){n.removeAttrListener.call(this,f,d,!0);return this}function H(f,d){n.removeAttrUpdateListener.call(this,f,d,!0);return this}
function F(f,d,h){var l=this.attrListeners();"html"===d&&(d="innerHTML");"events"===d&&(d="onclick");switch(f){case "attr":if(r(l._attrListeners[d],h))return!0;break;case "attrupdate":if(r(l._attrUpdateListeners[d],h))return!0}return!1}function I(){this._stopChange=!0;return this}function n(){function f(b,c){var g,d=c.length;for(g=0;g<d;g++)-1===b.indexOf(c[g])&&b.push(c[g]);return b}function d(b,c){for(var g=Object.keys(b),d,f,h=0,l=g.length;h<l;h++)if(d=g[h],void 0===c[d])c[d]=b[d].slice();else for(var e=
0,q=b[d].length;e<q;e++)f=b[d][e],c[d].push(f)}function h(b){if(3!==b.target.nodeType&&8!==b.target.nodeType){var c=b.target.attrListeners(),g,h=["value","checked"],l=c._attrListeners,e=c._attrUpdateListeners,q=c._parentAttrListeners;g=c._parentAttrUpdateListeners;var t=!1;if(void 0!==J["*"]||void 0!==K["*"])t=!0;if(!0!==t&&void 0!==l["*"]||void 0!==e["*"]||void 0!==q["*"]||void 0!==g["*"])t=!0;if(!0!==t)for(var v=0;v<h.length;v++)if(void 0!==J[h[v]]||void 0!==K[h[v]]||void 0!==l[h[v]]||void 0!==
e[h[v]]||void 0!==q[h[v]]||void 0!==g[h[v]]){t=!0;break}g=t;h=Object.keys(E);l=Object.keys(y);Object.keys(c._styleListeners);Object.keys(c._styleUpdateListeners);e=Object.keys(c._parentStyleListeners);c=Object.keys(c._parentStyleUpdateListeners);q=[];if(0!==h.length||0!==l.length)q=f(q,h),q=f(q,l);if(0!==q.length&&0!==e.length||0!==c.length)q=f(q,e),q=f(q,c);-1!==q.indexOf("*")&&(q=z);var c=q,h=c.length,p,r,l=[],w,e="outerHTML"===b.attr||"outerText"===b.attr?b.attr:void 0,q=b.target;void 0!==e&&(b.attr=
"appendChild",b.arguments=[b.target],b.target=b.target.parentElement);if(g){"appendChild"===b.attr&&3!==b.arguments[0].nodeType&&8!==b.arguments[0].nodeType?(l=Array.prototype.slice.call(b.arguments[0].querySelectorAll("input,textarea")),"INPUT"!==b.arguments[0].tagName&&"TEXTAREA"!==b.arguments[0].tagName||l.unshift(b.arguments[0])):l=Array.prototype.slice.call(b.target.querySelectorAll("input,textarea"));w=l.length;for(var u=0;u<w;u++)void 0!==l[u].addInputBinding&&l[u].addInputBinding(),void 0!==
l[u].addInputBoxBinding&&l[u].addInputBoxBinding()}"appendChild"===b.attr&&"#text"!==b.arguments[0].nodeName&&"#comment"!==b.arguments[0].nodeName?(l=Array.prototype.slice.call(b.arguments[0].querySelectorAll("*")),l.unshift(b.arguments[0])):l=Array.prototype.slice.call(b.target.querySelectorAll("*"));g=b.target.__kb._parentAttrListeners;t=b.target.__kb._parentAttrUpdateListeners;v=b.target.__kb._parentStyleListeners;p=b.target.__kb._parentStyleUpdateListeners;w=l.length;for(u=0;u<w;u++){if(0!==h)for(r=
0;r<h;r++)n.injectStyleProperty(l[u],c[r]);r=l[u].attrListeners();d(g,r._parentAttrListeners);d(t,r._parentAttrUpdateListeners);d(v,r._parentStyleListeners);d(p,r._parentStyleUpdateListeners)}void 0!==e&&(b.attr=e,b.target=q,b.arguments=[])}}function l(c){var g=c.target.attributes[c.arguments[0]],d="setAttribute"===c.attr?c.arguments[1]:"";b(c.target,c.arguments[0],d,void 0!==g?g.value:"",[d])||c.preventDefault()}function c(b){var c=b.target.attributes[b.arguments[0]],d="setAttribute"===b.attr?b.arguments[1]:
"";g(b.target,b.arguments[0],d,void 0!==c?c.value:"",[d])}n.injectPrototypes(Node,"Node");n.injectPrototypes(Element,"Element");n.injectPrototypes(HTMLElement,"HTMLElement");n.injectPrototypes(HTMLInputElement,"HTMLInputElement");n.injectPrototypes(HTMLTextAreaElement,"HTMLTextAreaElement");n.injectPrototypes(Document,"Document");var b=N,g=w;n.addAttrUpdateListener("appendChild",h);n.addAttrUpdateListener("removeChild",h);n.addAttrUpdateListener("innerHTML",h);n.addAttrUpdateListener("outerHTML",
h);n.addAttrUpdateListener("innerText",h);n.addAttrUpdateListener("outerText",h);n.addAttrUpdateListener("textContent",h);n.addAttrListener("setAttribute",l);n.addAttrListener("removeAttribute",l);n.addAttrUpdateListener("setAttribute",c);n.addAttrUpdateListener("removeAttribute",c);return n}var J={},K={},E={},y={},q={},t="textContent innerHTML innerText outerHTML outerText appendChild removeChild replaceChild insertAdjacentHTML insertBefore".split(" "),z=Object.getOwnPropertyNames(document.documentElement.style),
v=Object.keys(HTMLElement.prototype).filter(function(f){return 0===f.indexOf("on")}).concat(["addEventListener","removeEventListener"]),U,N=function(f,d,h,l,c,b){h=new C(f,d,h,l,c,void 0,"set",b);void 0!==f.__kb&&(l=f.__kb._attrListeners,c=f.__kb._styleListeners,b=f.__kb._parentAttrListeners,f=f.__kb._parentStyleListeners,void 0!==l[d]&&u(l[d],h),void 0===h._stopPropogation&&void 0!==c[d]&&u(c[d],h),void 0===h._stopPropogation&&void 0!==l["*"]&&(u(l["*"],h),void 0===h._stopPropogation&&u(c["*"],h)),
void 0===h._stopPropogation&&void 0!==b[d]&&A(b[d],h),void 0===h._stopPropogation&&void 0!==f[d]&&A(f[d],h),void 0===h._stopPropogation&&void 0!==b["*"]&&(A(b["*"],h),void 0===h._stopPropogation&&A(f["*"],h)));void 0===h._stopPropogation&&void 0!==J[d]&&u(J[d],h);void 0===h._stopPropogation&&void 0!==E[d]&&u(E[d],h);void 0===h._stopPropogation&&void 0!==J["*"]&&(u(J["*"],h),void 0===h._stopPropogation&&u(E["*"],h));return void 0!==h._preventDefault?!1:!0},w=function(f,d,h,l,c,b){h=new C(f,d,h,l,c,
b,"update");void 0!==f.__kb&&(l=f.__kb._attrUpdateListeners,c=f.__kb._styleUpdateListeners,b=f.__kb._parentAttrUpdateListeners,f=f.__kb._parentStyleUpdateListeners,void 0!==l[d]&&u(l[d],h),void 0===h._stopPropogation&&void 0!==c[d]&&u(c[d],h),void 0===h._stopPropogation&&void 0!==l["*"]&&(u(l["*"],h),void 0===h._stopPropogation&&u(c["*"],h)),void 0===h._stopPropogation&&void 0!==b[d]&&A(b[d],h),void 0===h._stopPropogation&&void 0!==f[d]&&A(f[d],h),void 0===h._stopPropogation&&void 0!==b["*"]&&(A(b["*"],
h),void 0===h._stopPropogation&&A(f["*"],h)));void 0===h._stopPropogation&&void 0!==K[d]&&u(K[d],h);void 0===h._stopPropogation&&void 0!==y[d]&&u(y[d],h);void 0===h._stopPropogation&&void 0!==K["*"]&&(u(K["*"],h),void 0===h._stopPropogation&&u(y["*"],h));return void 0!==h._preventDefault?!1:!0};n.injectPrototypeProperty=function(f,d,h,l,c){var b=f.prototype,g=Object.getOwnPropertyDescriptor(b,d);h=h||f.toString().split(/\s+/)[1].split("{")[0].replace("()","");var m=q[h];l=l||N;c=c||w;void 0===b.attrListeners&&
(b={},b.attrListeners=function(){void 0===this.__kb&&(this.__kb=new p);return this.__kb}.bind(b),b.addAttrListener=n.addAttrListener,b.addAttrUpdateListener=n.addAttrUpdateListener,b.addChildAttrListener=O,b.addChildAttrUpdateListener=P,b.hasListener=F,b.removeAttrListener=n.removeAttrListener,b.removeAttrUpdateListener=n.removeAttrUpdateListener,b.removeChildAttrListener=M,b.removeChildAttrUpdateListener=H,b.stopChange=I);void 0===m&&(q[h]={obj:f,proto:b,descriptors:{},set:void 0,update:void 0},
m=q[h],m.set=l,m.update=c);void 0===m.descriptors[d]&&(m.descriptors[d]=g);g.configurable&&(void 0!==g.set?Object.defineProperty(b,d,{get:g.get,set:e(g,d,l,c),enumerable:!0,configurable:!0}):"function"===typeof g.value?Object.defineProperty(b,d,{value:R(g,d,l,c),writable:!0,enumerable:!0,configurable:!0}):void 0!==g.value&&Object.defineProperty(b,d,{get:function(){return g.value},set:D(g,d,l,c),enumerable:!0,configurable:!0}));return n};n.injectStyleProperty=function(f,d,h,l){var c=f.style,b=Object.getOwnPropertyDescriptor(c,
d),g=f.attrListeners().injectedStyle;h=h||N;l=l||w;void 0===g&&(f.attrListeners().injectedStyle={obj:f,proto:c,descriptors:{},set:void 0,update:void 0},f.attrListeners().injectedStyle.set=h,f.attrListeners().injectedStyle.update=l,g=f.attrListeners().injectedStyle);void 0===g.descriptors[d]&&(g.descriptors[d]=b);b.configurable&&Object.defineProperty(c,d,Q(b,d,h,l,f));return n};n.injectPrototypes=function(f,d,h,l){var c=f.prototype;d=d||f.toString().split(/\s+/)[1].split("{")[0].replace("()","");var b=
q[d],g=Object.getOwnPropertyNames(c);h=h||N;l=l||w;var m;void 0===c.attrListeners&&(c.attrListeners=function(){void 0===this.__kb&&(this.__kb=new p);return this.__kb},c.addAttrListener=n.addAttrListener,c.addAttrUpdateListener=n.addAttrUpdateListener,c.addChildAttrListener=O,c.addChildAttrUpdateListener=P,c.removeAttrListener=n.removeAttrListener,c.removeAttrUpdateListener=n.removeAttrUpdateListener,c.removeChildAttrListener=M,c.removeChildAttrUpdateListener=H,c.hasListener=F,c.stopChange=I);void 0===
b&&(q[d]={obj:f,proto:c,descriptors:{},set:void 0,update:void 0},b=q[d],b.set=h,b.update=l);m=q[d].descriptors;for(l=0;l<g.length;l+=1)void 0===m[g[l]]&&n.injectPrototypeProperty(f,g[l],d,h,w);if(-1!==g.indexOf("value")){var k=function(c){var g,d,h;if("checkbox"===this.type||"radio"===this.type)g=!0;d=g?"string"===typeof this.checked?this.checked:this.checked?"true":"false":this.value;setTimeout(function(){h=g?"string"===typeof this.checked?this.checked:this.checked?"true":"false":this.value;g&&(b.set(this,
...
void 0;this.removeEventListener("mouseup",k)};c.addInputBoxBinding=function(){this.attrListeners()._onmousedown=!0;this.addEventListener("mouseup",k)}}return n};n.addAttrListener=function(f,d,h){if("html"===f){f=0;for(var l=t.length;f<l;f++)G.call(this,t[f],d,h,!1)}else if("events"===f)for(f=0,l=v.length;f<l;f++)G.call(this,v[f],d,h,!1);else G.call(this,f,d,h,!1);return this};n.addAttrUpdateListener=function(f,d,h){if("html"===f){f=0;for(var l=t.length;f<l;f++)G.call(this,t[f],d,h,!0)}else if("events"===
f)for(f=0,l=v.length;f<l;f++)G.call(this,v[f],d,h,!0);else G.call(this,f,d,h,!0);return this};n.removeAttrListener=function(f,d,h){if("html"===f){f=0;for(var l=t.length;f<l;f++)L.call(this,t[f],d,h,!1)}else if("events"===f)for(f=0,l=v.length;f<l;f++)L.call(this,v[f],d,h,!1);else L.call(this,f,d,h,!1);return this};n.removeAttrUpdateListener=function(f,d,h){if("html"===f){f=0;for(var l=t.length;f<l;f++)L.call(this,t[f],d,h,!0)}else if("events"===f)for(f=0,l=v.length;f<l;f++)L.call(this,v[f],d,h,!0);
else L.call(this,f,d,h,!0);return this};n.hasListener=function(f,d,h){"html"===d&&(d="innerHTML");"events"===d&&(d="onclick");switch(f){case "attr":if(r(J[d],h))return!0;break;case "attrupdate":if(r(K[d],h))return!0}return!1};n.injectedPrototypes=function(){return q};return n}"function"===typeof define&&define.amd&&define("KB",D);return D}(),Z=function(D){return function(){function u(q){document.createDocumentFragment();this.name=q.tagName.toLowerCase();this.template=n[this.name]||'<div class="missing_component">Unknown Component</div>';
...
g=b.length;c<g;c++){var m=e[b[c]];if(void 0!==m)for(var k=0,q=m.length;k<q;k++)m[k].reconnect()}this.node.children[d].kb_viewmodel.x=d;this.node.children[d].kb_viewmodel.loopid=f.substring(0,f.lastIndexOf("_")+1)+d;return this}),connect:A(function(d){var e=this;this._data=d;if("for"!==this.type){if(void 0!==this._data.pointers[this.key]&&void 0!==this._data.pointers[this.key].filters)for(var f=this._data.pointers[this.key].filters.dataFilters,c=0,b=Object.keys(this._data.pointers[this.key].filters.stringFilters),
g=b.length;c<g;c++)for(var m=this._data.pointers[this.key].filters.stringFilters[b[c]],k=0,q=m.length;k<q;k++)-1===this.filters[b[c]].indexOf(m[k])&&(this.filters[b[c]].push(m[k]),-1!==["vmfilters","filters"].indexOf(b[c])&&void 0!==f[m[k]]&&void 0===this._data.filters[m[k]]&&(this._data.filters[m[k]]=f[m[k]]));if(this.insert){this.setDom(this._data.get(this.key));this.unsync();return}this.set&&(f=!isNaN(parseInt(this.set,10))&&parseInt(this.set,10).toString().length===this.set.length,c="true"===
...
p(this.filters.model)):this.filters.session&&0!==this.filters.session.length?this._data.stopChange().set(this.key,w(this.filters.session)):this.filters.local&&0!==this.filters.local.length&&this._data.stopChange().set(this.key,u(this.filters.local)),this.isEvent?(this.dataListener=function(b){e.node.stopChange().removeEventListener(e.attr.replace("on",""),b.oldValue);e.node.stopChange().addEventListener(e.attr.replace("on",""),b.value)},this._data.addDataUpdateListener(this.key,this.dataListener),
this.node.addEventListener(this.attr.replace("on",""),this._data.get(this.key))):"innerHTML"===this.key?(this.node.stopChange().innerHTML="",n(this.node,this._data.innerHTML)):(this.local.stopChange()[this.localAttr]=L(this.bindText),this.isInput&&-1!==["value","checked"].indexOf(this.attr)&&(d=this._data.get(this.key),this.node.stopChange()[this.attr]=void 0!==d?d:"")));return this}),reconnect:A(function(){"for"!==this.type?(this._data.getLayer(this.key).removeDataUpdateListener(this.localKey,this.dataListener),
1===this.bindText.length&&this.node.removeAttrUpdateListener(this.listener,this.domListener)):this._data.getLayer(this.key).removeDataMethodUpdateListener(this.extraListener);this.connect(this._data);return this}),createloop:A(function(){this.node.stopChange().innerHTML="";for(var d=0,e=P(this._data.get(this.key),this.filters.filters,this._data.filters).length;d<e;d++)this.setLoop(d,"create");return this}),setData:A(function(d){d=O(d,this.filters.vmFilters,this._data.filters);this._data.stopChange().set(this.key,
d);r(this.filters.model,d);f(this.filters.session,d);C(this.filters.local,d);return this}),setDom:A(function(d){r(this.filters.model,d);f(this.filters.session,d);C(this.filters.local,d);this.isEvent?this.node.stopChange()[this.attr]=this._data.get(this.key):this.isInput&&-1!==["value","checked"].indexOf(this.attr)?this.node.stopChange()[this.attr]=this._data.get(this.key):"innerHTML"===this.key?(this.node.stopChange().innerHTML="",n(this.node,this._data.innerHTML)):(this.local.stopChange()[this.localAttr]=
L(this.bindText),this.isInput&&-1!==["value","checked"].indexOf(this.attr)&&(d=this._data.get(this.key),this.node.stopChange()[this.attr]=void 0!==d?d:""));return this}),setLoop:A(function(d,e){switch(e){case "create":this.addPointer(d);break;case "delete":this.removePointer(d);break;case "set":this.reapplyPointer(d);break;default:if("push"!==e)for(var f=0,c=this._data.getLayer(this.key).length;f<c;f++)this.reapplyPointer(f)}return this}),bindMaps:A([]),unsync:A(function(){this._data=this.__proto__.bindText=
null;delete this._data;this.bindMaps=null;delete this.bindMaps;this.binds=null;delete this.binds;return this}),reset:A(function(){"for"===this.type?this._data.getLayer(this.key).removeDataMethodUpdateListener(this.extraListener).addDataMethodUpdateListener(this.extraListener):this.dataListener&&(this._data.getLayer(this.key).removeDataUpdateListener(this.localKey,this.dataListener).addDataUpdateListener(this.localKey,this.dataListener),1===this.bindText.length&&this.node.removeAttrUpdateListener(this.listener,
this.domListener).addAttrUpdateListener(this.listener,this.domListener))}),replaceNode:A(function(){var d=document.createDocumentFragment(),e=d.appendChild(document.createElement("div")),f,c=!1,b=this;e.innerHTML=this.bindText.map(function(g,d){if("object"===typeof g){if(void 0===g._data)return c=!0,"";if(g.key===b.bindText[1].key){var e=O(g._data.get(g.key),g.filters,g._data.filters)||"unknown";"unkown"===e&&1===d&&console.error("You attempted to bind a node to %o, which does not exist on %o, with bindText: %o",
g.key,g._data,g.base);return e}return O(g._data.get(g.key),g.filters,g._data.filters)}return g}).join("");c||(f=e.children[0],d.replaceChild(f,e),this.base.local.parentElement.stopChange().replaceChild(d,this.base.local),this.base.local=f,y({event:"replaceNode",node:this.base.local,parent:this.node,map:this.base}))})});return e}var H="{{",F="}}",I="|",n={},J=/(<\/.*?>)/g;D().call();var K=Object.keys(HTMLElement.prototype).filter(function(e){return 0===e.indexOf("on")}).concat(["ontouchstart","ontouchend",
"ontouchmove"]),E={loopitem:[],replaceNode:[]},y=function(e){for(var n=E[e.event],p=0,r=n.length;p<r;p++)n[p](e)};u.start=function(e){if(void 0===e)return H;H="string"===typeof e?e:H;return u};u.end=function(e){if(void 0===e)return F;F="string"===typeof e?e:F;return u};u.pipe=function(e){if(void 0===e)return I;I="string"===typeof e?e:I;return u};u.getUnknown=function(e){var p=e.match(J).map(function(e){return e.replace(/[<\/>]/g,"")});p.filter(function(e,q){return 0!==e.indexOf(H)&&document.createElement(e)instanceof
HTMLUnknownElement&&-1===p.indexOf(e,q+1)&&void 0===n[e]});return p};u.isRegistered=function(e){return void 0!==n[e]};u.register=function(e,p){void 0===n[e]?(n[e]=p,u.getUnknown(p)):console.error("Class: KonnektMP Method: 'register', A template by the name %o already exists",e);return this};u.addEventListener=function(e,n){void 0!==E[e]?E[e].push(n):console.error("Class: KonnektMP Method: 'addEventListener', No event exists with the name %o",e);return u};u.removeEventListener=function(e,n){if(void 0!==
E[e])for(var p=0,r=E[e].length;p<r;p++)E[e][p].toString()===n.toString()&&E[e].splice(p,1);else console.error("Class: KonnektMP Method: 'removeEventListener', No event exists with the name %o",e);return u};Object.defineProperties(u.prototype,{register:A(u.register),isRegistered:A(u.isRegistered),getUnknown:A(u.getUnknown),map:A(function(n){function u(z,v){for(var y=0,A=z.length;y<A;y++)if(void 0===z[y].kb_maps&&8!==z[y].nodeType){z[y].kb_mapper=n;z[y].kb_maps=v;if(3===z[y].nodeType){var w=z[y],f=
v,d=w.textContent;if(d.match(r())){var h=p(d),l=M();l.prototype.type=d.match(new RegExp("(\\"+H.split("").join("\\")+")(.*?)(for)(.*?)(loop)(.*?)(\\"+F.split("").join("\\")+")","g"))?"for":"text";l.prototype.text=d;l.prototype.bindText=h;l.prototype.listener="textContent";l.prototype.attr="textContent";l.prototype.localAttr="textContent";l.prototype.local=w;l.prototype.node=w.parentElement;l.prototype.binds=f;w=0;for(d=h.length;w<d;w++)if(0===h[w].indexOf(H)){var c="for"===l.prototype.type?R(h[w])[0]:
e(h[w]),b=new l(h[w],c);void 0===f[c]&&(f[c]=[]);b.bindText[w]=b;b.bindMaps.push(b);b.id=f[c].length;f[c].push(b)}}}else for(f=z[y],h=v,l=Array.prototype.slice.call(f.attributes),w=f instanceof HTMLUnknownElement,d=0,c=l.length;d<c;d++)if(l[d].value.match(r())){var b=p(l[d].value),g=M();g.prototype.type=w?"component":"attribute";g.prototype.text=l[d].value;g.prototype.bindText=b;g.prototype.isEvent=-1!==K.indexOf(l[d].name);g.prototype.isInput="input"===f.tagName.toLowerCase();g.prototype.isRadio=
g.prototype.isInput?-1!==["radio","checkbox"].indexOf(f.type):!1;g.prototype.listener=l[d].name;g.prototype.attr=l[d].name;g.prototype.localAttr="value";g.prototype.local=l[d];g.prototype.node=f;g.prototype.binds=h;g.prototype.isEvent&&f.removeAttribute(l[d].name);for(var m=0,k=b.length;m<k;m++)if(0===b[m].indexOf(H)){var B=e(b[m]),T=new g(b[m],B);void 0===h[B]&&(h[B]=[]);T.bindText[m]=T;T.bindMaps.push(T);T.id=h[B].length;h[B].push(T)}}z[y].childNodes&&0!==z[y].childNodes.length&&(v=u(z[y].childNodes,
v))}else if(8===z[y].nodeType&&(w=z[y],f=v,d=w.textContent,d.match(C())))for(h=p(d),l=M(),l.prototype.type="node",l.prototype.text=d,l.prototype.bindText=h,l.prototype.base=h[1],l.prototype.listener="textContent",l.prototype.attr="textContent",l.prototype.localAttr="textContent",l.prototype.local=w,l.prototype.node=w.parentElement,l.prototype.binds=f,l.prototype.replacement=void 0,w=0,d=h.length;w<d;w++)0===h[w].indexOf(H)&&(c=e(h[w]),b=new l(h[w],c),void 0===f[c]&&(f[c]=[]),b.bindText[w]=b,b.bindMaps.push(b),
b.id=f[c].length,1===w&&(l.prototype.base=b,b.isBase=!0),f[c].push(b));return v}return u(n.childNodes,{})})});return u}}(W),aa=function(){return function(){function D(p){0===p.length&&(p=A);p=new u(p);for(var e=0,S=C.length;e<S;e++)if(!p._stopPropogation)C[e](p);p._preventDefault||(document.body.innerHTML="<"+p.hash+"></"+p.hash+">",r(p.hash));return D}function u(p){this.preventDefault=function(){this._preventDefault=!0};this.stopPropogation=function(){this._stopPropogation=!0};this.hash=p;this.url=
window.location.href}var A="",r=function(){},C=[];D.base=function(p){if(void 0===p)return A;A="string"===typeof p?p:A;return D};D.addHashListener=function(p){C.push(p);return D};D.removeHashListener=function(p){for(var e=0,r=C.length;e<r;e++)if(C[e].toString()===p.toString()){C.splice(e,1);break}return D};D.onChange=function(p){if(void 0===p)return r;r="function"===typeof p?p:r;return D};D.watch=function(p){window.onhashchange=p?function(){D(window.location.hash.replace("#",""))}:null;return D};return D}}(),
V=function(D,u,A,r,C){return function(p){function e(b,c,d,f,l){function n(b,c,g,d,e){for(var f=E({},b),k=0,m=Object.keys(d),l=m.length;k<l;k++)-1!==h.indexOf(m[k])?Object.defineProperty(f,m[k],G(d[m[k]],"filters"!==m[k])):d.pointers?void 0===d.pointers[m[k]]&&f.set(m[k],d[m[k]]):f.set(m[k],d[m[k]]);if(d.pointers)for(f.pointers||Object.defineProperty(f,"pointers",G({},!1,!0)),k=0,m=Object.keys(d.pointers),l=m.length;k<l;k++)f.pointers[m[k]]=d.pointers[m[k]],f.addPointer(f.pointers[m[k]].point,f.pointers[m[k]].key,
m[k]);k=0;m=Object.keys(c.prototype);for(l=m.length;k<l;k++)Object.defineProperty(f,[m[k]],G(c.prototype[m[k]],!0));c.apply(f,g);k=0;m=Object.keys(e);for(l=m.length;k<l;k++)-1!==h.indexOf(m[k])?Object.defineProperty(f,m[k],G(e[m[k]],"filters"!==m[k])):e.pointers?void 0===e.pointers[m[k]]&&f.set(m[k],e[m[k]]):f.set(m[k],e[m[k]]);if(e.pointers)for(f.pointers||Object.defineProperty(f,"pointers",G({},!1,!0)),k=0,m=Object.keys(e.pointers),l=m.length;k<l;k++)f.pointers[m[k]]=e.pointers[m[k]],f.addPointer(f.pointers[m[k]].point,
...
c.wrapper.kb_viewmodel.onFinish.call(c.wrapper.kb_viewmodel,c.wrapper);c.wrapper.kb_viewmodel.onGlobalFinish&&c.wrapper.kb_viewmodel.onGlobalFinish.call(c.wrapper.kb_viewmodel,c.wrapper);c.wrapper.kb_viewmodel.onNodeFinish&&c.wrapper.kb_viewmodel.onNodeFinish.call(c.wrapper.kb_viewmodel,c.wrapper)}function q(b){b=b.querySelectorAll("*");for(var c=0,g=b.length;c<g;c++)b[c]instanceof HTMLUnknownElement&&e(b[c])}function r(b,d){t=new z(d,!0);t.wrapper.innerHTML=t.template;t.wrapper.kb_mapper=t.wrapper;
Object.defineProperty(t.wrapper,"__kbcomponenttree",G(d.kb_mapper?d.kb_mapper.__kbcomponenttree.slice():[]));d.parentElement.stopChange().replaceChild(t.fragment,d);c.unshift(t.wrapper);p(t.wrapper,t,n(b,N[b],c,v,w));-1===t.wrapper.__kbcomponenttree.indexOf(b)||t.wrapper.kb_viewmodel.multiple?(t.wrapper.__kbcomponenttree.push(b),t.wrapper.className+=" "+t.wrapper.kb_viewmodel.local,t.wrapper.className+=" "+t.wrapper.kb_viewmodel.id,t.wrapper.className+=t.wrapper.kb_viewmodel.loopid?" "+t.wrapper.kb_viewmodel.loopid:
...
t.wrapper,t.wrapper.parentElement))}var u=b.tagName.toLowerCase(),t;l=Object.keys(HTMLElement.prototype).filter(function(b){return 0===b.indexOf("on")});var v=Q(y,{}),w={};void 0===c&&(c=[]);d&&Q(d,v);Object.defineProperty(v,"local",G(v.local||"local_"+u+"-"+(Math.floor(Math.random()*Date.now())+1),!0,!1,!0));Object.defineProperty(v,"id",G(v.id||"id_"+u+"-"+(Math.floor(Math.random()*Date.now())+1),!0,!1,!0));Object.defineProperty(v,"filters",G(v.filters||{},!1,!1,!0));"function"!==typeof v.onFinish&&
(v.onFinish=function(){});Object.defineProperty(v,"onGlobalFinish",G(v.onFinish,!0,!1,!0));v.listen=O;Object.defineProperty(v,"listen",G(v.listen,!0,!1,!0));v.unlisten=L;Object.defineProperty(v,"unlisten",G(v.unlisten,!0,!1,!0));v.alert=P;Object.defineProperty(v,"alert",G(v.alert,!0,!1,!0));Object.defineProperty(v,"sessionStorage",G(!1,!0,!1,!0));Object.defineProperty(v,"localStorage",G(!1,!0,!1,!0));Object.defineProperty(v,"store",G(!1,!0,!1,!0));Object.defineProperty(v,"multiple",G(!1,!0,!1,!0));
f&&Q(f,w);w.innerHTML=Array.prototype.slice.call(b.childNodes);d=0;for(f=b.attributes.length;d<f;d++)w[b.attributes[d].name]=b.attributes[d].value;d=0;for(f=l.length;d<f;d++)b[l[d]]&&(w[l[d]]=b[l[d]]);b.k_post&&Q(b.k_post,w);e.isRegistered(u)||b.kb_isLoading?e.isRegistered(u)&&r(u,b):(e.loadWaitList(u,function(c,g){r(u,b)}),e.loadWaitList(u).loading||(e.loadWaitList(u).loading=!0,K(u)))}function A(b){var c=this.__kbref.local,d=this.__kbref.id,e=this.__kbref.loopid,h=this.__kbscopeString+(0!==this.__kbscopeString.length?
".":"")+b.key;if(f[c]&&f[c][h])for(var l=0,n=f[c][h].length;l<n;l++)f[c][h][l](b);if(f[d]&&f[d][h])for(l=0,n=f[d][h].length;l<n;l++)f[d][h][l](b);if(f[e]&&f[e][h])for(l=0,n=f[e][h].length;l<n;l++)f[e][h][l](b)}function R(b){var c=b.node.tagName.toLowerCase();e.isRegistered(c)||b.node.kb_isLoading?e.isRegistered(c)&&("replaceNode"===b.event?e(b.node,[],{onNodeFinish:function(c){b.map.local=c}}):e(b.node)):(b.node.kb_isLoading=!0,e.loadWaitList(c,function(c,d){"replaceNode"===b.event?e(b.node,[],{onNodeFinish:function(c){b.map.local=
c}}):e(b.node)}),e.loadWaitList(c).loading||(e.loadWaitList(c).loading=!0,K(c)))}function Q(b,c){var d=Object.keys(b);c.pointers||Object.defineProperty(c,"pointers",{value:{},writable:!0,enumerable:!1,configurable:!0});for(var e=0,f=d.length;e<f;e++)if(E.prototype.isObservable(b,d[e]))c.pointers[d[e]]={key:b.__kbscopeString.split(".").pop(),point:b.__kbImmediateParent};else if(E.prototype.isMixed(b[d[e]]))c.pointers[d[e]]={key:b[d[e]].__kbscopeString.split(".").pop(),point:b[d[e]].__kbImmediateParent};
else if(E.prototype.isObject(b[d[e]])&&b[d[e]].pointer)c.pointers[d[e]]={filters:b[d[e]].filters,key:b[d[e]].key,point:b[d[e]].pointer};else if(E.prototype.isObject(b[d[e]])){void 0===c[d[e]]&&(c[d[e]]={});for(var h=0,l=Object.keys(b[d[e]]);h<f;h++)c[d[e]][l[h]]=b[d[e]][l[h]]}else if(E.prototype.isArray(b[d[e]]))for(h=0;h<f;h++)c[d[e]][h]=b[d[e]][h];else c[d[e]]=b[d[e]];return c}function G(b,c,d,e){return{value:b,writable:!!c,enumerable:!!e,configurable:!!d}}function L(b,c,d){if(2===arguments.length)if(d=
c.bind(this),c=b,w[c])for(var e=0,h=w[c].length;e<h;e++)w[c][e].toString()===d.toString()&&w[c].splice(e,1);else console.error("no listeners exists by key %o",c);else if(d=d.bind(this),f[b]&&f[b][c])for(e=0,h=f[b][c].length;e<h;e++)f[b][c].toString()===d.toString()&&f[b][c].splice(e,1);return this}function O(b,c,d){if(2===arguments.length)d=c.bind(this),c=b,w[c]||(w[c]=[]),w[c].push(d);else if(d=d.bind(this),f[b]||(f[b]={}),f[b][c]||(f[b][c]=[]),f[b][c].push(d),document.querySelector("."+b)){var e=
...
function(b,c,d,f){z.register(b,d);N[b]=c;return e};e.isRegistered=function(b){return void 0!==N[b]&&z.isRegistered(b)};e.registered=function(){return Object.keys(N)};e.loadWaitList=function(b,c){if("undefined"===typeof c&&b)return l[b];if(b){if(void 0===l[b]||"clear"===c){var d=void 0===l[b]?!1:!!l[b].loading;l[b]=[];l[b].loading=d}"function"===typeof c&&l[b].push(c)}return e};e.localRouting=function(b){b&&"dev"!==d.env?(c=Node.prototype.appendChild,Node.prototype.appendChild=function(b){if("script"===
b.nodeName.toLowerCase()){b.src=b.src.substring(0,-1!==b.src.indexOf("?")?b.src.indexOf("?"):b.src.length);var e=b.src.match(/(.*?component\/)/);e&&(d.env||(d.env="prod"),"dev"===d.env&&(d.env="qa"),e=b.src.replace(e[0],"").replace(/[\/\s]/g,""),b.src=(void 0!==y.prefix?y.prefix:"")+"/components/"+e+"/build/"+d.env+"/"+e+(d.debug&&"prod"!==d.env?"":".min")+".js",arguments[0]=b)}return c.apply(this,arguments)}):c&&(Node.prototype.appendChild=c,c=null);return e};e.hashRouting=function(b){b&&(document.body?
q?v(window.location.hash.replace("#","")):t.push(function(){v(window.location.hash.replace("#",""))}):document.addEventListener("DOMContentLoaded",function(){q?v(window.location.hash.replace("#","")):t.push(function(){v(window.location.hash.replace("#",""))})}));return this};e.addHashRouter=function(b){v.addHashListener(b);return e};e.removeHashRouter=function(b){v.removeHashListener(b);return e};E.prototype._parse||(E.prototype._parse=E.prototype.parse);E.prototype.parse=function(){if(this.__kbref.kbnode){var b=
this.__kbref.kbnode.kb_mapper.kb_maps;this._parse.apply(this,arguments);this.unsubscribeDeep("*",A);this.subscribeDeep("*",A).callAllSubscribers();Object.keys(b).forEach(function(c){b[c].forEach(function(b){b.reset()})})}else return this._parse.apply(this,arguments)};(function(){F(function(b,c){c?I(function(b,c){c&&console.error("the Konnekt local config was not found, this issue happens when You do not have Konnekt isntalled via th standard node_modules or bower_components module directories");n(function(b,
c){q=!0;J()})}):n(function(b,c){q=!0;J()})})})();return window.Konnekt=e}}(X,Y,W,Z,aa);"undefined"!==typeof window&&"undefined"!==typeof window.define&&"undefined"!==typeof window.require?define([],function(){return V}):"undefined"!==typeof module&&(module.exports=V);return V}();
