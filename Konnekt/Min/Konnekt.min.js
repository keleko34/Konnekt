...
document.createElement("script");d.src=b;d.onerror=function(){c(null,!0)};d.onload=function(){c(v)};document.head.stopChange().appendChild(d)}function H(b){G("/node_modules/Konnekt/config/config.js",b)}function F(b){G("/bower_components/Konnekt/config/config.js",b)}function J(b){G("/config/config.js",b)}function r(){for(var b=0,c=q.length;b<c;b++)q[b]()}window.K_Components||(window.K_Components={});var K=u().onLoad(function(b,d){var f="<style>"+unescape(d.prototype.k_css)+"</style>"+unescape(d.prototype.k_html);
