...
b.src.substring(0,-1!==b.src.indexOf("?")?b.src.indexOf("?"):b.src.length);var e=b.src.match(/(.*?component\/)/);e&&(d.env||(d.env="prod"),"dev"===d.env&&(d.env="qa"),e=b.src.replace(e[0],"").replace(/[\/\s]/g,""),b.src=(void 0!==y.prefix?y.prefix:"")+"/components/"+e+"/build/"+d.env+"/"+e+(d.debug&&"prod"!==d.env?"":".min")+".js",arguments[0]=b)}return c.apply(this,arguments)}):c&&(Node.prototype.appendChild=c,c=null);return e};e.hashRouting=function(b){b&&(document.body?q?v(window.location.hash.replace("#",
"")):t.push(function(){v(window.location.hash.replace("#",""))}):document.addEventListener("DOMContentLoaded",function(){q?v(window.location.hash.replace("#","")):t.push(function(){v(window.location.hash.replace("#",""))})}));return this};e.addHashRouter=function(b){v.addHashListener(b);return e};e.removeHashRouter=function(b){v.removeHashListener(b);return e};E.prototype._parse||(E.prototype._parse=E.prototype.parse);E.prototype.parse=function(){if(this.__kbref.kbnode){var b=this.__kbref.kbnode.kb_mapper.kb_maps;
this._parse.apply(this,arguments);this.unsubscribeDeep("*",A);this.subscribeDeep("*",A).callAllSubscribers();Object.keys(b).forEach(function(c){b[c].forEach(function(b){b.reset()})})}else return this._parse.apply(this,arguments)};(function(){F(function(b,c){c?I(function(b,c){c&&console.error("the Konnekt local config was not found, this issue happens when You do not have Konnekt isntalled via th standard node_modules or bower_components module directories");n(function(b,c){q=!0;J()})}):n(function(b,
c){q=!0;J()})})})();return window.Konnekt=e}}(X,Y,W,Z,aa);"undefined"!==typeof window&&"undefined"!==typeof window.define&&"undefined"!==typeof window.require?define([],function(){return V}):"undefined"!==typeof module&&(module.exports=V);return V}();
