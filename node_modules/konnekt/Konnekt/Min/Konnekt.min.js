...
""),c.src=(void 0!==E.prefix?E.prefix:"")+"/components/"+k+"/build/"+G.env+"/"+k+(G.debug&&"prod"!==G.env?"":".min")+".js",arguments[0]=c)}return y.apply(this,arguments)}):y&&(Node.prototype.appendChild=y,y=null);return c};c.hashRouting=function(c){c&&(document.body?K(window.location.hash.replace("#","")):document.addEventListener("DOMContentLoaded",function(){K(window.location.hash.replace("#",""))}))};return c}}(W,X,V,Y,Z);"undefined"!==typeof window&&"undefined"!==typeof window.define&&"undefined"!==
typeof window.require?define([],function(){return U}):"undefined"!==typeof module&&(module.exports=U);return U}();
